---
aliases:
- /releases/3.0/blob-inspector.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-3-0:
    identifier: corda-enterprise-3-0-blob-inspector
...
The tool is distributed as part of Corda Enterprise 3.0 in the form of runnable JAR “corda-tools-blob-inspector-3.0.jar”.

To run simply pass in the file or URL as the first parameter:

```kotlin
java -jar corda-tools-blob-inspector-3.0.jar <file or URL>
```
