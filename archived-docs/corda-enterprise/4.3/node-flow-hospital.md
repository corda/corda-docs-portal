---
aliases:
- /releases/4.3/node-flow-hospital.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-3:
    identifier: corda-enterprise-4-3-node-flow-hospital
...
Flow hospital functionality is enabled by default in Corda Enterprise Edition 4.3. No explicit configuration settings are required.
...
As of Corda Enterprise Edition 4.3, this UI is informational only (read-only). Future versions of Corda will extend the basic functionality to enable
