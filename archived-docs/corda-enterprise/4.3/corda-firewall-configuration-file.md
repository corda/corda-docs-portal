...
We require using version [3.5.4-beta](https://downloads.apache.org/zookeeper/) is needed to facilitate lead) and have 3 cluster participants which will be hosted on `vmInfra1`, `vmInfra2` and `vmZkWitness`.
