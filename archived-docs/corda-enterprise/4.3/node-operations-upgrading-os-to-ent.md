---
aliases:
- /releases/4.3/node-operations-upgrading-os-to-ent.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-3:
    identifier: corda-enterprise-4-3-node-operations-upgrading-os-to-ent
...
[to add the script retrospectively](database-management.md).{{< note >}}
...
CorDapps, contracts and states written for Corda 3.x and Corda 4.x are compatible with Corda Enterprise Edition 4.3, so upgrading
...
Please ensure you follow the instructions in [Upgrade Notes](https://github.com/corda/corda-docs/blob/master/content/en/docs/corda-os/3.3/upgrade-notes.md)
