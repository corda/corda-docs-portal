...
Contract CorDapp please read [Contract and state versioning](../../../../../../en/platform/corda/4.4/enterprise/node/operating/cm-updating-cordapp.html#contract-and-state-versioning) and [CorDapp Upgradeability Guarantees](../../../../../../en/platform/corda/4.4/enterprise/cordapps/cordapp-upgradeability.md) to understand your options.
{{< /warning >}}
...
relaxed hash constraint checking mode as described in [Hash constrained states in private networks](../../../../../../en/platform/corda/4.4/enterprise/cordapps/api-contract-constraints.html#hash-constrained-states-in-private-networks).
...
* As the original developer of the CorDapp, the first step is to sign the latest version of the JAR that was released (see [Building and installing a CorDapp](../../../../../../en/platform/corda/4.4/enterprise/cordapps/cordapp-build-systems.md)).
...
by different parties and it will be expressed as a `CompositeKey` in the `SignatureAttachmentConstraint` (see [Core types in the Corda API](../../../../../../en/platform/corda/4.4/enterprise/api-core-types.md)).
...
[Updating the contract whitelist for bootstrapped networks](../../../../../../en/platform/corda/4.4/enterprise/network-bootstrapper.html#updating-the-contract-whitelist-for-bootstrapped-networks) to can add both CorDapp Contract JAR hashes.
