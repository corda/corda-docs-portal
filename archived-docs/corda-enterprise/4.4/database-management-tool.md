...
bash and zsh. See [Shell extensions for CLI Applications](../../../../../en/platform/corda/4.4/enterprise/node/operating/cli-application-shell-extensions.md) for more info.
