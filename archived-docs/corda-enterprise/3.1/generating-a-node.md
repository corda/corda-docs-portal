---
aliases:
- /releases/3.1/generating-a-node.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-3-1:
    identifier: corda-enterprise-3-1-generating-a-node
...
Below you can find the example task from the [IRS Demo](https://github.com/corda/corda/blob/release-V3.1/samples/irs-demo/cordapp/build.gradle#L111) included in the samples directory of main Corda GitHub repository:
