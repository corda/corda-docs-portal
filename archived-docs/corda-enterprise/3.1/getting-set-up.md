...
any issues, please consult the [Troubleshooting](troubleshooting.md) page, or reach out on [Slack](https://slack.corda.net/), or [Stack Overflow](https://stackoverflow.com/questions/tagged/corda).
...
`repository` folder to your local Maven repository located at `C:\Documents and Settings\{your-username}\.m2`.
