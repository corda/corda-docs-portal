...
|---------------------------------------------------------|------------------------------|----------------------------------------------------------|
|[Corda node](running-a-node.html#starting-a-corda-node-from-the-command-line)|`corda --<option>`|`corda-4.4.jar`|
|[Network bootstrapper]({{% ref "network-bootstrapper.md" %}})|`bootstrapper --<option>`|`corda-tools-network-bootstrapper-4.4.jar`|
|[Standalone shell](shell.html#the-standalone-shell)|`corda-shell --<option>`|`corda-tools-shell-cli-4.4.jar`|
