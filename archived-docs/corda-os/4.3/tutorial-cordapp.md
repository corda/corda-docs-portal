---
aliases:
- /releases/release-V4.3/tutorial-cordapp.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-4-3:
    identifier: corda-os-4-3-tutorial-cordapp
...
See [Running tests in IntelliJ](testing.html#tutorial-cordapp-alternative-test-runners)
