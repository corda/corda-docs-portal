---
aliases:
- /releases/release-V4.3/docker-image.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-4-3:
    identifier: corda-os-4-3-docker-image
...
docker run -ti \
        ...
        -v /home/user/corda/samples/bank-of-corda-demo/build/nodes/BankOfCorda/cordapps:/opt/corda/cordapps \
        entdocker.software.r3.com/corda-enterprise-java1.8-4.3:latest db-migrate-create-jars
```
...
docker run -ti \
        ...
        entdocker.software.r3.com/corda-enterprise-java1.8-4.3:latest db-migrate-execute-migration
```
