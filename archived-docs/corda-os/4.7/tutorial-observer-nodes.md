...
participant/owner. See the [Example usage](api-vault-query.html#example-usage---kotlin) section of the [API: Vault Query](api-vault-query.md) page for information on how to do this.
