...
menu:
  corda-os-3-3:
    identifier: corda-os-3-3-tutorial-custom-notary
...
[MyCustomNotaryService.kt](https://github.com/corda/corda/blob/release/os/3.3/samples/notary-demo/src/main/kotlin/net/corda/notarydemo/MyCustomNotaryService.kt)
