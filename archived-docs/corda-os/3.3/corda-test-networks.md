...
menu:
  corda-os-3-3:
    identifier: corda-os-3-3-corda-test-networks
...
[example-node.conf](https://github.com/corda/corda/blob/release/os/3.3/docs/source/example-code/src/main/resources/example-node.conf)
