...
menu:
  corda-os-4-1:
    identifier: corda-os-4-1-cordapp-constraint-migration
...
relaxed hash constraint checking mode as described in [Hash constrained states in private networks](api-contract-constraints.html#hash-constrained-states-in-private-networks).
...
* If using a hosted CZ network (such as [The Corda Network](corda-networks-index.md) or
[UAT Environment](../../../../../en/platform/corda/4.1/open-source/corda-network/uat.md)) running an Identity Operator (formerly known as Doorman) and
