...
function activateTabs() {
  ...
  for (var i = 0; i < elements.length; i++) {
    var e = elements[i];
    var s = "#" + e.id;
    var default_tab_name = s + "-" + default_tab; // https://getbootstrap.com/docs/4.4/components/navs/#tabshow
    // Always make the first tab the visible one

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(s + " a").first().tab("show"); // Unless it's the default tab i.e. 'java', in which case, show that instead

    var selector = s + ' a[href="' + default_tab_name + '"]';
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(selector).tab("show");
  }
}

/***/ }),

/***/ "./scripts/anchorify.js":
/*!******************************!*\
  !*** ./scripts/anchorify.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "applyAnchors": () => (/* binding */ applyAnchors)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DocsiteCookies": () => (/* binding */ DocsiteCookies)
/* harmony export */ });
...
var DocsiteCookies = /*#__PURE__*/function () {
  function DocsiteCookies() {
    ...
    _classCallCheck(this, DocsiteCookies);
    ...
    new (_vendor_cookies_eu_banner__WEBPACK_IMPORTED_MODULE_0___default())(function () {
      _this.cookieBanner();
    }, true);
  }

  _createClass(DocsiteCookies, [{
    key: "handleAllCookies",
    value: function handleAllCookies() {
      var _this2 = this;

      var acceptButton = document.querySelector("#cookies-eu-accept");
      var allCookiesButton = document.querySelector("#cookies-eu-accept-all");
      allCookiesButton.addEventListener("click", function (e) {
        e.preventDefault();

        _this2.allowAllCookies(_this2.form);
    ...
    key: "allowAllCookies",
    value: function allowAllCookies(form) {
      var cookiePreferences = form.querySelectorAll(".cookies-checkbox");

      var _iterator = _createForOfIteratorHelper(cookiePreferences),
          _step;
    ...
    key: "formToCookie",
    value: function formToCookie(name, form) {
      var thirteenMonthsInMils = 31104000000;
      var date = new Date();
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          switch (pair[0]) {
            case "necessary":
              this.cookiesAccepted.necessary = pair[1] === "on" ? true : false;
              break;

            case "preferences":
              this.cookiesAccepted.preferences = pair[1] === "on" ? true : false;
              break;

            case "statistics":
              this.cookiesAccepted.statistics = pair[1] === "on" ? true : false;
              break;

            case "marketing":
              this.cookiesAccepted.marketing = pair[1] === "on" ? true : false;
              break;
      ...
      var cookieValue = JSON.stringify(this.cookiesAccepted);
      document.cookie = "".concat(name, "=").concat(cookieValue, ";expires=").concat(date.toGMTString(), ";path=/");
    }
  }, {
    key: "checkConsent",
    ...
    key: "setAdditionalServices",
    value: function setAdditionalServices() {
      var cookieConsent = this.getCookie(this.name);

      for (var _i = 0, _Object$entries = Object.entries(cookieConsent); _i < _Object$entries.length; _i++) {
        ...
        if (key === "necessary" && value === true) {
          new Promise(docsearchLoad).then(function () {
            (0,_vendor_doc_search__WEBPACK_IMPORTED_MODULE_2__.docSearchInit)();
          })["catch"](function (err) {
        ...
        if (key === "statistics" && value === true) {
          (0,_vendor_googleanalytics__WEBPACK_IMPORTED_MODULE_1__.googleAnalytics)();
        }
      }
    }
  }]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "searchShortcut": () => (/* binding */ searchShortcut)
/* harmony export */ });
...
function searchShortcut() {
  var pressForwardSlash = (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.default)(function (searchBar) {
    searchBar.focus();
  }, 400);
...
/* harmony export */   "clickLinkOnNavExpandDropDown": () => (/* binding */ clickLinkOnNavExpandDropDown),
/* harmony export */   "uncheckDropDownOnClick": () => (/* binding */ uncheckDropDownOnClick)
/* harmony export */ });
...
function clickLinkOnNavExpandDropDown() {
  var docsNav = document.querySelector(".r3-o-docs-nav");
...
function uncheckDropDownOnClick() {
  var docsNav = document.querySelector(".r3-o-docs-nav");

  if (docsNav) {
    var checkboxes = docsNav.querySelectorAll("input[type=checkbox]");
...
/***/ "./scripts/vendor/cookies-eu-banner.js":
/*!*********************************************!*\
  !*** ./scripts/vendor/cookies-eu-banner.js ***!
  \*********************************************/
/***/ ((module, exports) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "docSearchInit": () => (/* binding */ docSearchInit)
/* harmony export */ });
...
function googleAnalytics() {
  ...
  window.ga("create", "UA-87760032-1", "auto");
...
/* harmony import */ var _sitemap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sitemap */ "./scripts/sitemap.js");
...
/* harmony import */ var _search_shortcut__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./search-shortcut */ "./scripts/search-shortcut.js");
/* harmony import */ var _cookie_banner__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cookie-banner */ "./scripts/cookie-banner.js");
...
document.addEventListener("DOMContentLoaded", function () {
  (0,_anchorify__WEBPACK_IMPORTED_MODULE_0__.applyAnchors)();
  (0,_sitemap__WEBPACK_IMPORTED_MODULE_2__.scrollOffset)();
  (0,_nav__WEBPACK_IMPORTED_MODULE_1__.activateListeners)();
  (0,_activate_tabs__WEBPACK_IMPORTED_MODULE_3__.activateTabs)();
  (0,_search_shortcut__WEBPACK_IMPORTED_MODULE_4__.searchShortcut)();
  (0,_sitemap__WEBPACK_IMPORTED_MODULE_2__.clickLinkOnNavExpandDropDown)();
  (0,_sitemap__WEBPACK_IMPORTED_MODULE_2__.uncheckDropDownOnClick)();
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.scss */ "./styles/scss/main.scss");
