...
* [Auth Service](../../corda-enterprise/4.8/node/auth-service).
* [Gateway Service](../../corda-enterprise/4.8/node/gateway-service).
...
1. Deploy the [Auth Service](../../corda-enterprise/4.8/node/auth-service.md) using PostgreSQL on AWS.
