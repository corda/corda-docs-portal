...
{{/* /en/docs/cenm/1.2/services/src/test/resources/v1.1-configs/identity-manager/identity-manager-test-minimum-valid.conf */}}
...
{{/* /en/docs/cenm/1.2/services/src/test/resources/v1.1-configs/network-map/network-map-test-minimum-valid.conf */}}
