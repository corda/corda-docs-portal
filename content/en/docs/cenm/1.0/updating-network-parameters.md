---
aliases:
- /releases/release-1.0/updating-network-parameters.html
date: '2020-01-08T09:59:25Z'
menu:
  cenm-1-0:
    identifier: cenm-1-0-updating-network-parameters
...
{{< note >}}
If you are deploying a fresh Network Map service (rather than an upgrade), then you will need to run the above
command along with the `--ignore-migration` flag.
