...
The local signing service is recommended for testing and toy environments. Given a local key store containing the
                            ...
                            integrated signer that is a cut-down version of the standalone [Signing Service]({{< relref "signing-service" >}}) and provides no HSM integration or
...
##### External Signing Service
The production grade signing mechanism is the external [Signing Service]({{< relref "signing-service" >}}). This has all the functionality of the
...
##### External Signing Service
Also similarly to CSR signing, the production grade signing mechanism for CRRs is the external [Signing Service]({{< relref "signing-service" >}}).
...
{{/* /en/docs/cenm/1.1/services/src/test/resources/v1.1-configs/identity-manager/identity-manager-test-valid.conf */}}
...
Below is an example of a more production-like configuration of the Identity Manager. It is configured with a Issuance
                        ...
                        service (see [Signing Service]({{< relref "signing-service" >}})).
...
{{/* /en/docs/cenm/1.1/services/src/test/resources/v1.1-configs/identity-manager/identity-manager-prod-valid.conf */}}
