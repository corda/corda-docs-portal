...
The local signing service is recommended for testing and toy environments. Given a local key store containing the
                        ...
                        [Signing Service]({{< relref "signing-service" >}}) and provides no HSM integration or ability to manually verify changes. It is strongly recommended
...
{{/* /en/docs/cenm/1.1/services/src/test/resources/v1.1-configs/network-map/network-map-test-valid.conf */}}
