...
Custom serializer classes should follow the [rules for including classes](https://docs.corda.net/docs/corda-enterprise/4.8/cordapps/cordapp-build-systems.html#building-and-installing-a-cordapp).
