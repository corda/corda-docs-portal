...
menu:
  corda-enterprise-4-8:
    ...
    identifier: corda-enterprise-4-8-operations-guide-deployment-cenm-kubernetes-idman
tags:
- config
- kubernetes
...
This Helm chart is to configure, deploy, and run the CENM [Identity Manager Service](../../../../cenm/1.5/identity-manager.md) on Kubernetes.

## Example usage

The example below shows a command that triggers the Helm chart for the [Zone Service](../../../../cenm/1.5/zone-service.md):
...
| `dockerImage.tag`             | Docker image Tag for the Docker image used by the Identity Manager Service Helm chart | `1.5` |
...
| `dockerImageCli.tag`             | Docker image Tag for the Docker image used by the CENM Command-Line (CLI) tool Helm chart | `1.5` |
