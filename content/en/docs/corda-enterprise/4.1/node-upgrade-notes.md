...
Replace the `corda.jar` with the latest version of Corda.
                Make sure it’s available on your path, and that you’ve read the [Release notes for Corda 4]({{< relref "release-notes" >}}). Pay particular attention to which version of Java this
                node requires.
