...
aliases = [ "/releases/4.1/contract-upgrade.html",]
...
```
[ContractUpgradeFlow.kt](https://github.com/corda/enterprise/blob/release/ent/4.1/core/src/main/kotlin/net/corda/core/flows/ContractUpgradeFlow.kt)```kotlin
@StartableByRPC
...
```
[DummyContractV2.kt](https://github.com/corda/enterprise/blob/release/ent/4.1/testing/test-utils/src/main/kotlin/net/corda/testing/contracts/DummyContractV2.kt)
