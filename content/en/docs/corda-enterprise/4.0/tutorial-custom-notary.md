...
aliases = [ "/releases/4.0/tutorial-custom-notary.html",]
...
```
[MyCustomNotaryService.kt](https://github.com/corda/enterprise/blob/release/ent/4.0/samples/notary-demo/workflows/src/main/kotlin/net/corda/notarydemo/MyCustomNotaryService.kt)The next step is to write a notary service flow. You are free to copy and modify the existing built-in flows such
...
```
[MyCustomNotaryService.kt](https://github.com/corda/enterprise/blob/release/ent/4.0/samples/notary-demo/workflows/src/main/kotlin/net/corda/notarydemo/MyCustomNotaryService.kt)To enable the service, add the following to the node configuration:
