...
title = "API: Flows"
aliases = [ "/releases/4.0/api-flows.html",]
tags = [ "api", "flows",]
...
> 
> ```
> [AbstractCashSelection.kt](https://github.com/corda/enterprise/blob/release/ent/4.0/finance/workflows/src/main/kotlin/net/corda/finance/workflows/asset/selection/AbstractCashSelection.kt)
