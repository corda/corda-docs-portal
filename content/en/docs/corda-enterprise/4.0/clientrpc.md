...
aliases = [ "/releases/4.0/clientrpc.html",]
...
```
[BankOfCordaClientApi.kt](https://github.com/corda/enterprise/blob/release/ent/4.0/samples/bank-of-corda-demo/src/main/kotlin/net/corda/bank/api/BankOfCordaClientApi.kt)
{{< warning >}}
...
```
[BankOfCordaClientApi.kt](https://github.com/corda/enterprise/blob/release/ent/4.0/samples/bank-of-corda-demo/src/main/kotlin/net/corda/bank/api/BankOfCordaClientApi.kt)In this code snippet it is possible to see that the function `performRpcReconnect` creates an RPC connection and implements
