...
menu:
  corda-enterprise-4-3-1:
    identifier: corda-enterprise-4-3-1-jmeter-samplers
...
a flow in a given set-up.![empty flow sampler](/en/empty-flow-sampler.png "empty flow sampler")
...
of cash tokens on the node it is running on and store it in the vault.![cash issue sampler](/en/cash-issue-sampler.png "cash issue sampler")
...
invoking the full vault access, peer-to-peer communication and notarisation cycle.![cash issue and pay sampler](/en/cash-issue-and-pay-sampler.png "cash issue and pay sampler")
...
The classname of this sampler client is `com.r3.corda.jmeter.CashPaySampler`.![cash pay sampler](/en/cash-pay-sampler.png "cash pay sampler")
