---
aliases:
- /releases/4.2/upgrading-cordapps.html
...
Have each node operator stop their node. If you are also changing flow definitions, you should perform a
                        [node drain](operating/cm-updating-cordapp.md#draining-the-node) first to avoid the definition of states or contracts changing whilst a flow is
                        in progress.
