...
menu:
  corda-enterprise-4-2:
    identifier: corda-enterprise-4-2-testnet-explorer
    parent: corda-enterprise-4-2-corda-networks-testnet-decommission
    weight: 1070
tags:
- testnet
- explorer
...
```bash
http://software.r3.com/artifactory/corda-releases/net/corda/corda-tools-explorer/4.2/corda-tools-explorer-4.2.jar
```
