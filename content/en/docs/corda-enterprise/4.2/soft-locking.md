...
title = "Soft Locking"
aliases = [ "/releases/4.2/soft-locking.html",]
...
```
[QueryCriteria.kt](https://github.com/corda/enterprise/blob/release/ent/4.2/core/src/main/kotlin/net/corda/core/node/services/vault/QueryCriteria.kt)
## Explicit Usage
