---
aliases:
- /releases/4.2/deploying-a-node.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-2:
    identifier: corda-enterprise-4-2-deploying-a-node
...
* Create a Corda directory and copy the Enterprise Corda JAR `corda-4.2.jar`.
