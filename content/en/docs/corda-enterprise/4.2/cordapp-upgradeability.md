...
aliases = [ "/releases/4.2/cordapp-upgradeability.html",]
...
* Explicit Contract Upgrades are only supported for hash and CZ whitelisted constraint types. See [Performing explicit contract and state upgrades](operating/cm-updating-cordapp.md#explicit-contract-upgrades-ref) for more information.
