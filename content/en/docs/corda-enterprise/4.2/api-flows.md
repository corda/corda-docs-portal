...
title = "API: Flows"
aliases = [ "/releases/4.2/api-flows.html",]
tags = [ "api", "flows",]
...
> 
> ```
> [AbstractCashSelection.kt](https://github.com/corda/enterprise/blob/release/ent/4.2/finance/workflows/src/main/kotlin/net/corda/finance/workflows/asset/selection/AbstractCashSelection.kt)
