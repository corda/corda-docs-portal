---
aliases:
- /releases/4.2/node-database-developer.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-2:
    identifier: corda-enterprise-4-2-node-database-developer
    parent: corda-enterprise-4-2-corda-nodes
    weight: 1100
tags:
- node
- database
...
See the [Corda node upgrade notes](operating/cm-upgrading-node.md#node-upgrade-notes-update-database-ref) for more information.
