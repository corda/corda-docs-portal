...
[CordaRPCOps.kt](https://github.com/corda/enterprise/blob/release/ent/4.2/core/src/main/kotlin/net/corda/core/messaging/CordaRPCOps.kt)
...
of which share the same `linearId` (for example, such as the `IRSState` defined in the SIMM
