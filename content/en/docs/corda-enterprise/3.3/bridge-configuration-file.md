...
menu:
  corda-enterprise-3-3:
    identifier: corda-enterprise-3-3-bridge-configuration-file
...
[bridgedefault.conf](resources/bridge/bridgedefault.conf)
...
![ha bridge float socks](resources/bridge/ha_bridge_float_socks.png "ha bridge float socks")
