---
aliases:
- /releases/3.3/key-concepts-contracts.html
...
![tx validation](/en/images/tx-validation.png "tx validation")The contract code can be written in any JVM language, and has access to the full capabilities of the language,
                including:
...
Developers can pre-verify their CorDapps are determinsitic by linking their CorDapps against the deterministic modules
                (see the Deterministic Corda Modules).
