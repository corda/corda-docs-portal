---
aliases:
- /releases/3.3/deploying-a-node.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-3-3:
    identifier: corda-enterprise-3-3-deploying-a-node
...
Replace `VERSION_NUMBER` with the desired version. Here’s an example using PowerShell:```kotlin
mkdir C:\Corda
