...
```
{{% /tab %}}
{{/* github src='docs/source/running-a-notary-cluster/resources/node.conf' url='https://github.com/corda/enterprise/blob/3.2/docs/source/running-a-notary-cluster/resources/node.conf' raw='https://raw.githubusercontent.com/corda/enterprise/3.2/docs/source/running-a-notary-cluster/resources/node.conf' start='' end='' */}}

[node.conf](https://github.com/corda/enterprise/blob/release/ent/3.2/docs/source/running-a-notary-cluster/resources/node.conf) | ![github](/images/svg/github.svg "github")
