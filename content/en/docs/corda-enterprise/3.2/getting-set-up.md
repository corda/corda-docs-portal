---
aliases:
- /releases/3.2/getting-set-up.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-3-2:
    identifier: corda-enterprise-3-2-getting-set-up
...
* Checkout the corresponding branch for Corda Enterprise 3.2 by running `git checkout release-enterprise-V3` in the current directory
...
binaries will be made available to your organisation as a compressed tarball (`corda-3.2-developer-pack.tar.gz`).
...
be done by firstly unpacking the `corda-3.2-developer-pack.tar.gz` compressed tarball. Then, copy the unpacked
...
{{< /note >}}
be done by firstly unpacking the `corda-3.2-developer-pack.tar.gz` compressed tarball:

`tar -xvzf corda-3.2-developer-pack.tar.gz`
