---
aliases:
- /releases/3.2/upgrade-notes.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-3-2:
    identifier: corda-enterprise-3-2-upgrade-notes
...
These notes provide instructions for upgrading your CorDapps from previous versions of Corda to version Corda Enterprise 3.2.



## Upgrading from Corda Open Source

A prerequisite to upgrade to Corda Enterprise 3.2 is to ensure your CorDapp is upgraded to Open Source Corda 3.x.
Please follow the instructions in the [Corda Open Source upgrade notes](https://docs.corda.net/releases/release-V3.2/upgrade-notes.html)
...
{{< /note >}}
Upgrading to Corda Enterprise 3.2 from Open Source 3.x requires updating build file properties. For Gradle:
...
{{< note >}}
Corda Enterprise 3.2 binaries are not available in a public repository. In order to make the dependencies available for development, either create a mirror repository and upload them there, or add them to the local Maven repository.
...
Corda Enterprise 3.2 uses Kotlin API and language version 1.2. The specifics are
...
A limited distribution preview of Corda Enterprise 3.2 was made available to a small number of users. If your app uses this version, here are some specific notes on how to upgrade to the Generally Available release:
