...
{{< warning >}}
Before you start the upgrade, you must consult the [CENM Release Notes](../../../../cenm/1.3/release-notes.md) to confirm all changes between releases.
{{< /warning >}}
...
for generating the full SSL hierarchy is provided under [config-samples/upgrade-pki-tool-1.3.conf](../../../../cenm/1.3/config-samples/upgrade-pki-tool-1.3.conf).
