...
{{<warning>}}
Corda Enterprise 4.3.7 fixes a key security vulnerability. Before upgrading to Corda Enterprise 4.3.7 please read the guidance on [upgrading your notary service](notary/upgrading-the-ha-notary-service.md/).
{{</warning>}}
...
* The [new withEntityManager API](https://api.corda.net/api/corda-os/4.3/html/api/javadoc/net/corda/core/node/ServiceHub.html#withEntityManager-block-) for using JPA inside your flows and services.
