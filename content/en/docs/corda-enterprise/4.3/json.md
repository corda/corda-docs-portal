---
aliases:
- /releases/4.3/json.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-3:
    identifier: corda-enterprise-4-3-json
    parent: corda-enterprise-4-3-serialization-index
    weight: 1050
tags:
- json
title: JSON
...
* [Kotlin API docs](https://api.corda.net/api/corda-enterprise/4.3/html/api/kotlin/corda/net.corda.client.jackson/-jackson-support/index.html)
* [JavaDoc](https://api.corda.net/api/corda-enterprise/4.3/html/api/javadoc/net/corda/client/jackson/package-summary.html)
