...
![flowTriageView](/en/images/flowTriageView.png "flowTriageView")As of Corda Enterprise 4.3, this UI is informational only (read-only). Future versions of Corda will extend the basic functionality to enable
