---
aliases:
- /releases/4.4/api-persistence.html
...
```
{{/* github src='core/src/main/kotlin/net/corda/core/schemas/PersistentTypes.kt' url='https://github.com/corda/enterprise/blob/release/ent/4.4/core/src/main/kotlin/net/corda/core/schemas/PersistentTypes.kt' raw='https://raw.githubusercontent.com/corda/enterprise/release/ent/4.4/core/src/main/kotlin/net/corda/core/schemas/PersistentTypes.kt' start='DOCSTART QueryableState' end='DOCEND QueryableState' */}}[SchemaService.kt](https://github.com/corda/enterprise/blob/release/ent/4.4/node/src/main/kotlin/net/corda/node/services/api/SchemaService.kt)
...
```
{{/* github src='node/src/main/kotlin/net/corda/node/services/api/SchemaService.kt' url='https://github.com/corda/enterprise/blob/release/ent/4.4/node/src/main/kotlin/net/corda/node/services/api/SchemaService.kt#L8-L28' raw='https://raw.githubusercontent.com/corda/enterprise/release/ent/4.4/node/src/main/kotlin/net/corda/node/services/api/SchemaService.kt' start='DOCSTART SchemaService' end='DOCEND SchemaService' */}}[HibernateConfigurationTest.kt](https://github.com/corda/enterprise/blob/release/ent/4.4/node/src/test/kotlin/net/corda/node/services/persistence/HibernateConfigurationTest.kt)
...
```
{{/* github src='core/src/main/kotlin/net/corda/core/schemas/PersistentTypes.kt' url='https://github.com/corda/enterprise/blob/release/ent/4.4/core/src/main/kotlin/net/corda/core/schemas/PersistentTypes.kt' raw='https://raw.githubusercontent.com/corda/enterprise/release/ent/4.4/core/src/main/kotlin/net/corda/core/schemas/PersistentTypes.kt' start='DOCSTART MappedSchema' end='DOCEND MappedSchema' */}}[CustomVaultQuery.kt](https://github.com/corda/enterprise/blob/release/ent/4.4/docs/source/example-code/src/main/kotlin/net/corda/docs/kotlin/vault/CustomVaultQuery.kt)
...
```
{{/* github src='finance/contracts/src/main/kotlin/net/corda/finance/schemas/CashSchemaV1.kt' url='https://github.com/corda/enterprise/blob/release/ent/4.4/finance/contracts/src/main/kotlin/net/corda/finance/schemas/CashSchemaV1.kt' raw='https://raw.githubusercontent.com/corda/enterprise/release/ent/4.4/finance/contracts/src/main/kotlin/net/corda/finance/schemas/CashSchemaV1.kt' start='' end='' */}}[CustomVaultQuery.kt](https://github.com/corda/enterprise/blob/release/ent/4.4/docs/source/example-code/src/main/kotlin/net/corda/docs/kotlin/vault/CustomVaultQuery.kt)
