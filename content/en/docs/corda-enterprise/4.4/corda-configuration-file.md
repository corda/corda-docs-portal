...
The number of threads available to execute external operations that have been called from flows. See the documentation on
                            [calling external systems inside flows]({{< relref "api-flows#api-flows-external-operations" >}}) for more information.
...
>                                                         metric exposed by the notary to determine batch utilisation. For more information, see [Highly-available notary metrics]({{< relref "running-a-notary-cluster/notary-metrics" >}})
> 
> *Default:* 500
> 
> 
...
{{/* /en/docs/corda-enterprise/4.4/node/src/main/resources/reference.conf */}}
...
{{/* /en/docs/corda-enterprise/4.4/docs/source/example-code/src/main/resources/example-node.conf */}}
```none
...
{{/* /en/docs/corda-enterprise/4.4/docs/source/example-code/src/main/resources/example-node-with-networkservices.conf */}}
