---
aliases:
- /releases/4.4/running-a-notary-cluster/backup-restore.html
...
![storage components](running-a-notary-cluster/resources/storage-components.png "storage components")
