...
{{/* /en/docs/corda-enterprise/4.4/docs/source/running-a-notary-cluster/resources/node.conf */}}
{{< /tabs >}}

See [Node configuration]({{< relref "../corda-configuration-file" >}}) for a complete reference.
...
{{/* /en/docs/corda-enterprise/4.4/docs/source/running-a-notary-cluster/resources/percona.conf */}}
{{< /tabs >}}
...
Corda Enterprise comes with a tool for obfuscating secret values in configuration files, which is strongly recommended for production deployments.
                ...
                the configuration file should be obfuscated. Usage instructions can be found on the [Configuration Obfuscator]({{< relref "../tools-config-obfuscator" >}}) page.
...
{{/* /en/docs/corda-enterprise/4.4/docs/source/running-a-notary-cluster/resources/config_obfuscator */}}

## Obtaining the notary service identity
The notary service is registered with the CENM identity service using the registration tool as documented in [notary registration]({{< relref "../ha-utilities#notary-reg-tool" >}}).
                Once the service is registered, each worker node is registered using the `initial-registration` process. See [Joining an existing compatibility zone]({{< relref "../joining-a-compatibility-zone" >}}).
