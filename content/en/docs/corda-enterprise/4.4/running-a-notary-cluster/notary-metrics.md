---
aliases:
- /releases/4.4/running-a-notary-cluster/notary-metrics.html
...
A notary exports the standard metrics exported by all Corda nodes (see [Node administration](../node-administration.md)), plus the
