...
```
{{/* github src='bridge/src/main/resources/firewalldefault_latest.conf' url='https://github.com/corda/enterprise/blob/release/ent/4.4/bridge/src/main/resources/firewalldefault_latest.conf' raw='https://raw.githubusercontent.com/corda/enterprise/release/ent/4.4/bridge/src/main/resources/firewalldefault_latest.conf' start='' end='' */}}[firewalldefault_latest.conf](https://github.com/corda/enterprise/blob/release/ent/4.4/bridge/src/main/resources/firewalldefault_latest.conf)
...
![deployment concept](node/../resources/ha/deployment_concept.png "deployment concept")
...
![Infra](node/../resources/ha/Infra.png "Infra")
