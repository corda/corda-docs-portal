...
* Ensure CorDapps contain Liquibase database management scripts.
                            ...
                            [to add the script retrospectively]({{< relref "../../cordapps/database-management#database-management-add-liquibase-retrospectively-ref" >}}).
...
* Create a database schema and configure a Corda node to connect to the new database following [Database schema setup]({{< relref "node-database-admin" >}}) instructions
                            ...
                            Refer to [Understanding the node database]({{< relref "node-database" >}}) to decide which setup is more suitable.
