...
```
{{< img src="network/resources/explorer-login.png" alt="explorer login" >}}
...
{{< img src="network/resources/explorer-network.png" alt="explorer network" >}}
...
{{< img src="network/resources/explorer-cash-issue1.png" alt="explorer cash issue1" >}}

Now click on `New Transaction` and create an issuance to a known counterparty on the network by filling in the form:

{{< img src="network/resources/explorer-cash-issue2.png" alt="explorer cash issue2" >}}

Click `Execute` and the transaction will start.

{{< img src="network/resources/explorer-cash-issue3.png" alt="explorer cash issue3" >}}
...
{{< img src="network/resources/explorer-transactions.png" alt="explorer transactions" >}}
