---
aliases:
- /releases/4.4/sizing-and-performance.html
...
but the notary state is maintained in a version of MySQL utilising a clustering technology as described in [Corda Enterprise HA notary service set-up](running-a-notary-cluster/ha-notary-service-setup.md).
