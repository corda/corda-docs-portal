...
```
[im-config-pre-obfuscation.conf](https://github.com/corda/enterprise/blob/release/ent/4.4/docs/source/resources/config-files/cenm-1.1/im-config-pre-obfuscation.conf)
...
```
[im-config-post-obfuscation.conf](https://github.com/corda/enterprise/blob/release/ent/4.4/docs/source/resources/config-files/cenm-1.1/im-config-post-obfuscation.conf)
