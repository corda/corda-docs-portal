...
aliases = [ "/releases/4.4/cenm/enm-components.html",]
...
![enm high level](cenm/../resources/enm-high-level.png "enm high level")The three main components of the CENM suite are
