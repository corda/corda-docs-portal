---
aliases:
- /releases/4.4/cli-application-shell-extensions.html
...
[Database Manager](database-management.md)                `database-manager --<option>`  `corda-tools-database-manager-4.4.jar`
