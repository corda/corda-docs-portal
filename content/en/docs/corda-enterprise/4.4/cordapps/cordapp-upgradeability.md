...
* Explicit Contract Upgrades are only supported for hash and CZ whitelisted constraint types. See [Performing explicit contract and state upgrades]({{< relref "../node/operating/cm-updating-cordapp#explicit-contract-upgrades-ref" >}}) for more information.
