---
aliases:
- /releases/4.4/ZZPotential-delete-docs/tutorial-cordapp.html
...
the IDE
* Click the green arrow to start the nodes:![run config drop down](ZZPotential-delete-docs/resources/run-config-drop-down.png "run config drop down")
...
(see network-bootstrapper) to update the files and have them distributed locally:`java -jar network-bootstrapper.jar workflows-kotlin/build/nodes`
