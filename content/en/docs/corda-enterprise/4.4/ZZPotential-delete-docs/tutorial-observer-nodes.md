...
aliases = [ "/releases/4.4/ZZPotential-delete-docs/tutorial-observer-nodes.html",]
...
If the states define a relational mapping (see api-persistence) then the regulator will be able to query the
