...
The configuration fields are listed in [Corda Enterprise Firewall configuration fields](corda-firewall-configuration-file).
...
as well as no proxy at all. For more information please see [proxyConfig](corda-firewall-configuration-file.md#proxyconfig).
