...
menu:
  corda-enterprise-4-6:
    identifier: corda-enterprise-4-6-contract-irs
    name: "Interest rate swaps"
    parent: corda-enterprise-4-6-component-library-index
tags:
- contract
- irs
...
{{< figure alt="contract irs" zoom="./resources/contract-irs.png" >}}
