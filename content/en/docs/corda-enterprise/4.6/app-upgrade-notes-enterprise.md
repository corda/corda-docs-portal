...
{{<warning>}}
Corda Enterprise 4.6.3 fixes a key security vulnerability. Before upgrading to Corda Enterprise 4.6.3 please read the guidance on [upgrading your notary service](notary/upgrading-the-ha-notary-service.md/).
{{</warning>}}
