...
{{< figure alt="hierarchy agnostic" zoom="../resources/hierarchy-agnostic.png" >}}
...
{{< figure alt="tls hierarchy" zoom="../resources/tls-hierarchy.png" >}}
...
{{< figure alt="example hierarchy" zoom="../resources/example-hierarchy.png" >}}
