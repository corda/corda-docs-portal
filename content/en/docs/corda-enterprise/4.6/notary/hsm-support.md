...
{{< figure alt="hsm support" zoom="../resources/hsm-support.png" >}}
...
network. See [Welcome to the Corda Enterprise Network Manager](https://docs.corda.net/docs/cenm/1.4.html) for more information. The legal identity certificate is issued by the node certificate authority.
