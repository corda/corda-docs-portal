...
menu:
  corda-enterprise-4-6:
    parent: corda-enterprise-4-6-cordapps-contracts
tags:
- contract
- upgrade
...
[DummyContractV2.kt](https://github.com/corda/enterprise/blob/release/ent/4.6/testing/test-utils/src/main/kotlin/net/corda/testing/contracts/DummyContractV2.kt)
