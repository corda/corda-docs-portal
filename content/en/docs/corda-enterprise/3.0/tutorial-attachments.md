---
aliases:
- /releases/3.0/tutorial-attachments.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-3-0:
    identifier: corda-enterprise-3-0-tutorial-attachments
...
```
{{% /tab %}}
{{/* github src='node/src/test/kotlin/net/corda/node/services/persistence/NodeAttachmentStorageTest.kt' url='https://github.com/corda/enterprise/blob/3.0/node/src/test/kotlin/net/corda/node/services/persistence/NodeAttachmentStorageTest.kt#L163-L181' raw='https://raw.githubusercontent.com/corda/enterprise/3.0/node/src/test/kotlin/net/corda/node/services/persistence/NodeAttachmentStorageTest.kt' start='DOCSTART AttachmentQueryExample1' end='DOCEND AttachmentQueryExample1' */}}
