---
aliases:
- /releases/3.0/design/float/design.html
...
[![current p2p state](/en/current-p2p-state.png "current p2p state")](/en/current-p2p-state.png)
...
[![full float](/en/full-float.png "full float")](/en/full-float.png)
...
[![in process amqp bridging](/en/in-process-amqp-bridging.png "in process amqp bridging")](/en/in-process-amqp-bridging.png)
...
[![out of proc artemis broker bridges](/en/out-of-proc-artemis-broker-bridges.png "out of proc artemis broker bridges")](/en/out-of-proc-artemis-broker-bridges.png)
