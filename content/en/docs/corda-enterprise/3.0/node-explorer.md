---
aliases:
- /releases/3.0/node-explorer.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-3-0:
    identifier: corda-enterprise-3-0-node-explorer
...
Node Explorer assumes that “corda-finance-3.0.jar” CorDapp is deployed on the node.
...
The tool is distributed in the form of runnable JAR file: “corda-tools-explorer-3.0.jar”.


## Running the UI

```kotlin
java -jar corda-tools-explorer-3.0.jar
```
