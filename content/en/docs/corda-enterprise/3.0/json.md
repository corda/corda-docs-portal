---
aliases:
- /releases/3.0/json.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-3-0:
    identifier: corda-enterprise-3-0-json
...
* [JavaDoc](https://api.corda.net/api/corda-enterprise/3.0/html/api/javadoc/net/corda/client/jackson/package-summary.html)
* [Kotlin API docs](https://api.corda.net/api/corda-enterprise/3.0/html/api/kotlin/corda/net.corda.client.jackson/-jackson-support/index.html)
