---
aliases:
- /releases/release-V3.4/json.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-3-4:
    identifier: corda-os-3-4-json
...
* [Kotlin API docs](https://api.corda.net/api/corda-os/3.4/html/api/kotlin/corda/net.corda.client.jackson/-jackson-support/index.html)
* [JavaDoc](https://api.corda.net/api/corda-os/3.4/html/api/javadoc/net/corda/client/jackson/package-summary.html)
