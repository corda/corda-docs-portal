...
aliases = [ "/releases/release-V3.4/contract-upgrade.html",]
menu = [ "corda-os-3-4",]
...
```
[ContractUpgradeFlow.kt](https://github.com/corda/corda/blob/release/os/3.4/core/src/main/kotlin/net/corda/core/flows/ContractUpgradeFlow.kt)```kotlin
@StartableByRPC
...
```
[ContractUpgradeFlow.kt](https://github.com/corda/corda/blob/release/os/3.4/core/src/main/kotlin/net/corda/core/flows/ContractUpgradeFlow.kt)
...
```
[DummyContractV2.kt](https://github.com/corda/corda/blob/release/os/3.4/testing/test-utils/src/main/kotlin/net/corda/testing/contracts/DummyContractV2.kt)
