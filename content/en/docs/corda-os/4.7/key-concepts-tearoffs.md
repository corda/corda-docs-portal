...
menu:
  corda-os-4-7:
    identifier: corda-os-4-7-key-concepts-tearoffs
...
{{< figure alt="merkleTreeFull" zoom="/en/images/merkleTreeFull.png" >}}
...
{{< figure alt="SubMerkleTree Oracle" zoom="/en/images/SubMerkleTree_Oracle.png" >}}
...
{{< figure alt="SubMerkleTree Notary" zoom="/en/images/SubMerkleTree_Notary.png" >}}
