...
{{/* /en/docs/corda-os/4.1/docs/source/example-code/src/main/kotlin/net/corda/docs/kotlin/tutorial/flowstatemachines/TutorialFlowStateMachines.kt */}}
{{< /tabs >}}
...
{{/* /en/docs/corda-os/4.1/finance/workflows/src/main/kotlin/net/corda/finance/flows/TwoPartyTradeFlow.kt */}}
{{< /tabs >}}
...
If a node has flows still in a suspended state, with flow continuations written to disk, it will not be
                    ...
                    [Draining the node]({{< relref "upgrading-cordapps#draining-the-node" >}}) for details). While there are mechanisms for “evolving” serialised data held
...
{{/* /en/docs/corda-os/4.1/docs/source/example-code/src/main/java/net/corda/docs/java/tutorial/flowstatemachines/TutorialFlowStateMachines.java */}}
{{< /tabs >}}
