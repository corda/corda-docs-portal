...
aliases = [ "/releases/release-V4.0/release-notes.html",]
menu = [ "corda-os-4-0",]
tags = [ "release", "notes",]
+++
...
{{< important >}}
We strongly recommend reading “[Upgrading apps to Corda 4](app-upgrade-notes.md)”. This covers the upgrade procedure,
