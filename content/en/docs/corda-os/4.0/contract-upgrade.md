...
aliases = [ "/releases/release-V4.0/contract-upgrade.html",]
menu = [ "corda-os-4-0",]
...
```
[ContractUpgradeFlow.kt](https://github.com/corda/corda/blob/release/os/4.0/core/src/main/kotlin/net/corda/core/flows/ContractUpgradeFlow.kt)```kotlin
@StartableByRPC
...
```
[ContractUpgradeFlow.kt](https://github.com/corda/corda/blob/release/os/4.0/core/src/main/kotlin/net/corda/core/flows/ContractUpgradeFlow.kt)
...
```
[DummyContractV2.kt](https://github.com/corda/corda/blob/release/os/4.0/testing/test-utils/src/main/kotlin/net/corda/testing/contracts/DummyContractV2.kt)
