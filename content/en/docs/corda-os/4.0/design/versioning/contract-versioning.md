---
aliases:
- /releases/release-V4.0/design/versioning/contract-versioning.html
...
version’ will be used for the regular release, and be part of the jar name.

Also, when packaging the contract for release, the `version` should be added by the plugin to the manifest file, together with other properties like 
{{< warning >}}`{{< /warning >}}
