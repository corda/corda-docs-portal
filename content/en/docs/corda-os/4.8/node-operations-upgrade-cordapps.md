...
menu:
  corda-os-4-8:
    identifier: corda-os-4-8-node-operations-upgrade-cordapps
...
Management Tool as detailed [here](../../corda-enterprise/4.8/node/operating/node-operations-cordapp-deployment.md/).
* Restart the node
