...
menu:
  corda-os-4-8:
    identifier: corda-os-4-8-upgrading-cordapps
...
{{< figure alt="flow interface" zoom="/en/images/flow-interface.png" >}}
...
The general recommendation for Corda 4.8 is to use **implicit** upgrades for the reasons described [here](api-contract-constraints.md#implicit-vs-explicit-upgrades).
