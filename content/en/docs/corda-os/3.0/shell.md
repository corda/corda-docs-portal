---
aliases:
- /releases/release-V3.0/shell.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-3-0:
    identifier: corda-os-3-0-shell
...
Several parameter types can automatically be mapped from strings. See the [defined parsers](https://api.corda.net/api/corda-os/3.0/html/api/kotlin/corda/net.corda.client.jackson/-jackson-support/index.html) for more information. We
