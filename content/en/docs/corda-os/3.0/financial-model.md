---
aliases:
- /releases/release-V3.0/financial-model.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-3-0:
    identifier: corda-os-3-0-financial-model
    parent: corda-os-3-0-component-library-index
    weight: 1030
tags:
- financial
- model
...
The [Amount](https://api.corda.net/api/corda-os/3.0/html/api/kotlin/corda/net.corda.core.contracts/-amount/index.html) class is used to represent an amount of
