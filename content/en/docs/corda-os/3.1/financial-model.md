---
aliases:
- /releases/release-V3.1/financial-model.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-3-1:
    identifier: corda-os-3-1-financial-model
...
The [Amount](https://api.corda.net/api/corda-os/3.1/html/api/kotlin/corda/net.corda.core.contracts/-amount/index.html) class is used to represent an amount of
