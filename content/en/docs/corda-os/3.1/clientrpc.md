---
aliases:
- /releases/release-V3.1/clientrpc.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-3-1:
    identifier: corda-os-3-1-clientrpc
...
The starting point for the client library is the [CordaRPCClient](https://api.corda.net/api/corda-os/3.1/html/api/javadoc/net/corda/client/rpc/CordaRPCClient.html) class. [CordaRPCClient](https://api.corda.net/api/corda-os/3.1/html/api/javadoc/net/corda/client/rpc/CordaRPCClient.html) provides a `start` method
that returns a [CordaRPCConnection](https://api.corda.net/api/corda-os/3.1/html/api/javadoc/net/corda/client/rpc/CordaRPCConnection.html). A [CordaRPCConnection](https://api.corda.net/api/corda-os/3.1/html/api/javadoc/net/corda/client/rpc/CordaRPCConnection.html) allows you to access an implementation of the
[CordaRPCOps](https://api.corda.net/api/corda-os/3.1/html/api/javadoc/net/corda/core/messaging/CordaRPCOps.html) interface with `proxy` in Kotlin or `getProxy()` in Java. The observables that are returned by RPC
...
{{< warning >}}
The returned [CordaRPCConnection](https://api.corda.net/api/corda-os/3.1/html/api/javadoc/net/corda/client/rpc/CordaRPCConnection.html) is somewhat expensive to create and consumes a small amount of
server side resources. When you’re done with it, call `close` on it. Alternatively you may use the `use`
method on [CordaRPCClient](https://api.corda.net/api/corda-os/3.1/html/api/javadoc/net/corda/client/rpc/CordaRPCClient.html) which cleans up automatically after the passed in lambda finishes. Don’t create
