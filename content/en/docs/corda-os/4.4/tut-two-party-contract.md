...
{{/* /en/docs/corda-os/4.4/docs/source/example-code/src/main/kotlin/net/corda/docs/kotlin/tutorial/twoparty/IOUContract.kt */}}
...
{{/* /en/docs/corda-os/4.4/docs/source/example-code/src/main/java/net/corda/docs/java/tutorial/twoparty/IOUContract.java */}}
{{< /tabs >}}
