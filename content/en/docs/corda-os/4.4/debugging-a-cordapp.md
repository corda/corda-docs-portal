...
* Define a network using the node driver as per [Integration testing]({{< relref "tutorial-integration-testing" >}})
...
See [Enabling remote debugging]({{< relref "node-commandline#enabling-remote-debugging" >}}).
