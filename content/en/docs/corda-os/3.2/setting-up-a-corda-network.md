---
aliases:
- /releases/release-V3.2/setting-up-a-corda-network.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-3-2:
    identifier: corda-os-3-2-setting-up-a-corda-network
...
[example-node.conf](https://github.com/corda/corda/blob/release/os/3.2/docs/source/example-code/src/main/resources/example-node.conf)
