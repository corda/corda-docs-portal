...
- /docs/corda-os/head/financial-model.html
- /docs/corda-os/financial-model.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-4-4:
    identifier: corda-os-4-4-financial-model
    parent: corda-os-4-4-component-library-index
    weight: 1020
tags:
- financial
- model
...
The [Amount](https://api.corda.net/api/corda-os/4.4/html/api/kotlin/corda/net.corda.core.contracts/-amount/index.html) class is used to represent an amount of
