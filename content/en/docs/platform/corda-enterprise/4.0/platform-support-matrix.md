...
Production use of Corda Enterprise 4.0 is only supported on Linux OS, see details below.
...
{{< /note >}}
Other distributions of the [OpenJDK](https://openjdk.java.net/) are not officially supported but should be compatible with Corda Enterprise 4.0.
