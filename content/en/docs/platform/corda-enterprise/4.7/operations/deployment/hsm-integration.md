...
{{< codesample file="/content/en/docs/platform/corda-enterprise/codesamples/AWSCloudConfiguration.java" >}}
...
{{< codesample file="/content/en/docs/platform/corda-enterprise/codesamples/AWSCloudConfigurationParser.java" >}}
...
{{< codesample file="/content/en/docs/platform/corda-enterprise/codesamples/AWSCloudCryptoServiceProvider.java" >}}
...
{{< codesample file="/content/en/docs/platform/corda-enterprise/codesamples/com.r3.corda.utils.CryptoServiceProvider" >}}
...
{{< codesample file="/content/en/docs/platform/corda-enterprise/codesamples/AWSCloudCryptoService.java" >}}
