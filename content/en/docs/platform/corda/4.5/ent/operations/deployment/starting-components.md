...
{{< note >}}
If a node is registered but not started and the [Network Map Service](../../../../cenm/1.3/network-map.html#network-map-service) goes down before the first start of the node, the node will fail to restart.
{{< /note >}}
