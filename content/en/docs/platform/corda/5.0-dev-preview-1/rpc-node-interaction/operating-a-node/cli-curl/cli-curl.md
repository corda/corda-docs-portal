...
menu:
  corda-5-dev-preview:
    ...
    identifier: corda-5-dev-preview-1-rpc-node-interaction-cli-curl
    weight: 700
project: corda-5
...
The Corda Node CLI `.jar` file is available for download from Artifactory.
...
![Try it out](tryitout.png "Try it out")
