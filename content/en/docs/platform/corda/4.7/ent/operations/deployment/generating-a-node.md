...
* The Corda JAR, downloaded from [https://r3.bintray.com/corda/net/corda/corda/](https://r3.bintray.com/corda/net/corda/corda/) (under /4.7/corda-4.7.jar)
...
* **Optional:** A webserver JAR entitled `corda-webserver-4.7.jar` that will connect to the node via RPC
