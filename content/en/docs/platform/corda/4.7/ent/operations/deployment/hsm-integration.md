...
{{< codesample file="/content/en/docs/platform/corda/4.8/codesamples/AWSCloudConfiguration.java" >}}
...
{{< codesample file="/content/en/docs/platform/corda/4.8/codesamples/AWSCloudConfigurationParser.java" >}}
...
{{< codesample file="/content/en/docs/platform/corda/4.8/codesamples/AWSCloudCryptoServiceProvider.java" >}}
...
{{< codesample file="/content/en/docs/platform/corda/4.8/codesamples/com.r3.corda.utils.CryptoServiceProvider" >}}
...
{{< codesample file="/content/en/docs/platform/corda/4.8/codesamples/AWSCloudCryptoService.java" >}}
