...
The Metering Collection Tool is distributed as part of Corda Enterprise 4.7 under the name `corda-tools-metering-collector-4.7.jar`. You must place this `.jar` file in the `cordapps` directory of the node.
...
[CorDapp configuration file](/docs/corda-os/4.7/cordapp-build-systems.html#cordapp-configuration-files) for the CorDapp.
