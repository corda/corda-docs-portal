...
{{< note >}}
To determine which *minimumPlatformVersion* a zone must mandate in order to permit all the features of Corda 4.8, see [Corda features and versions](../features-versions.md).
