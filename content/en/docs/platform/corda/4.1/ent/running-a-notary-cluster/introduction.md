---
aliases:
- /releases/4.1/running-a-notary-cluster/introduction.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-1:
    identifier: corda-enterprise-4-1-introduction
...
![HA notary overview](/resources/ha-notary-overview2.png "HA Notary overview")
...
![Percona Colocated](/resources/percona-colocated.png "Percona Colocated")
  :scale: 50%
