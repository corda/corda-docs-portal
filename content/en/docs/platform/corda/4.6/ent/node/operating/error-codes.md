...
menu:
  corda-enterprise-4-6:
    identifier: corda-enterprise-4-6-error-codes
...
For a list of error codes specific to Corda Enterprise Network Manager (CENM), see [CENM error codes](../../../../cenm/1.4/cenm-error-codes.md).
