...
* An [Auth Service](../../corda-enterprise/4.8/node/auth-service.md) deployment to handle user authentication and authorisation.
* A [Gateway Service](../../corda-enterprise/4.8/node/gateway-service.md) deployment to act as a gateway from the user interface (CLI) to the back-end services.
