...
This Helm chart is to configure, deploy, and run the [Gateway Service](../../corda-enterprise/4.8/node/gateway-service.md) on Kubernetes.
...
| `gatewayImage.tag`               | Docker image tag | `1.5` |
