...
You access the User Admin tool from the location of your [FARM Service]({{< relref "gateway-service.md#manage-farm-service-configuration" >}}) instance. Enter the full address of your FARM Service, including the port number, followed by `/admin` into a web browser.
