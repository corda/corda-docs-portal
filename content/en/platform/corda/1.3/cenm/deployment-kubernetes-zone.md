...
This Helm chart is to configure, deploy, and run the [CENM Zone Service]({{< relref "zone-service.md" >}}) on Kubernetes.
...
| `image.tag`                   | Docker image Tag | `1.3.5-zulu-openjdk8u242` |
