...
1. Use the Corda Enterprise Configuration Obfuscator tool. See [Configuration Obfuscator](../../../../../en/platform/corda/4.5/enterprise/tools-config-obfuscator.md) for more information.
