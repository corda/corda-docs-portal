...
## Corda Enterprise Network Manager 1.1.1
...
See [Config migration tool]({{< relref "../../../../../en/platform/corda/1.2/cenm/tool-config-migration.md" >}}) for details on this tool.
...
queue” of older versions. See [Configuring the ENM services to use SSL]({{< relref "enm-with-ssl.md" >}}) for more information.
