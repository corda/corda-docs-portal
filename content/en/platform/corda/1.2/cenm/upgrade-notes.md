...
config files. 0.2.2 and 0.3 / 0.4 config files can be migrated to 1.0 using the [Config migration tool](../../../../../en/platform/corda/1.2/cenm/tool-config-migration.html)
