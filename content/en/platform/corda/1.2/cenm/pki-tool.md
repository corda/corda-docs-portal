...
As outlined in the [Configuring the ENM services to use SSL]({{< relref "enm-with-ssl.md" >}}) doc, all inter-service CENM communication can be configured to encrypt their
...
HSMs. Refer to the [Signing services]({{< relref "signing-service.md" >}}) documentation for more information.
