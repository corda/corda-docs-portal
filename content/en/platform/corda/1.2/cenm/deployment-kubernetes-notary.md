...
For additional information on database connection details refer to the [Corda database documentation](../../../../../en//archived-docs/corda-os/4.4/corda-configuration-file.html#configuration-file-fields).
