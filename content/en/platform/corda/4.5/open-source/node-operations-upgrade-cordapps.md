...
menu:
  corda-os-4-5:
    identifier: corda-os-4-5-node-operations-upgrade-cordapps
...
Management Tool as detailed [here](../../corda-enterprise/4.5/node/operations/node-operations-cordapp-deployment.md/).
* Restart the node
