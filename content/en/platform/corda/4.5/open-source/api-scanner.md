...
menu:
  corda-os-4-5:
    identifier: corda-os-4-5-api-scanner
...
new Corda release. The stable Corda modules are listed [here](api-stability-guarantees.html#api-stability-guarantees). Our CI process runs an “API Stability”
...
or anything in a module that isn’t in the stable modules list [here](api-stability-guarantees.html#api-stability-guarantees).
