...
menu:
  ...
  corda-os-4-5:
    weight: 1
    name: Corda Open Source 4.5
project: corda
section_menu: corda-os-4-5
title: Corda Open Source 4.5
version: 'Open source 4.5'
---
...
**Want to start coding on Corda?** Familiarise yourself with the [key concepts](../../../../../en/platform/corda/4.5/open-source/key-concepts.md), then read
