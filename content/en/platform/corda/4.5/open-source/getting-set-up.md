...
menu:
  corda-os-4-5:
    identifier: corda-os-4-5-getting-set-up
...
{{< note >}} Visit the [platform support matrix](../../../../../en/platform/corda/4.5/enterprise/platform-support-matrix.md) to check the latest third-party application versions supported by Corda. {{< /note >}}
