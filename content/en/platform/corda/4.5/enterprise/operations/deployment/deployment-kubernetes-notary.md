...
| `dockerImage.tag`             | Docker image Tag | `4.4.10-zulu-openjdk8u242` |
...
For additional information on database connection details refer to the [Corda database documentation](../../../../../../../en/platform/corda/4.5/open-source/corda-configuration-file.html#configuration-file-fields).
