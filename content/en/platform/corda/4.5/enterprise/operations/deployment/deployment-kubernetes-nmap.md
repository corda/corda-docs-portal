...
menu:
  corda-enterprise-4-5:
    ...
    identifier: corda-enterprise-4-5-operations-guide-deployment-cenm-kubernetes-nmap
tags:
- config
- kubernetes
...
This Helm chart is to configure, deploy, and run the [CENM Network Map Service](../../../../../../../en/platform/corda/1.3/cenm/network-map.md) on Kubernetes.
...
| `dockerImage.tag`             | Docker image tag | `1.3.5-zulu-openjdk8u242` |
...
| `dockerImageCli.tag`          | Docker image tag | `1.3.5-zulu-openjdk8u242` |
