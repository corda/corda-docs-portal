...
menu:
  corda-enterprise-4-5:
    identifier: corda-enterprise-4-5-operations-guide-deployment-node-running
...
See [Monitoring via Jolokia](../../node/operating/node-administration.hml#monitoring-via-jolokia) for further details.
