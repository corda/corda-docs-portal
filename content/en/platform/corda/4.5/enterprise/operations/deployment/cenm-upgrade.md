...
menu:
  corda-enterprise-4-5:
    identifier: corda-enterprise-4-5-operations-guide-deployment-cenm-upgrade
...
{{< warning >}}
Before you start the upgrade, you must consult the [CENM Release Notes](../../../../../../../en/platform/corda/1.3/release-notes.md) to confirm all changes between releases.
{{< /warning >}}
...
1. Generate new certificates for [FARM](../../../../../../../en/platform/corda/1.3/gateway-service.md), [Auth](../../../../../../../en/platform/corda/1.3/auth-service.md), and [Zone](../../../../../../../en/platform/corda/1.3/zone-service.md) Services.
...
7. Edit [Identity Manager Service](../../../../../../../en/platform/corda/1.3/identity-manager.md), [Network Map Service](../../../../../../../en/platform/corda/1.3/network-map.md), and [Signing Service](../../../../../../../en/platform/corda/1.3/signing-service.md) configurations to remove shell access and add an admin listener configuration.
8. Edit the [Signing Service](../../../../../../../en/platform/corda/1.3/signing-service.md) configuration so that signing tasks refer to [service aliases](../../../../../../../en/platform/corda/1.3/signing-service.html#direct-cenm-service-locations) generated by the Zone Service.
9. Set Identity Manager Service configuration in the [Zone Service](../../../../../../../en/platform/corda/1.3/zone-service.md).
...
13. Add [Angel Services](../../../../../../../en/platform/corda/1.3/angel-service.md) to Identity Manager, Network Map, and Signing Services, to fetch configurations from the Zone
   Service.
...
for generating the full SSL hierarchy is provided under [config-samples/upgrade-pki-tool-1.3.conf](../../../../../../../en/platform/corda/1.3/config-samples/upgrade-pki-tool-1.3.conf).
...
To generate the JWT, refer to the [Auth Service](../../../../../../../en/platform/corda/1.3/auth-service.md) documentation.
...
* [FARM Service](../../../../../../../en/platform/corda/1.3/gateway-service.md)
* [Auth Service](../../../../../../../en/platform/corda/1.3/auth-service.md)
* [Zone Service](../../../../../../../en/platform/corda/1.3/zone-service.md)
...
The [Auth Service](../../../../../../../en/platform/corda/1.3//auth-service.md) has an initial user who can manage users, however
...
these names. The names are specified in [service aliases](../../../../../../../en/platform/corda/1.3/signing-service.html#direct-cenm-service-locations).
...
[Angel Service documentation](../../../../../../../en/platform/corda/1.3/angel-service.md).
 ...
 **Identity Manager**
  ...
  The release includes changes to database schemas (see [Changelog](../../../../../../../en/platform/corda/1.2/changelog.md)) for Oracle databases;
...
The release includes changes to database schemas (see [Changelog](../../../../../../../en/platform/corda/1.2/changelog.md)); new columns are created automatically
...
configuration of the relevant component (Signing Service or PKI Tool). For more information, see [Signing Services](../../../../../../../en/platform/corda/1.3/signing-service.md).
and [Public Key Infrastructure (PKI) Tool](../../../../../../../en/platform/corda/1.3/pki-tool.md) for more information.
...
Version 0.2.2 and 0.3 / 0.4 configuration files can be migrated to CENM 1.0 using the [configuration migration tool](../../../../../../../en/platform/corda/1.3/tool-config-migration.md).
...
of the [Network Map Service](../../../../../../../en/platform/corda/1.3/network-map.md) document for more information.
...
manually. See [Signing Services](../../../../../../../en/platform/corda/1.3/signing-service.md) for more information on how to configure this.
...
configuration modification. See [Signing Services](../../../../../../../en/platform/corda/1.3/signing-service.md) for more information on how to configure this.
...
See the “Setting the Network Parameters” section of the [Network Map Service](../../../../../../../en/platform/corda/1.3/network-map.md) document for more information.
