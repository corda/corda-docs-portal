...
menu:
  corda-enterprise-4-5:
    identifier: corda-enterprise-4-5-operations-guide-deployment-node-generating
...
The remaining node files and directories will be generated at runtime. These are described in the [Node folder structure](../../node/setup/corda-configuration-file.md) section.
...
* `sshdPort` &lt;integer&gt; - use this configuration option to specify the port for sshd communication. For more information, see [sshd](../../node/setup/corda-configuration-fields.html#sshd). For example:
