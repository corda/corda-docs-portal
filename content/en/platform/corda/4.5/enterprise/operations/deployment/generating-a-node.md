...
* The Corda JAR, downloaded from [https://r3.bintray.com/corda/net/corda/corda/](https://software.r3.com/ui/repos/tree/General/corda-releases%2Fnet%2Fcorda%2Fcorda%2F4.5) (under /4.5/corda-4.5.jar)
...
* **Optional:** A webserver JAR entitled `corda-webserver-4.5.jar` that will connect to the node via RPC
...
in the [Kotlin CorDapp Template](https://github.com/corda/cordapp-template-kotlin):
