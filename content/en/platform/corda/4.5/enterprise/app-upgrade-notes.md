...
[here](../../../../../api-ref/corda/4.5/open-source/kotlin/corda/net.corda.core.flows/-destination.html))
...
See [CorDapp configuration files](../../../../../platform/corda/4.5/enterprise/cordapps/cordapp-build-systems.md#cordapp-configuration-files-ref) for more information.
...
Learn more by reading [Contract/State Agreement](../../../../../platform/corda/4.5/enterprise/cordapps/api-contract-constraints.html#contract-state-agreement). If an app targets Corda 3 or lower (i.e. does not specify a target version),
...
[Signature Constraints](../../../../../platform/corda/4.5/enterprise/cordapps/api-contract-constraints.html#signature-constraints) are a new data model feature introduced in Corda 4. They make it much easier to
...
“[Package namespace ownership](../../../../../platform/corda/4.5/enterprise/node/deploy/env-dev.html#package-namespace-ownership)”.
...
* The [new withEntityManager API](../../../../../api-ref/corda/4.5/open-source/net/corda/core/node/ServiceHub.html#withEntityManager-block-) for using JPA inside your flows and services.
* [Reference States](../../../../../platform/corda/4.5/enterprise/cordapps/api-states.md#reference-states), that let you use an input state without consuming it.
* [State Pointers](../../../../../platform/corda/4.5/enterprise/cordapps/api-states.md#state-pointers), that make it easier to ‘point’ to one state from another and follow the latest version of a linear state.
