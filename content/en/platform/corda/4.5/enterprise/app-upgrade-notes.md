...
The [Confidential identities](../../../../../../en/platform/corda/4.5/enterprise/cordapps/api-confidential-identity.html#confidential-identities) API is experimental in Corda 3 and remains so in Corda 4. In this release, the `SwapIdentitiesFlow`
