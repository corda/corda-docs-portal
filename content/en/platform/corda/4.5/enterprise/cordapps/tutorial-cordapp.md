...
1. Open IntelliJ.
2. From the splash screen, click **Open**, navigate to the `Basic\cordapp-example` sub-folder, and click **OK**. The sample CorDapp opens.
...
(see [Network Bootstrapper](../../../../../../../en/platform/corda/4.5/enterprise/open-source/network-bootstrapper.html)) to update the files and have them distributed locally:`java -jar network-bootstrapper.jar /build/nodes`
