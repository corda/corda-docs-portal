...
![flow interface](../resources/flow-interface.png "flow interface")
...
The general recommendation for Corda 4 is to use **implicit** upgrades for the reasons described [here](../../../../../../../en/platform/corda/4.5/enterprise/cordapps/api-contract-constraints.html#implicit-vs-explicit-contract-upgrades).
...
[node drain](../../../../../../../en/platform/corda/4.5/enterprise/node/operating/cm-updating-cordapp.html#draining-the-node) first to avoid the definition of states or contracts changing whilst a flow is
in progress.
...
re-run the network bootstrapper to whitelist the new contracts. See network-bootstrapper.
