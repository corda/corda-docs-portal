...
[Flows](../../../../../../en/platform/corda/4.5/enterprise/cordapps/api-flows.md) to a smooth halt (existing work is finished, and new work is queued rather than being processed).
...
For a detailed explanation of Corda backup and recovery guarantees, see [Backup recommendations](../../../../../../en/platform/corda/4.5/enterprise/node/operating/node-administration.html#backup-recommendations) .
...
Make sure it’s available on your path, and that you’ve read the [Corda release notes](../../../../../../en/platform/corda/4.6/enterprise/release-notes-enterprise.md). Pay particular attention to which version of Java this
node requires.
...
distribution. See [Upgrade a Corda 3.X Enterprise Node](https://github.com/corda/corda-docs-portal/blob/main/content/en/archived-docs/corda-enterprise/3.3/node-operations-upgrading.md)
