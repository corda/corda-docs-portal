...
Make sure it’s available on your path, and that you’ve read the [Corda release notes](../../../../../en/platform/corda/4.6/open-source/release-notes.md). Pay particular attention to which version of Java this
node requires.
