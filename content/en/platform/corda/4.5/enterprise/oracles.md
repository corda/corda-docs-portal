...
oracle but still allow it to sign it by providing the Merkle hashes for the remaining parts.  See [Oracles](../../../../../en/platform/corda/4.5/open-source/key-concepts-oracles.md)
for more details.
...
[RatesFixFlow.kt](https://github.com/corda/corda/blob/release/os/4.5/samples/irs-demo/cordapp/workflows-irs/src/main/kotlin/net.corda.irs/flows/RatesFixFlow.kt)

You’ll note that the `FixSignFlow` requires a `FilterTransaction` instance which includes only `Fix` commands.
You can find a further explanation of this in [Oracles](../../../../../en/platform/corda/4.5/open-source/key-concepts-oracles.md). Below you will see how to build such a
...
[FixingFlow.kt](https://github.com/corda/corda/blob/release/os/4.5/samples/irs-demo/cordapp/workflows-irs/src/main/kotlin/net.corda.irs/flows/FixingFlow.kt)
...
[OracleNodeTearOffTests.kt](https://github.com/corda/corda/blob/release/os/4.5/samples/irs-demo/cordapp/workflows-irs/src/test/kotlin/net/corda/irs/api/OracleNodeTearOffTests.kt)

See [here](https://github.com/corda/corda/blob/release/os/4.5/samples/irs-demo/cordapp/workflows-irs/src/test/kotlin/net/corda/irs/api/OracleNodeTearOffTests.kt) for more examples.
