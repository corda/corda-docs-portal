...
You can check if the CorDapp JAR contains Liquibase scripts as described in [here](node-operations-cordapp-deployment.html#cordapp-deploymnet-database-setup-ref).
