...
- [Simplified database schema setup for development](#simplified-database-schema-setup-for-development)
  - [Database schema setup](#database-schema-setup)
    - [1. Creating a database user with schema permissions](#1-creating-a-database-user-with-schema-permissions)
      - [SQL Azure](#sql-azure)
      - [SQL Server](#sql-server)
      - [Oracle](#oracle)
      - [PostgreSQL](#postgresql)
    - [2. Corda node configuration](#2-corda-node-configuration)
      - [H2](#h2)
      - [Azure SQL](#azure-sql)
      - [SQL Server](#sql-server-1)
      - [Oracle](#oracle-1)
      - [PostgreSQL](#postgresql-1)
    - [3. Start the node to auto-create schema objects](#3-start-the-node-to-auto-create-schema-objects)
  ...
  - [Database schema update when upgrading a CorDapp](#database-schema-update-when-upgrading-a-cordapp)
  - [Database schema cleanup](#database-schema-cleanup)
...
(see the documentation on [Database access when running H2](../../node-database-access-h2.md), hence when using H2 database it’s sufficient to [start the node](node-database-admin.html#db-setup-step-3-ref) and the database will be created.
...
For development convenience the properties are specified in the [deployNodes Cordform task](../../testing.html#testing-cordform-ref) task.
...
See [Node configuration](../setup/corda-configuration-file.html#database-properties-ref) for a complete list of database specific properties, it contains more options useful in case of testing Corda with unsupported databases.
...
See the [Corda node upgrade notes](cm-upgrading-node.html#node-upgrade-notes-update-database-ref) for more information.
