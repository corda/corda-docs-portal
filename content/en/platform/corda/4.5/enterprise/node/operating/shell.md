...
1. Download the shell `.jar` file for your version of Corda from [Artifactory](https://software.r3.com/ui/repos/tree/General/corda-enterprise-for-customers)—for example, `corda-tools-shell-cli-4.5.jar`.
...
[here](https://docs.r3.com/en/api-ref/corda/4.5/open-source/kotlin/corda/net.corda.core.messaging/-corda-r-p-c-ops/index.html).
