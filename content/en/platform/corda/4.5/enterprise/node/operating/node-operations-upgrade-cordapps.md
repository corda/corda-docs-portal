...
If any backwards-incompatible changes have been made (see [What constitutes a non-backwards compatible flow change?](../../cordapps/upgrading-cordapps.html#upgrading-cordapps-backwards-incompatible-flow-changes)
...
* If required, do a flow drain to avoid the definition of states or contracts changing whilst a flow is in progress (see [Flow drains](../../cordapps/upgrading-cordapps.html#upgrading-cordapps-flow-drains) for more information)
