...
{{< note >}}
When you apply manual approval or pre-auth rules, the member registration status is set as “PENDING_MANUAL_APPROVAL”. This is the final outcome of registering the member through rules.
{{< /note >}}
