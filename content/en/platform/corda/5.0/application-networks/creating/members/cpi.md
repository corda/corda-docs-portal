...
To join a group, members must use a group policy file exported from the {{< tooltip >}}MGM{{< /tooltip >}} of that group. To retrieve the `GroupPolicy.json` file from the MGM:
