...
This section describes how to configure the {{< tooltip >}}MGM{{< /tooltip >}}, through which a membership group is created for a dynamic network. The sections must be completed in the order in which they are presented:
{{< childpages >}}
