...
1. The initiating flow is called on the initiating node with another member of the {{< tooltip >}}application {{< /tooltip >}}, the recipient,  specified as the input argument.
