...
* **Application:** Members which run a CPI (Corda Package Installer) containing a {{< tooltip >}}CPB{{< /tooltip >}} which provides a CorDapp to run on the network. Most members fulfil this role, and would be our archetypical “Alice” or “Bob” nodes.
