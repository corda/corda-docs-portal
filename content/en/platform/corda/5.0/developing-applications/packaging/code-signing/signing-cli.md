...
You can sign the CPK, CPB, and CPI packages using Corda CLI. Corda CLI is particularly useful for {{< tooltip >}}CorDapp{{< /tooltip >}} developers or CorDapp distributors
