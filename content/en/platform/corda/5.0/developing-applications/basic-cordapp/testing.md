...
1. Follow the [CSDE environment instructions]({{< relref "../getting-started/installing/_index.md" >}})
...
1. Following the [CSDE documentation]({{< relref "../getting-started/installing/_index.md" >}})
