...
This tutorial guides you through writing the two contracts you need in your {{< tooltip >}}CorDapp{{< /tooltip >}}: `AppleStampContract` and `BasketOfApplesContract`. You will link these contracts to the states that you created in the [Write States]({{< relref"./state.md" >}}) tutorial.
