...
{{< enterprise-icon noMargin="true" >}} If you are using HashiCorp Vault as an external secret management system, you must ensure the passwords for the RBAC, Crypto, and virtual node databases are stored correctly in Vault. For more information, see [Encryption]({{< relref "../deploying/deploying.html#external-secrets-service-hahahugoshortcode-s18-hbhb">}}) in the _Deploying_ section. 