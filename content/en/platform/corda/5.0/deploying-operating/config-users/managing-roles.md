...
To retrieve permissions matching certain query criteria, use the [get_permission](https://docs.r3.com/en/platform/corda/5.0/reference/rest-api/C5_OpenAPI.html#tag/RBAC-Permission-API/operation/get_permission) API call.
