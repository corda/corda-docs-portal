...
If [bootstrapping manually]({{< relref "./deploying/bootstrapping.md" >}}), an additional virtual node user will still need the ability to create schemas dynamically at runtime.
