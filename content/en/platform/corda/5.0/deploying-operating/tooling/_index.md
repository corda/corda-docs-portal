...
The Cluster Operator will require the Corda CLI if they intend to [manually bootstrap](../deploymnet/deploying/bootstrapping.md) Kafka and PostgreSQL.
...
## PostgreSQL Client
The Cluster Operator, or their database administrator, will require a PostgreSQL client if they intend to [manually bootstrap](../deploymnet/deploying/bootstrapping.md) PostgreSQL.
...
The Cluster Operator, or their Kafka administrator, may require a Kafka client if they intend to [manually bootstrap](../deploymnet/deploying/bootstrapping.md) Kafka.
