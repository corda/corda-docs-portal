...
The membership worker is responsible for the processing of application network functionality either on behalf of an {{< tooltip >}}MGM{{< /tooltip >}}, a network member, or both. For an MGM, examples of this application functionality include:
