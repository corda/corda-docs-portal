...
| `corda_consumer_records_consumed` | Gauge | <ul><li>`messagepattern.clientid`</li><li>`partition`</li></ul> | The size of batches polled from Kafka in consumers. |
...
| `corda_producer_chunks_generated` | DistributionSummary | <ul><li>`messagepattern.clientid`</li><li>`topic`</li></ul> | The number of chunks generated by Kafka producers. |
