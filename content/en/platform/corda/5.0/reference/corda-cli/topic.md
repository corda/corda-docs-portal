...
---
# topic
This section lists the Corda CLI `topic` arguments. You can use these commands to manually create or delete topics in Kafka,  as described in the [Manual Bootstrapping]({{< relref "../../deploying-operating/deploymnet/deploying/bootstrapping.md" >}}) section.
