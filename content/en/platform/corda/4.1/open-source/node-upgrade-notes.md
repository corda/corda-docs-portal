---
aliases:
- /releases/release-V4.1/node-upgrade-notes.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-4-1:
    identifier: corda-os-4-1-node-upgrade-notes
    weight: 40
tags:
- node
- upgrade
...
Refer to [Corda 3.2 release notes](https://github.com/corda/corda-docs/blob/master/content/en/docs/corda-os/3.2/release-notes.md)
