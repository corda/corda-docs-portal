...
new Corda release. The stable Corda modules are listed [here](corda-api.html#api-stability-guarantees). Our CI process runs an “API Stability”
...
or anything in a module that isn’t in the stable modules list [here](corda-api.html#api-stability-guarantees).
