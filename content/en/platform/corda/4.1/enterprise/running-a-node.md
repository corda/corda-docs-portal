---
aliases:
- /releases/4.1/running-a-node.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-1:
    identifier: corda-enterprise-4-1-running-a-node
...
`install-shell-extensions`: Install `corda` alias and auto completion for bash and zsh.
