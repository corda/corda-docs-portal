---
aliases:
- /releases/4.1/corda-firewall-component.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-1:
    identifier: corda-enterprise-4-1-corda-firewall-component
...
Please see the [configuration file examples](resources/bridge/node_bridge/node.conf)


#### bridge.conf

Please see the [configuration file examples](resources/bridge/node_bridge/bridge.conf)
...
![node bridge float](/resources/bridge/node_bridge_float/node_bridge_float.png)

#### node.conf


Please see the [configuration file examples](resources/bridge/node_bridge_float/node.conf)


#### bridge.conf


Please see the [configuration file examples](resources/bridge/node_bridge_float/bridge.conf)


#### float.conf

Please see the [configuration file examples](resources/bridge/node_bridge_float/float.conf)
...
![socks proxy](resources/bridge/socks_proxy/socks_proxy.png)

#### node.conf


Please see the [configuration file examples](resources/bridge/socks_proxy/node.conf)


#### bridge.conf

Please see the [configuration file examples](resources/bridge/socks_proxy/bridge.conf)


#### float.conf


Please see the [configuration file examples](resources/bridge/socks_proxy/float.conf)
...
![HA nodes](resources/bridge/ha_nodes/ha_nodes.png)

#### node.conf


Please see the [configuration file examples](resources/bridge/ha_nodes/node.conf)


#### bridge.conf


Please see the [configuration file examples](resources/bridge/ha_nodes/bridge.conf)


#### float.conf


Please see the [configuration file examples](resources/bridge/ha_nodes/float.conf)
...
![Multi-node without HA](resources/bridge/multiple_non_ha_nodes/multiple_nodes_no_ha.png)

#### bank-a-node.conf


Please see the [configuration file examples](resources/bridge/multiple_non_ha_nodes/bank-a-node.conf)


#### bank-b-node.conf


Please see the [configuration file examples](resources/bridge/multiple_non_ha_nodes/bank-b-node.conf)


#### bridge.conf


Please see the [configuration file examples](resources/bridge/multiple_non_ha_nodes/bridge.conf)
...
A simple procedure for adding a new node might look like the following:
  ...
  2. Register your new entities with the network operator. See [joining and existing compatibility zone](joining-a-compatibility-zone.md).
...
![Zookeeper](resources/bridge/zookeeper.png)
