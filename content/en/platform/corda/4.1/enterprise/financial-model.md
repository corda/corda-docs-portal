---
aliases:
- /releases/4.1/financial-model.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-1:
    identifier: corda-enterprise-4-1-financial-model
    parent: corda-enterprise-4-1-component-library-index
    weight: 1020
tags:
- financial
- model
...
The [Amount](https://api.corda.net/api/corda-enterprise/4.1/html/api/kotlin/corda/net.corda.core.contracts/-amount/index.html) class is used to represent an amount of
