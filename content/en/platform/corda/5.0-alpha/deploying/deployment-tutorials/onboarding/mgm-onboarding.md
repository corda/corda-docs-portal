...
Currently, this is just for P2P TLS certificates, but, in the future, they may also be used for session certificates.<!--To check-may link to new (optional) certificate section-->
