...
<div class="col">
  <div class="card h-100">
    <div class="card-body">
      ...
      {{% "../corda/5.0-dev-preview-2/icons/agenda-bookmark-white.svg" "alt text" class="dark-only"}}
      {{% "../corda/5.0-dev-preview-2/icons/agenda-bookmark.svg" "alt text" class="light-only"}}
