...
When a [virtual node](../../introduction/key-concepts.html#virtual-nodes) is created for a CorDapp (as part of a [CPI](../../introduction/key-concepts.html#cordapp-package-installer-cpi)), associated tables, indexes, foreign-keys, etc. must be created.
This is done by embedding Liquibase files into the CorDapp [CPK](../../introduction/key-concepts.html#cordapp-packages-cpks).
...
3. To load a row from the database by ID:
  ```java
