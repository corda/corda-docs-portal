...
---
You can view the KDoc documentation for this module [here](/en/api-ref/corda/5.0-dev-preview-2/open-source/modules/corda-application-5.0.0.190-DevPreview-2-javadoc/index.html).
