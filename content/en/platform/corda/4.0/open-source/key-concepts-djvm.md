---
aliases:
- /releases/release-V4.0/key-concepts-djvm.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-4-0:
    identifier: corda-os-4-0-key-concepts-djvm
    parent: corda-os-4-0-key-concepts
    weight: 1140
tags:
- concepts
- djvm
...
* [Only Allow Explicitly Whitelisted Runtime API](#only-allow-explicitly-whitelisted-runtime-api)
