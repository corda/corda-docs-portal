...
Before we present the pool of supported schemes it is useful to be familiar with [Identities](../../../../../en/platform/corda/4.0/open-source/key-concepts-ecosystem.html#identity)key-concepts-identity,
