---
aliases:
- /releases/4.0/docker-image.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-0:
    identifier: corda-enterprise-4-0-docker-image
...
docker run -ti \
        ...
        -p 10200:10200 \
        -p 10201:10201 \
        corda/corda-zulu-java1.8-4.0:latest
```
...
docker run -ti --net="host" \
        ...
        corda/corda-zulu-java1.8-4.0:latest config-generator --generic
```
...
docker run -ti \
        ...
        -v /home/user/corda/samples/bank-of-corda-demo/build/nodes/BankOfCorda/cordapps:/opt/corda/cordapps \
        entdocker.software.r3.com/corda-enterprise-java1.8-4.0:latest db-migrate-create-jars
```
...
docker run -ti \
        ...
        entdocker.software.r3.com/corda-enterprise-java1.8-4.0:latest db-migrate-execute-migration
```
