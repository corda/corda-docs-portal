---
aliases:
- /releases/4.0/platform-support-matrix.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-0:
    identifier: corda-enterprise-4-0-platform-support-matrix
    weight: 70
tags:
- platform
- support
...
Production use of Corda Enterprise Edition 4.0 is only supported on Linux OS, see details below.


## JDK support

Corda Enterprise Edition 4.0 has been tested and verified to work with **Oracle JDK 8 JVM 8u171+** and **Azul Zulu Enterprise 8**, downloadable from
...
{{< /note >}}
Other distributions of the [OpenJDK](https://openjdk.java.net/) are not officially supported but should be compatible with Corda Enterprise Edition 4.0.
