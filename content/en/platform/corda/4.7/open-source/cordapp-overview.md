...
menu:
  corda-os-4-7:
    identifier: corda-os-4-7-cordapp-overview
...
* Ensure your CorDapp is designed per [Structuring a CorDapp](writing-a-cordapp.md) and annotated according to [CorDapp separation](cordapp-build-systems.md#separation-of-cordapp-contracts-flows-and-services).
...
Please read [Setting your dependencies](cordapp-build-systems.md#setting-your-dependencies) to understand the options and recommendations with regards to correctly Jar’ing CorDapp dependencies.
...
{{< note >}}
As of Corda 4 it is recommended to use [CorDapp Jar signing](cordapp-build-systems.md#signing-the-cordapp-jar) to leverage the new signature constraints functionality.
