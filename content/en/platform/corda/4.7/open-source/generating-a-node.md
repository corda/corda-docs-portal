...
* `configFile` &lt;string&gt; - use this configuration option to generate an extended node configuration. For more information, see [Node configuration](corda-configuration-file.md). For example:
