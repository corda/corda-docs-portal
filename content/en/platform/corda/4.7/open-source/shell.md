...
1. Download the shell `.jar` file for your version of Corda from [Artifactory](https://software.r3.com/artifactory/corda-releases/net/corda/corda-tools-shell-cli/)—for example, `corda-tools-shell-cli-4.7.jar`.
