...
menu:
  corda-os-4-7:
    identifier: corda-os-4-7-node-administration
...
`exportHibernateJMXStatistics` flag on the [database configuration](corda-configuration-file.html#database-properties-ref).
