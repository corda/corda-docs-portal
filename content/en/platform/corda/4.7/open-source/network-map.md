...
menu:
  corda-os-4-7:
    identifier: corda-os-4-7-network-map
...
additional endpoints for users. These additional endpoints can be found [here](../../cenm/1.5/network-map-overview.md).
...
and a replacement is registered to the network and added to Network Parameters, the original notary will continue to appear in the list of available
...
[NetworkParameters.kt](https://github.com/corda/corda/blob/release/os/4.7/core/src/main/kotlin/net/corda/core/node/NetworkParameters.kt)
