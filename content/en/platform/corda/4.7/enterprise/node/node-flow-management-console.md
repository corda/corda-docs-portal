...
The flow management console allows you to see the state of the flows running on a node and perform some operations on them. It runs as part of the [Gateway Service](../../../../../../en/platform/corda/4.7/enterprise/cordapps/gateway-service.md).
