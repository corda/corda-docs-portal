...
menu:
  corda-enterprise-4-7:
    parent: corda-enterprise-4-7-corda-nodes-deploying
tags:
- running
- node
...
If you need to initialise or migrate the node's database schema objects, you need to run the `run-migration-scripts` sub-command. See [Node command-line options]({{< relref "../../../../../../../en/platform/corda/4.7/enterprise/node/node-commandline.md" >}}) for details.

{{< note >}}
If your node configuration file is obfuscated, and you want to de-obfuscate it when running the node, you need to pass the
...
* Run nodes on the remote machine using [runnodes command](#native).
