...
menu:
  corda-enterprise-4-7:
    identifier: corda-enterprise-4-7-corda-nodes-deploying
...
```bash
java -jar corda-tools-network-bootstrapper-4.7.jar --dir <nodes-root-dir>
```
...
```bash
java -jar corda-tools-network-bootstrapper-4.7.jar --network-parameter-overrides=<path_to_file>
```

Or alternatively, by using the short form version:

```bash
java -jar corda-tools-network-bootstrapper-4.7.jar -n=<path_to_file>
```
