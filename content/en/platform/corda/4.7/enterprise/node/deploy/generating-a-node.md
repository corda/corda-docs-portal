...
The remaining node files and directories will be generated at runtime. These are described in the [Node folder structure]({{< relref "../setup/corda-configuration-file.md" >}}) section.
...
See [Upgrading your node to Corda 4.7]({{< relref "../../node-upgrade-notes.md" >}}) for more information.
...
To configure [package namespace ownership](../../../../../../../en/platform/corda/4.7/enterprise/node/deploy/env-dev.html#package-namespace-ownership), use the optional `networkParameterOverrides` and `packageOwnership` blocks, in a similar way to how the configuration file is used by the [Network Bootstrapper]({{< relref "../../../../../../../en/platform/corda/4.7/enterprise/network-bootstrapper.md" >}}) tool. For example:
