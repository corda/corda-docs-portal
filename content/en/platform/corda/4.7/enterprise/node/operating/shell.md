...
The shell can be used to upload and download attachments from the node. To learn how, see the [Working with attachments](../../../../../en/platform/corda/corda-os/4.7/tutorial-attachments.md#uploading-an-attachment) tutorial.
