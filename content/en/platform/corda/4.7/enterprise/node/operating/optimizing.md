...
Flow and RPC threads can be set explicitly using the [tuning section](../../../../../../../en/platform/corda/4.7/enterprise/node/setup/corda-configuration-file.html#configuration-examples) of the enterprise configuration. Add the following section to your node configuration file:
