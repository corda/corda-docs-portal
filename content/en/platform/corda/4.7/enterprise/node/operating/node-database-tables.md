...
Read more in [Ledger](../../../../../../../en/platform/corda/4.7/open-source/key-concepts-ledger.md).


### Attachments

Read more in [Working with attachments](../../../../../../../en/platform/corda/4.7/open-source/tutorial-attachments.md) and [Node services](../../node-services.md).
...
Read more about the vault in [Vault](../../../../../../../en/platform/corda/4.7/open-source/key-concepts-vault.md).
