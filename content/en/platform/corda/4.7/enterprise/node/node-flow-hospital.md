...
Flow hospital functionality is enabled by default in Corda Enterprise Edition 4.7. No explicit configuration settings are required.
...
* vizualisation of failed flows in the [flow management console]({{< relref "../../../../../../en/platform/corda/4.7/enterprise/node/node-flow-management-console.md" >}}).
