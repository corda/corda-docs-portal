...
In addition to recording RPC Audit Data it will also be useful to collect information on any data recorded.  See the [RPC Audit Data Collector]({{< relref "../../rpc-audit-collector.md" >}}) page for details on this.
