...
oracle but still allow it to sign it by providing the Merkle hashes for the remaining parts.  See [Oracles](../../../../../en/platform/corda/4.7/open-source/key-concepts-oracles.md)
for more details.
...
You can find a further explanation of this in [Oracles](../../../../../en/platform/corda/4.7/open-source/key-concepts-oracles.md). Below you will see how to build such a
...
See [here](https://github.com/corda/corda/blob/release/os/4.7/samples/irs-demo/cordapp/workflows-irs/src/test/kotlin/net/corda/irs/api/OracleNodeTearOffTests.kt) for more examples.
