...
More information can be found in [Network Bootstrapper]({{< relref "../../../../../../en/platform/corda/4.7/enterprise/network-bootstrapper.md" >}}).
...
{{< note >}}
To determine which *minimumPlatformVersion* a zone must mandate in order to permit all the features of Corda 4.7, see [Corda features and versions]({{< relref "../features-versions.md" >}}).
...
You can also [Set up a notary in a segregated network]({{< relref "../../../../../../en/platform/corda/4.7/enterprise/corda-network/setup-segregated-notary.md" >}}).
