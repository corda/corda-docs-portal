...
{{< note >}}
Before running any Corda Docker images, you must accept the license agreement and indicate that you have done this by setting the environment variable `ACCEPT_LICENSE` to `YES` or `Y`. If you do not do this, none of the Docker containers will start.
...
docker run -ti \
        ...
        -v /home/user/corda/samples/bank-of-corda-demo/build/nodes/BankOfCorda/cordapps:/opt/corda/cordapps \
        entdocker.software.r3.com/corda-enterprise-java1.8-4.7:latest db-migrate-create-jars
```
...
docker run -ti \
        ...
        entdocker.software.r3.com/corda-enterprise-java1.8-4.7:latest db-migrate-execute-migration
```
