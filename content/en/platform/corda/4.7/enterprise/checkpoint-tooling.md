...
The checkpoint agent can be downloaded from [Maven](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-checkpoint-agent/4.7.10/corda-tools-checkpoint-agent-4.7.10.jar).
...
See [Generating a Node](node/deploy/generating-a-node.html#tasks-using-the-cordform-plug-in).
