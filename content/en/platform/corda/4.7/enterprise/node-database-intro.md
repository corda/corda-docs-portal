...
for production systems for a new Corda installation or [database upgrade](../../../../../en/platform/corda/4.7/enterprise/node-upgrade-notes.html#step-3-update-the-database-manual) for upgrading Corda nodes.
...
Corda Enterprise is released with the [Database Management Tool](../../../../../en/platform/corda/4.7/enterprise/node/operating/node-database.html#database-management-tool-ref).
