...
After the JPA notary is operating, you should run the [Notary Health Check tool]({{< relref "../../../../../../en/platform/corda/4.7/enterprise/notary-healthcheck.md" >}})) to ensure that the network is up and responsive.
