...
* Use the [Corda Database Management Tool](../../../../../../en/platform/corda/4.7/enterprise/node/operating/node-database.html#database-management-tool) to prepare the schema in the target database.
