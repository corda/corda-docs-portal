...
menu:
  corda-enterprise-4-7:
    identifier: corda-enterprise-4-7-notary-migration-overview
...
* Use the [Corda Database Management Tool](../../../../../../en/platform/corda/4.7/enterprise/node/operating/node-database.html#database-management-tool-ref) to prepare the schema in the target database.
