...
{{< note >}}
For more information about `MultiRPCClient`, see [Interacting with a node](../../../../../en/platform/corda/4.7/enterprise/node/operating/clientrpc.html#building-the-multi-rpc-client).
{{< /note >}}
