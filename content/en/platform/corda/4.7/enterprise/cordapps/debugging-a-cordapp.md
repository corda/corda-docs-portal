...
menu:
  corda-enterprise-4-7:
    identifier: corda-enterprise-4-7-cordapps-debugging
...
* Define a network using the node driver as described in [Conducting integration Testing](../../../../../../en/platform/corda/4.7/open-source/tutorial-integration-testing.md).
