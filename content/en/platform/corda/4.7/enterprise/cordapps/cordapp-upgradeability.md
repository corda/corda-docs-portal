...
receiver flows to use the new APIs and thus opting in to platform version 4. See [Step 5. Security: Upgrade your use of FinalityFlow](../../../../../../en/platform/corda/4.7/enterprise/app-upgrade-notes.html#step-5-security-upgrade-your-use-of-finalityflow) for more information.
...
that requires programmatic code changes. See [CZ whitelisted constraints migration](../../../../../../en/platform/corda/4.7/enterprise/cordapps/cordapp-constraint-migration.html#migrate-cz-whitelisted-constraints) for more information.
* Explicit Contract Upgrades are only supported for hash and CZ whitelisted constraint types. See [Performing explicit contract and state upgrades](../../../../../../en/platform/corda/4.7/enterprise/cordapps/upgrading-cordapps.html#performing-explicit-contract-and-state-upgrades) for more information.
...
See [Installing the CorDapp JAR](../../../../../../en/platform/corda/4.7/enterprise/cordapps/cordapp-build-systems.html#installing-the-cordapp-jar) and [CorDapp Contract Attachments](../../../../../../en/platform/corda/4.7/enterprise/cordapps/cordapp-build-systems.html#cordapp-contract-attachments-ref) for more information.
