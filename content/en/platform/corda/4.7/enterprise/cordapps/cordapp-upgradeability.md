...
receiver flows to use the new APIs and thus opting in to platform version 4. See [Step 5. Security: Upgrade your use of FinalityFlow](../../../../../en/platform/corda/4.7/enterprise/app-upgrade-notes.html#cordapp-upgrade-finality-flow-ref) for more information.
...
that requires programmatic code changes. See [CZ whitelisted constraints migration](../../../../../en/platform/corda/4.7/enterprise/cordapps/cordapp-constraint-migration.html#cz-whitelisted-constraint-migration) for more information.
* Explicit Contract Upgrades are only supported for hash and CZ whitelisted constraint types. See [Performing explicit contract and state upgrades](../../../../../en/platform/corda/4.7/enterprise/cordapps/upgrading-cordapp.html#performing-explicit-contract-and-state-upgrades) for more information.
...
See [Installing the CorDapp JAR](../../../../../en/platform/corda/4.7/enterprise/cordapps/cordapp-build-systems.html#cordapp-install-ref) and [CorDapp Contract Attachments](../../../../../en/platform/corda/4.7/enterprise/cordapps/cordapp-build-systems.html#cordapp-contract-attachments-ref) for more information.
...
where the latest installed contract Jar is signed as per [CorDapp Jar signing](../../../../../en/platform/corda/4.7/enterprise/cordapps/cordapp-build-systems.html#cordapp-build-system-signing-cordapp-jar-ref).
...
but wish to use for the purpose of transaction verification with peers running later versions of a CorDapp.
