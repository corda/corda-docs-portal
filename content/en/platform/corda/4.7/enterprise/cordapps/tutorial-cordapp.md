...
The local Corda network includes one notary, and three nodes, each representing a party in the network. A Corda node is an individual instance of Corda representing one party in a network.
For more information on nodes, see the [node documentation]({{< relref "../../../../../../en/platform/corda/4.7/enterprise/node/component-topology.md" >}}).
...
3. After the build finishes, navigate to the `samples-java/Basic/cordapp-example/build/nodes` or `samples-kotlin/Basic/cordapp-example/build/nodes` folder.
...
You can read more about how to generate nodes [here]({{< relref "../node/deploy/generating-a-node.md" >}}).
...
please follow the instructions in [Node database]({{< relref "../../../../../../en/platform/corda/4.7/enterprise/node/operating/node-database.md" >}}).
...
(see [Network Bootstrapper]({{< relref "../../../../../../en/platform/corda/4.7/enterprise/network-bootstrapper.md" >}})) to update the files and have them distributed locally:`java -jar network-bootstrapper.jar /build/nodes`
