...
For more information on nodes, see the [node documentation](../../../../../../en/platform/corda/4.7/enterprise/node/component-topology.md).
...
please follow the instructions in [Node database](../../../../../en/platform/corda/4.7/enterprise/node/operating/node-database.md).
...
(see [Network Bootstrapper](../../../../../en/platform/corda/4.7/enterprise/network-bootstrapper.md)) to update the files and have them distributed locally:`java -jar network-bootstrapper.jar /build/nodes`
