...
See [Defining encumbrances](../../../../../../en/platform/corda/4.7/open-source/tutorial-contract.html#defining-encumbrances) for more information.
{{< /note >}}
...
{{< note >}}
This functionality is part of Corda open source 4.7 and can be fully leveraged by Corda Enterprise Edition 4.7 users as well.
{{< /note >}}
