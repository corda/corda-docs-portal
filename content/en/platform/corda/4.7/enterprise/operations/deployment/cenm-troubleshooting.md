...
menu:
  corda-enterprise-4-7:
    identifier: corda-enterprise-4-7-operations-guide-deployment-cenm-troubleshooting
...
configured. See the “Signing Network Map and Network Parameters” section of [Signing Services](../../../../cenm/1.5/signing-service.md). If the service is
...
retried after a short break. See the “Identity Manager Communication” section of [Network Map Service](../../../../cenm/1.5/network-map.md) to verify that the
...
[Identity Manager Configuration Parameters](../../../../cenm/1.5/config-identity-manager-parameters.md) and [Network Map Configuration Parameters](../../../../cenm/1.5/config-network-map-parameters.md) for more information.
