...
menu:
  corda-enterprise-4-7:
    identifier: corda-enterprise-4-7-cordapp-advanced-concepts
...
(read more in [Contract Constraints]({{< relref "../../../../../en/platform/corda/4.7/enterprise/cordapps/api-contract-constraints.md" >}})), and the actual code is contained in a JAR  file that is referenced by the transaction.
...
In Corda 4, to help avoid this type of confusion, we introduced the concept of Package Namespace Ownership (see “[Package namespace ownership](../../../../../en/platform/corda/4.7/enterprise/node/deploy/env-dev.html#package-namespace-ownership)”).
