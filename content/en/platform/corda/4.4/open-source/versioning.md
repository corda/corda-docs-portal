...
menu:
  corda-os-4-4:
    identifier: corda-os-4-4-versioning
...
Applications can advertise a *minimum platform version* they require. If your app uses new APIs that were added in (for example) Corda 4.4,
you should specify a minimum platform version of 6. This will ensure the app won’t be loaded by older nodes. If you can *optionally* use the new
