...
`-parameters` argument to `javac`. See the documentation on [Creating nodes locally](../../../../../en/platform/corda/4.4/open-source/deploy/generating-a-node.md) to learn how to specify it via Gradle.
{{< /note >}}
