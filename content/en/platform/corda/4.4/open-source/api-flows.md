...
{{< note >}}
The size of the external operation thread pool can be configured, see [the node configuration documentation](corda-configuration-file.html#configuration-file-fields).
