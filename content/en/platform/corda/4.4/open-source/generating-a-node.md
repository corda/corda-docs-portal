...
* An up-to-date version of the [`network-parameters` file](network-map.html#network-parameters) generated by the bootstrapper tool
...
* `notary` `(config)` (see [notary](corda-configuration-file.html#configuration-file-fields))
