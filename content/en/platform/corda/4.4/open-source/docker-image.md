...
menu:
  corda-os-4-4:
    identifier: corda-os-4-4-docker-image
...
docker run -ti \
        ...
        -v /home/user/corda/samples/bank-of-corda-demo/build/nodes/BankOfCorda/cordapps:/opt/corda/cordapps \
        entdocker.software.r3.com/corda-enterprise-java1.8-4.4:latest db-migrate-create-jars
```
...
docker run -ti \
        ...
        entdocker.software.r3.com/corda-enterprise-java1.8-4.4:latest db-migrate-execute-migration
```
