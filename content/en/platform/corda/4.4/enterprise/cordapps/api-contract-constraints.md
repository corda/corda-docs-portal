...
[node configuration documentation](../../../../../../en/platform/corda/4.4/enterprise/node/setup/corda-configuration-file.md).

More information on how to sign an app directly from Gradle can be found in the
[CorDapp Jar signing](../../../../../../en/platform/corda/4.4/enterprise/cordapps/cordapp-build-systems.md) section of the documentation.
...
This is expanded upon in [Using Contract Constraints in Transactions](../../../../../../en/platform/corda/4.4/enterprise/cordapps/api-contract-constraints.html#using-contract-constraints-in-transactions).
