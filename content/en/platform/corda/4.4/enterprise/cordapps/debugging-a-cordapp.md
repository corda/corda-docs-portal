...
* Define a network using the node driver as described in [Integration Testing](../../../../../../en/platform/corda/4.4/open-source/tutorial-integration-testing.md).
...
See [Enabling remote debugging](../../../../../../en/platform/corda/4.4/enterprise/node/node-commandline.html#enabling-remote-debugging).
