...
- /docs/corda-enterprise/head/oracles.html
- /docs/corda-enterprise/oracles.html
...
oracle but still allow it to sign it by providing the Merkle hashes for the remaining parts.  See [Oracles](../../../../../en/platform/corda/4.4/open-source/key-concepts-oracles.md) for more details.
...
You can find a further explanation of this in [Oracles](../../../../../en/platform/corda/4.4/open-source/key-concepts-oracles.md). Below you will see how to build such a
