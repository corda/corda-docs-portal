...
instead of the [HA Utilities tool](../../../../../../en/platform/corda/4.4/enterprise/ha-utilities.html#notary-reg-tool). In all other implementations, the network bootstrapper is not required.
...
See [notary registration](../../../../../../en/platform/corda/4.4/enterprise/ha-utilities.html#notary-reg-tool) for more information on using the HA Utilities tool.
