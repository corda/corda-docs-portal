...
The tool is distributed as part of Corda Enterprise Edition 4.4 in the form of runnable JAR “corda-tools-blob-inspector-4.4.jar”.
...
`install-shell-extensions`: Install `blob-inspector` alias and auto-completion for bash and zsh. See [Shell extensions for CLI Applications](../../../../../en/platform/corda/4.4/enterprise/node/operating/cli-application-shell-extensions.md) for more info.
