...
Check out the Example CorDapp and follow the instructions to build it [here](../../../../../en/platform/corda/4.4/open-source/tutorial-cordapp.html#building-the-example-cordapp).
