...
input state owner.
    * Please see the documentation [Identities](../../../../../en/platform/corda/4.4/open-source/key-concepts-ecosystem.html#identities-and-discovery) and [API: Identity](../../../../../en/platform/corda/4.4/open-source/api-identity.md) for more details.
