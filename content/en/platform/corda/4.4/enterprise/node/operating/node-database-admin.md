...
If the permission is not granted then [Corda Database Management Tool](../../../../../../../en/platform/corda/4.4/enterprise/node/operating/node-database.html#database-management-tool) will output the message
...
the [Corda Database Management Tool](../../../../../../../en/platform/corda/4.4/enterprise/node/operating/node-database.html#database-management-tool) to output the DDL scripts and run the scripts against a database.
...
Refer to the [Corda Database Management Tool](../../../../../../../en/platform/corda/4.4/enterprise/node/operating/node-database.html#database-management-tool) manual for more detail.
...
Alternatively the path can be also specified by the `jarDirs` option in [the node configuration](../../../../../../../en/platform/corda/4.4/enterprise/node/setup/corda-configuration-file.html#configuration-file-fields).
