...
The general recommendation for Corda 4 is to use **implicit** upgrades for the reasons described [here](../../../../../../../en/platform/corda/4.4/enterprise/cordapps/api-contract-constraints.html#implicit-vs-explicit-contract-upgrades).
