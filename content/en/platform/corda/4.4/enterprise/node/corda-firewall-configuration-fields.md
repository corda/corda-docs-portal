...
menu:
  corda-enterprise-4-4:
    parent: corda-enterprise-4-4-corda-nodes-firewall-config
    identifier: corda-enterprise-4-4-corda-nodes-firewall-config-file
tags:
- corda
- firewall
- configuration
...
## healthCheck
An optional configuration field that specifies whether the firewall can process requests sent by the [Health Survey Tool](../../../../../../en/platform/corda/4.4/enterprise/health-survey.md). The default is `true`.
...
See [Setting JVM arguments](../../../../../../en/platform/corda/4.4/enterprise/node/deploy/running-a-node.html#setting-jvm-arguments) for examples and details on the precedence of the different approaches to settings arguments.
...
### name
The name of HSM provider to be used. E.g.: `UTIMACO`, `GEMALTO_LUNA`, etc. See [Using an HSM with Corda Enterprise](../../../../../../en/platform/corda/4.4/enterprise/node/operating/cryptoservice-configuration.md).
