...
Oracles are not the source of information: they are an entity that queries, verifies, and authenticates external data sources, then relays that information back to a [smart contract]({{< relref "key-concepts-contracts.md" >}}).
...
Some oracles monetize their services. In that case, you will need to pay the oracle before they sign the transaction.
