...
menu:
  corda-community-4-10:
    identifier: corda-community-4-10-upgrading-cordapps
...
The general recommendation for Corda 4.10 is to use **implicit** upgrades for the reasons described [here]({{< relref "api-contract-constraints.md#implicit-and-explicit-contract-upgrades" >}}).
