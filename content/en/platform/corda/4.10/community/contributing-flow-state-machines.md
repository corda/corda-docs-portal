...
menu:
  corda-community-4-10:
    identifier: corda-community-4-10-contributing-flow-state-machines
...
See [calling external systems inside of flows](api-flows.md) for more information on these public interfaces.
