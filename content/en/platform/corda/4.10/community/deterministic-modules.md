...
`rt.jar` containing a deterministic subset of the Java 8 APIs from Maven.  To build a new version of this JAR and upload it to Maven, see the `create-jdk8u` module.
