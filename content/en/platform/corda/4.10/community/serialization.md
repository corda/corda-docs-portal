...
You can see both methods in action in the [client RPC tutorial](../enterprise/get-started/tutorials/supplementary-tutorials/tutorial-clientrpc-api.md). Here's a sample:
