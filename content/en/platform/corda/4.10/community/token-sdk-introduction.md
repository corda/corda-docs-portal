...
menu:
  corda-community-4-10:
    identifier: corda-community-4-10-token-sdk
    name: "Tokens SDK"
...
This method always uses database token selection; to use [in-memory selection]({{< relref "token-selection.html" >}}), use `addMoveTokens` with already selected input and output states.
...
This method always uses database token selection, to use in memory [token selection]({{< relref "token-selection.html" >}}), use `addMoveTokens` with already selected input and output states.
