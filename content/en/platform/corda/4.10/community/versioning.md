...
menu:
  corda-community-4-10:
    ...
    parent: corda-community-4-10-versioning-and-upgrades
    weight: 1020
tags:
- versioning
title: Versioning
...
Applications can advertise a *minimum platform version* they require. If your app uses new APIs that were added in (for example) Corda 4.10,
you should specify a minimum version of 12. This will ensure the app won’t be loaded by older nodes. If you can *optionally* use the new
...
For example, consider an app that uses new features introduced in Corda 4.10, but which has passed regression testing on Corda 4.11. It will
advertise a minimum platform version of 12 and a target version of 13. These numbers are published in the JAR manifest file.

If this app is loaded into a Corda 4.10 (platform version 12) node, that node may implement backwards compatibility workarounds for your app that make it slower,
...
this, you promise that you understood all the changes in Corda 4.10 (platform version 12) and have thoroughly tested your app to prove it works. This testing should
