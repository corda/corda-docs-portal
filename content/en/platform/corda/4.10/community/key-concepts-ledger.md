...
menu:
  corda-community-4-10:
    identifier: corda-community-4-10-key-concepts-ledger
...
Although there is no central ledger, you can broadcast a basic fact to all nodes of a network using the [network map](network-map.md)
service.
