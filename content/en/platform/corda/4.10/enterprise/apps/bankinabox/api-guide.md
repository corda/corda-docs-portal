...
menu:
  corda-enterprise-4-10:
    ...
    identifier: bank-in-a-box-api-guide-4-10
tags:
- Bank in a Box
- API
weight: 400
...
Send a `GET` request to the `/customers` endpoint to invoke the [GetCustomersPaginatedFlow]({{< relref "./back-end-guide.md#getcustomerspaginatedflow" >}}). This flow returns a paginated list of all customers matching the given search crtieria. This request requires authorization. It can be sent by an admin user.
