...
1. Remove any entries of `transactionIsolationLevel`, `initialiseSchema`, `initialiseAppSchema`, and `runMigration` from the database section of your [node configuration file](../../../../../en/platform/corda/4.10/enterprise/node/setup/corda-configuration-file.md).
2. Update any missing core schema changes by either running the [Database Management Tool](../../../../../en/platform/corda/4.10/enterprise/database-management-tool.md) (recommended) or running the node in `run-migration-scripts` mode: `java -jar corda.jar run-migration-scripts --core-schemas`.
...
See [CorDapp configuration files](../../../../../en/platform/corda/4.10/enterprise/cordapps/cordapp-build-systems.html#cordapp-configuration-files) for more information.
...
You can learn more by reading [contract/state agreement](../../../../../en/platform/corda/4.10/enterprise/cordapps/api-contract-constraints.html#contractstate-agreement).
...
[Signature constraints](../../../../../en/platform/corda/4.10/enterprise/cordapps/api-contract-constraints.html#signature-constraints) are a new data model feature introduced in Corda 4. They make it much easier to smoothly
...
existing states on ledger issued with older constraint types (such as Corda 3.x states issued with **hash** or **CZ whitelisted** constraints) by reading the [CorDapp constraints migration](../../../../../en/platform/corda/4.10/enterprise/cordapps/cordapp-constraint-migration.md) guide.
...
[package namespace ownership](../../../../../en/platform/corda/4.10/enterprise/node/deploy/env-dev.html#package-namespace-ownership).
...
If your flows could benefit from being extended in this way, see [overriding a flow via node configuration](../../../../../en/platform/corda/4.10/enterprise/cordapps/flow-overriding.html#overriding-a-flow-via-node-configuration).
...
Please also read the [CorDapp upgradeability guarantees](../../../../../en/platform/corda/4.10/enterprise/cordapps/cordapp-upgradeability.md).
