...
### name
The name of HSM provider to be used; for example: `UTIMACO`, `GEMALTO_LUNA`, etc. See [Using an HSM with Corda Enterprise]({{< relref "operating/cryptoservice-configuration.md" >}}).
