...
Flow hospital functionality is enabled by default in Corda Enterprise Edition 4.10. No explicit configuration settings are required.
...
* visualization of failed flows in the [flow management console](../../../../../../en/platform/corda/4.10/enterprise/node/node-flow-management-console.md).
