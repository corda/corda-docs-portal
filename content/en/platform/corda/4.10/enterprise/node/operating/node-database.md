...
Database setup for production systems (with **restricted permissions**) is described in [Database schema setup](../../../../../../../en/platform/corda/4.9/enterprise/node/operating/node-database-admin.md),
and the recommended setup for development/testing environments are described in [Simplified database schema setup for development](../../../../../../../en/platform/corda/4.9/enterprise/node/operating/node-database-developer.md).
...
You can review all available commands and options in the [Database Management Tool documentation](../../../../../../../en/platform/corda/4.9/enterprise/database-management-tool.md).
...
For more details, see [Database tables](../../../../../../../en/platform/corda/4.9/enterprise/node/operating/node-database-tables.md).
