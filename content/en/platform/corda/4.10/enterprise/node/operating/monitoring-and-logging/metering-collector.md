...
menu:
  corda-enterprise-4-10:
    identifier: corda-enterprise-4-10-metering-collection
...
All Corda Enterprise nodes record metering data, the metering collection tool is used to collect data from the node. Node metering data can also be collected using the [metering client](../../../../../../../../en/platform/corda/4.10/enterprise/node/operating/monitoring-and-logging/metering-rpc.md).
...
The metering collection tool is distributed as part of Corda Enterprise Edition 4.10 under the name `corda-tools-metering-collector-4.9.jar`. You must place this `.jar` file in the `cordapps` directory of the node.
...
You invoke this flow from the [shell](../../../../../../../../en/platform/corda/4.10/enterprise/node/operating/shell.md). The flow takes the following arguments:
...
* the [Corda RPC API](../../../../../../../../en/platform/corda/4.10/enterprise/api-rpc.md)
* the [node shell](../../../../../../../../en/platform/corda/4.10/enterprise/node/operating/shell.md)
