...
(under `/corda-webserver-4.10.jar`) and place it in `/opt/corda`
...
* Save the below as `/opt/corda/node.conf`. See [Node configuration](../setup/corda-configuration-file.md) for a description of these options:
...
* Save the below as `C:\Corda\node.conf`. See [Node configuration](../setup/corda-configuration-file.md) for a description of these options:
