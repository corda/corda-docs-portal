...
* A node configuration file with a name `node.conf`, configured as described in the [Node configuration](../corda-firewall-configuration-file.md) section.
...
The remaining node files and directories will be generated at runtime. These are described in the [Node folder structure](../corda-firewall-configuration-file.md) section.
