...
menu:
  corda-enterprise-4-10:
    identifier: corda-enterprise-4-10-corda-nodes-notaries
...
{{< note >}}
In production we recommend running five nodes or more replicas in the notary state database cluster. However, there is more flexibility regarding the number of notary workers, since this is only a concern with availability, not durability, as a result there is a tradeoff between the number of notary workers and availability performance.
{{< /note >}}
