...
menu:
  corda-enterprise-4-10:
    parent: corda-enterprise-4-10-corda-nodes-notaries
tags:
- hsm
- support
...
to use a unique alias for the identity and client ca key. See [Node configuration]("../node/setup/corda-configuration-file.md) for more information on how to configure this.
