...
menu:
  corda-enterprise-4-10:
    identifier: corda-enterprise-4-10-cordapps-debugging
...
1. [Define a network using the node driver](../../../../../tutorials/corda/4.10/community/supplementary-tutorials/tutorial-integration-testing.md).
