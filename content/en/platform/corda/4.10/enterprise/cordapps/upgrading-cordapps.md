...
The general recommendation for Corda 4 is to use **implicit** upgrades for the reasons described in [Implicit and explicit contract upgrades]({{< relref "api-contract-constraints.md#implicit-and-explicit-contract-upgrades" >}}).
