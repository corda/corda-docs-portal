...
This article focuses on implicit contract upgrades. To learn about the explicit upgrades see [Release new CorDapp versions](../../../../../../en/platform/corda/4.9/enterprise/cordapps/upgrading-cordapps.md).
...
You can [sign a CorDapp directly from Gradle](../../../../../../en/platform/corda/4.9/enterprise/cordapps/cordapp-build-systems.html#sign-the-cordapp).
...
You must specify which CorDapp packages to scan when you run tests. Provide a package containing the contract class in `MockNetworkParameters`. See [Testing CorDapps](../../../../../../en/platform/corda/4.9/enterprise/cordapps/api-testing.md).
