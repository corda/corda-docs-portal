...
Contract CorDapp please read [Contract and state versioning](../../../4.10/enterprise/cordapps/upgrading-cordapps.html#contract-and-state-versioning) and [CorDapp Upgradeability Guarantees](cordapp-upgradeability.md) to understand your options.
{{< /warning >}}
