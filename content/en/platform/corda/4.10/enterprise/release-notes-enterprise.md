...
* The OpenTelemetry tracing signal is now supported in flows across nodes. For more information, refer to the [OpenTelemetry](node/operating/monitoring-and-logging/opentelemetry.md) section.
