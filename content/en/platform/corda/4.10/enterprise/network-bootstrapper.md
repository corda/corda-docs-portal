...
1. Download the [Corda Network Bootstrapper](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-network-bootstrapper/4.10.3/corda-tools-network-bootstrapper-4.10.3.jar) for the version of Corda you want the nodes to run.
...
`install-shell-extensions`: Installs the `bootstrapper` alias and auto-completion for bash and zsh. See [Shell extensions for CLI applications]({{< relref "node/operating/cli-application-shell-extensions.md#shell-extensions-for-cli-applications" >}}).
