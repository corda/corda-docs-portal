...
1. Download the [Corda Network Bootstrapper](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-network-bootstrapper/4.10.2/corda-tools-network-bootstrapper-4.10.2.jar) for the version of Corda you want the nodes to run.
...
Before you add `exclude_whitelist.txt` or `include_whitelist.txt` files, refer to [contract constraints](cordapps/api-contract-constraints.md) to understand different constraint types.
