...
menu:
  corda-enterprise-4-10:
    identifier: corda-enterprise-4-10-operations-guide-deployment-cenm-kubernetes
...
- Download the Docker image with the {{< cenmlatestrelref "cenm/cenm-cli-tool.md" "CENM Command Line Interface" >}} so you can manage CENM services:
...
Use the {{< cenmlatestrelref "cenm/cenm-cli-tool.md" "CENM Command Line Interface" >}} to access the [Gateway Service]({{< relref "../../node/gateway-service.md" >}}) from your local machine.
...
1. Create the library JAR as described in {{< cenmlatestrelref "cenm/signing-service.md#azure-key-vault" "Signing Service" >}} .
...
Visit the [platform support matrix]({{< relref "../../platform-support-matrix.md#docker-images" >}}) for information on Corda Docker Images for version 4.10.
