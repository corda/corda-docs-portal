...
menu:
  corda-enterprise-4-10:
    identifier: corda-enterprise-4-10-operations-guide-deployment-node-running-remotely
...
{{< note >}}
The remote node running method described in this page is designed for testing use. For production-grade deployments visit the [node deployments page](../../../../../../../en/platform/corda/4.10/enterprise/node-docker-deployments.md).
{{< /note >}}
