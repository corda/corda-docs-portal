...
menu:
  corda-enterprise-4-10:
    identifier: corda-enterprise-4-10-operations-guide-deployment-notary
...
and ease of operation, the recommended database is CockroachDB 23.1.x. The full set of supported configurations is
...
The JPA notary service is tested against CockroachDB 23.1.x. CockroachDB’s
[documentation page](https://www.cockroachlabs.com/docs/v23.1/) explains the installation
in detail.
