...
You should interact with each node via its shell over SSH - see the [node configuration options](../../node/setup/corda-configuration-file.md) for more information.
