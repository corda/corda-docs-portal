...
menu:
  corda-enterprise-4-10:
    identifier: corda-enterprise-4-10-operations-guide-deployment-node-generating-dockerform
...
You should interact with each node via its shell over SSH - see the [node configuration options](../../../../../../../en/platform/corda/4.10/enterprise/node/setup/corda-configuration-file.md) for more information.
