...
* A node configuration file with a name `node.conf`, configured as described in the [Node configuration](../../../../../../../en/platform/corda/4.9/enterprise/node/setup/corda-configuration-file.md) section.
...
The remaining node files and directories will be generated at runtime. These are described in [Node configuration](../../../../../../../en/platform/corda/4.9/enterprise/node/setup/corda-configuration-file.md) section.
...
See [Upgrading a node to Corda 4.9](../../../../../../../en/platform/corda/4.9/enterprise/node-upgrade-notes.md) for more information.
