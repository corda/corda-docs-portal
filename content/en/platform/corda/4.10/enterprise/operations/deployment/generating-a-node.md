...
The remaining node files and directories will be generated at runtime. These are described in [Node configuration](../../node/setup/corda-configuration-file.md) section.
...
See [Upgrading a node to Corda 4.10](../../node-upgrade-notes.md) for more information.
