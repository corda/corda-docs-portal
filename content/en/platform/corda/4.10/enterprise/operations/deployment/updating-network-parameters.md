...
for information on the network parameters configuration file format and options. You can find supplementary information in the [CENM Network Map documentation]({{< relref "../../../../1.5/cenm/network-map.md#network-parameters" >}}).
...
{{< note >}}
Corda 4.10 does not support hotswapping of Network Parameters within a node. As a result, all nodes will shut down in this situation, regardless of whether they have accepted the parameter update or not.
{{< /note >}}
