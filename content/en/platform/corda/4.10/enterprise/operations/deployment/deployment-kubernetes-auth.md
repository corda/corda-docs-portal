...
menu:
  corda-enterprise-4-10:
    ...
    identifier: corda-enterprise-4-10-operations-guide-deployment-cenm-kubernetes-auth
tags:
- config
- kubernetes
...
This Helm chart is to configure, deploy, and run the [Auth Service](../../node/auth-service.md) on Kubernetes.
...
| `authImage.tag`               | Docker image tag | `1.5.4-zulu-openjdk8u242` |
