...
You can find a further explanation of this in [Oracles](../../../../../en/platform/corda/4.10/community/key-concepts-oracles.md). Below you will see how to build such a
...
[OracleNodeTearOffTests.kt](https://github.com/corda/corda/blob/release/os/4.10/samples/irs-demo/cordapp/workflows-irs/src/test/kotlin/net/corda/irs/api/OracleNodeTearOffTests.kt)

See [here](https://github.com/corda/corda/blob/release/os/4.10/samples/irs-demo/cordapp/workflows-irs/src/test/kotlin/net/corda/irs/api/OracleNodeTearOffTests.kt) for more examples.
