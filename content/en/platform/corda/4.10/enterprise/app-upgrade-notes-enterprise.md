...
Before upgrading to Corda Enterprise Edition 4.10, upgrade your CorDapp to Corda Community Edition 4.10. See [Upgrading CorDapps to newer platform versions]({{< relref "app-upgrade-notes.md" >}}) for detailed instructions.
...
in an open source production environment, then follow the [re-compiling for Corda Enterprise Edition 4.10](#re-compiling-for-corda-enterprise-edition-410) guide.
