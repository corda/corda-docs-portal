...
See [Network parameters]({{< relref "../../network/network-parameters.md" >}})
for information on the network parameters configuration file format and options. You can find supplementary information in the {{< cenmlatestrelref "cenm/network-map.md#network-parameters" "CENM Network Map documentation" >}}.
