...
* Download `TemplateInitiator.java` and `TemplateContract.java` from the [CorDapp tutorial repository](https://github.com/corda/samples-java/tree/release/4.12/Basic/tutorial-applestamp).
...
Take a look at the [Apple Stamp CorDapp solution](https://github.com/corda/samples-java/tree/release/4.12/Basic/tutorial-applestamp) to see the implementation of integration tests for the `RedeemApples` flow and the `PackageApples` flow.
