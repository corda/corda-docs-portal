...
## Release packs and checksums for Corda Enterprise Edition 4.12.12

The release packs and checksum files for Corda Enterprise 4.12.12 can be downloaded from the [Customer Hub](https://customerhub.r3.com).

The following release packs are available, along with their respective checksum files:

* devtest-4.12.12.tar.gz: required for building, developing, and testing CorDapps.
* runtime-4.12.12.tar.gz: required to run Corda.

The following release packs are provided as optionals for external tools, SDKs, and CorDapps:
* optional-sdk-4.12.12.tar.gz
* optional-tools-4.12.12.tar.gz

## Release packs and checksums for Corda Enterprise Edition 4.12.11

The release packs and checksum files for Corda Enterprise 4.12.11 can be downloaded from the [Customer Hub](https://customerhub.r3.com).

The following release packs are available, along with their respective checksum files:

* devtest-4.12.11.tar.gz: required for building, developing, and testing CorDapps.
* runtime-4.12.11.tar.gz: required to run Corda.

The following release packs are provided as optionals for external tools, SDKs, and CorDapps:
* optional-sdk-4.12.11.tar.gz
* optional-tools-4.12.11.tar.gz

## Release packs and checksums for Corda Enterprise Edition 4.12.10

The release packs and checksum files for Corda Enterprise 4.12.10 can be downloaded from the [Customer Hub](https://customerhub.r3.com).

The following release packs are available, along with their respective checksum files:

* devtest-4.12.10.tar.gz: required for building, developing, and testing CorDapps.
* runtime-4.12.10.tar.gz: required to run Corda.

The following release packs are provided as optionals for external tools, SDKs, and CorDapps:
* optional-sdk-4.12.10.tar.gz
* optional-tools-4.12.10.tar.gz

## Release packs and checksums for Corda Enterprise Edition 4.12.9

The release packs and checksum files for Corda Enterprise 4.12.9 can be downloaded from the [Customer Hub](https://customerhub.r3.com).

The following release packs are available, along with their respective checksum files:

* devtest-4.12.9.tar.gz: required for building, developing, and testing CorDapps.
* runtime-4.12.9.tar.gz: required to run Corda.

The following release packs are provided as optionals for external tools, SDKs, and CorDapps:
* optional-sdk-4.12.9.tar.gz
* optional-tools-4.12.9.tar.gz
