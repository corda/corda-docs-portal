...
{{< note >}}
Obfuscation is supported exclusively for Corda-related configuration files, such as node or other core components. It is not available for CorDapps or non-Corda-specific configuration files.
{{< /note >}}
