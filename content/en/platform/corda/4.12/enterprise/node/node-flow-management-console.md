...
The flow management console allows you to see the state of the flows running on a node and perform some operations on them. It runs as part of the {{< cenmlatestrelref "cenm/gateway-service.md" "Gateway Service" >}}.
