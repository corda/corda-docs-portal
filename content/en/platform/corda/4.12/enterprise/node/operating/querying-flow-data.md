...
For details of how to build a Multi RPC Client, see [Building a Multi RPC Client]({{< relref "clientrpc.md#building-the-multi-rpc-client" >}}). See also [MultiRPCClient](../../../../../../../en/api-ref/corda/4.12/community/javadoc/net/corda/client/rpc/ext/MultiRPCClient.html) in the API documentation.
