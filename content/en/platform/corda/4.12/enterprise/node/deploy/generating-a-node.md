...
* The Corda JAR artifact file, downloaded from [Maven](https://download.corda.net/maven/corda-releases/net/corda/corda/4.12/corda-4.12.jar).
...
* An up-to-date version of the `network-parameters` file (see [The network map]({{< relref "../../network/network-map.md" >}})), generated by the bootstrapper tool.
