...
The checkpoint agent can be downloaded from [here](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-checkpoint-agent/4.12/corda-tools-checkpoint-agent-4.11.jar).
