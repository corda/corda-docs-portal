...
Additionally, if a CorDapp has been updated to platform version 140, you must upgrade Corda node to Corda 4.12. For instructions on how to upgrade Corda nodes, see [Corda Community Edition 4.11 to 4.12 upgrade guide]({{< relref "comm-upgrade-guide.md" >}}).
