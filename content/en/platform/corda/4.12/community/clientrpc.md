...
The Multi RPC Client in Corda Open Source Edition can be used as an extension of the [net.corda.core.messaging.CordaRPCOps](../../../../api-ref/corda/4.12/community/javadoc/index.html) remote interface.
