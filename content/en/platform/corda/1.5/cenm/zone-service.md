...
- `--disable-authentication`: Allows you to disable authentication and authorisation via the {{< cordalatestrelref "enterprise/node/auth-service.md" "Auth Service" >}}. Only use this option in development environments. Defaults to `false` if no value is provided.
