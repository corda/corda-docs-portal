...
For additional information on database connection details refer to the [Corda database documentation]({{< relref "../../4.10/enterprise/node/setup/corda-configuration-file.md" >}}).
