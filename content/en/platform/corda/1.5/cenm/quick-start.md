...
* An [Auth Service](../../4.8/enterprise/node/auth-service.md) deployment to handle user authentication and authorisation.
* A [Gateway Service](../../4.8/enterprise/node/gateway-service.md) deployment to act as a gateway from the user interface (CLI) to the back-end services.
