...
1. Use the Corda Enterprise Configuration Obfuscator tool. See [Configuration Obfuscator](../../../../../en/platform/corda/4.8/enterprise/tools-config-obfuscator.md) for more information.
