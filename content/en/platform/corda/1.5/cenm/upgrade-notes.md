...
1. Generate new certificates for [FARM](../../../../../en/platform/corda/4.7/enterprise/node/gateway-service.md), [Auth](../../../../../en/platform/corda/4.7/enterprise/node/auth-service.md), and [Zone](../../../../../en/platform/corda/1.3/cenm/zone-service.md) Services.
...
7. Edit [Identity Manager Service](../../../../../en/platform/corda/1.3/cenm/identity-manager.md), [Network Map Service](../../../../../en/platform/corda/1.3/cenm/network-map.md), and [Signing Service](../../../../../en/platform/corda/1.3/cenm/signing-service.md) configurations to remove shell access and add an admin listener configuration.
8. Edit the [Signing Service](../../../../../en/platform/corda/1.3/cenm/signing-service.md) configuration so that signing tasks refer to [service aliases](../../../../../en/platform/corda/1.5/cenm/signing-service.html#direct-cenm-service-locations) generated by the Zone Service.
9. Set Identity Manager Service configuration in the [Zone Service](../../../../../en/platform/corda/1.3/cenm/zone-service.md).
...
To generate the JWT, refer to the [Auth Service](../../../../../en/platform/corda/4.7/enterprise/node/auth-service.md) documentation.
...
* [FARM Service](../../../../../en/platform/corda/4.7/enterprise/node/gateway-service.md)
* [Auth Service](../../../../../en/platform/corda/4.7/enterprise/node/auth-service.md)
...
The [Auth Service](../../../../../en/platform/corda/4.7/enterprise/node/auth-service.md) has an initial user who can manage users, however
