...
8. Edit the [Signing Service]({{< relref "../../../../../en/platform/corda/1.3/cenm/signing-service.md" >}}) configuration so that signing tasks refer to [service aliases]({{< relref "../../../../../en/platform/corda/1.5/cenm/signing-service.md#direct-cenm-service-locations" >}}) generated by the Zone Service.
...
13. Add [Angel Services]({{< relref "../../../../../en/platform/corda/1.3/cenm/angel-service.md" >}}) to Identity Manager, Network Map, and Signing Services, to fetch configurations from the Zone
   Service.
...
these names. The names are specified in [service aliases]({{< relref "../../../../../en/platform/corda/1.3/cenm/signing-service.md#direct-cenm-service-locations" >}}).
