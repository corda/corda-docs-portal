...
1. Generate new certificates for [the Gateway Service]({{< relref "../../4.10/enterprise/node/gateway-service.md" >}}), [the Auth Service]({{< relref "../../4.10/enterprise/node/auth-service.md" >}}), and [the Zone Service]({{< relref "../../1.3/cenm/zone-service.md" >}}).
...
8. Edit the [Signing Service]({{< relref "../../1.3/cenm/signing-service.md" >}}) configuration so that signing tasks refer to [service aliases]({{< relref "signing-service.md#direct-cenm-service-locations" >}}) generated by the Zone Service.
...
To generate the JWT, refer to the [Auth Service]({{< relref "../../4.10/enterprise/node/auth-service.md" >}}) documentation.
...
The [Auth Service]({{< relref "../../4.10/enterprise/node/auth-service.md" >}}) has an initial user who can manage users, however
