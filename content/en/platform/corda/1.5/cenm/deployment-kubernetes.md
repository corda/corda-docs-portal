...
Use the CENM [Command Line Interface (CLI) Tool]({{< relref "cenm-cli-tool.md" >}}) to access the [Gateway Service]({{< relref "../../4.10/enterprise/node/gateway-service.md" >}}) from your local machine.
...
The [Gateway Service]({{< relref "../../4.10/enterprise/node/gateway-service.md" >}}) is a gateway between the [Auth Service]({{< relref "../../4.10/enterprise/node/auth-service.md" >}}) and front end services in CENM. It allows you to perform all network operations on the [Identity Manager service]({{< relref "identity-manager.md" >}}), the [Network Map service]({{< relref "network-map.md" >}}), and the [Signing Service]({{< relref "signing-service.md" >}}).
...
[Joining an existing compatibility zone]({{< relref "../../4.10/enterprise/network/joining-a-compatibility-zone.md" >}}).
{{< /note >}}
...
Visit the [platform support matrix]({{< relref "../../4.10/enterprise/platform-support-matrix.md#docker-images" >}}) for information on Corda Docker Images for version 1.5.
