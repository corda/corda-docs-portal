...
- [Auth Service](../../4.8/enterprise/node/auth-service.md) that has been set up with at least one user (ideally an admin user) and running.
- [Zone Service](zone-service.md) running.
- [Gateway Service](../../4.8/enterprise/node/gateway-service.md) is installed and running.

### Install the CENM management console

The CENM management console is accessed via the [Gateway Service](../../4.8/enterprise/node/gateway-service.md). Once you have added the plugin binaries to the correct directory on the machine that hosts your Gateway Service, you can access the web service from any browser.
