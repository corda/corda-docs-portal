...
8. Edit the [Signing Service](signing-service.md) configuration so that signing tasks refer to [service aliases](../../../../../en/platform/corda/1.4/cenm/signing-service.html#direct-cenm-service-locations) generated by the Zone Service.
...
for generating the full SSL hierarchy is provided under [../../../../../en/platform/corda/1.4/cenm/config-samples/upgrade-pki-tool.conf](config-samples/upgrade-pki-tool.conf/).
...
these names. The names are specified in [service aliases](../../../../../en/platform/corda/1.4/cenm/signing-service.html#direct-cenm-service-locations).
