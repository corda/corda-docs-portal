...
1. Use the Corda Enterprise Configuration Obfuscator tool. See [Configuration Obfuscator]({{< relref "../../4.7/enterprise/tools-config-obfuscator.md" >}}) for more information.
