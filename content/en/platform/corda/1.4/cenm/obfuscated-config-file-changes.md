...
1. Use the Corda Enterprise configuration obfuscator tool. See [Configuration obfuscator]({{< relref "../../4.8/enterprise/tools-config-obfuscator.md" >}}) for more information.
