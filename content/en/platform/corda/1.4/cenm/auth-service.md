...
When you use any front end interface for CENM, the Auth Service is activated and updated via a front-end gateway, called the [Gateway service]({{< relref "gateway-service.md" >}}).
