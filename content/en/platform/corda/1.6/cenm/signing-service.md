...
The Signing Service supports the following HSMs (see [CENM support matrix]({{< relref "../../../../../en/platform/corda/1.6/cenm/cenm-support-matrix.md#hardware-security-modules-hsms" >}}) for more information):
...
[Shell Configuration]({{< relref "../../../../../en/platform/corda/1.6/cenm/shell.md#shell-config" >}}) for more information on how to configure the shell.
