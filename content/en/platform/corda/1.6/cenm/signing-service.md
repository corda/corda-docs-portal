...
menu:
  cenm-1-6:
    identifier: cenm-1-6-signing-service
...
The Signing Service forms a part of the main Corda Enterprise Network Manager (CENM) services, alongside the [Identity Manager Service]({{< relref "../../../../../en/platform/corda/1.6/cenm/identity-manager.md" >}}) and the [Network Map Service]({{< relref "../../../../../en/platform/corda/1.6/cenm/network-map.md" >}}) (and complemented by the [Auth Service]({{< relref "../../../../../en/platform/corda/4.8/enterprise/node/auth-service.md" >}}), the [Zone Service]({{< relref "../../../../../en/platform/corda/1.6/cenm/zone-service.md" >}}), the [Angel Service]({{< relref "../../../../../en/platform/corda/1.6/cenm/angel-service.md" >}}), and the [Gateway Service]({{< relref "../../../../../en/platform/corda/4.8/enterprise/node/gateway-service.md" >}})).

As mentioned in other CENM service documentation ([Identity Manager Service]({{< relref "../../../../../en/platform/corda/1.6/cenm/identity-manager.md" >}}) and [Network Map Service]({{< relref "../../../../../en/platform/corda/1.6/cenm/network-map.md" >}})), the main CENM services
...
The Signing Service supports the following HSMs (see [CENM support matrix](../../../../../en/platform/corda/1.6/cenm/cenm-support-matrix.html#hardware-security-modules-hsms) for more information):
...
[Configuring the CENM services to use SSL]({{< relref "../../../../../en/platform/corda/1.6/cenm/enm-with-ssl.md" >}}) for more information.
{{< /note >}}
...
[Shell Configuration](../../../../../en/platform/corda/1.6/cenm/shell.html#shell-config) for more information on how to configure the shell.
...
* `azure-keyvault` and `msal4j` to use the new Microsoft MSAL authentication library.
...
and are manually signed every 3 months. See [CRL Endpoint Check Tool]({{< relref "../../../../../en/platform/corda/1.6/cenm/crl-endpoint-check-tool.md" >}}) for more information how to check
...
See [EJBCA Sample Plugin]({{< relref "../../../../../en/platform/corda/1.6/cenm/ejbca-plugin.md" >}}) for sample open source CA implementation.
...
To view the latest changes to the obfuscated configuration files, see [Obfuscation configuration file changes]({{< relref "../../../../../en/platform/corda/1.6/cenm/obfuscated-config-file-changes.md" >}}).
