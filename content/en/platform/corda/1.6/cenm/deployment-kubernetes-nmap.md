...
This Helm chart is to configure, deploy, and run the [CENM Network Map Service]({{< relref "../../../../../en/platform/corda/1.5/cenm/network-map.md" >}}) on Kubernetes.
...
| `dockerImage.tag`             | Docker image tag | `1.5.6-zulu-openjdk8u242` |
