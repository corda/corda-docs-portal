...
configured. See the “Signing Network Map and Network Parameters” section of [Signing services]({{< relref "../../../../../en/platform/corda/1.6/cenm/signing-service.md" >}}). If the service is
...
retried after a short break. See the “Identity Manager Communication” section of [Network Map service]({{< relref "../../../../../en/platform/corda/1.6/cenm/network-map.md" >}}) to verify that the
...
[Identity Manager configuration parameters]({{< relref "../../../../../en/platform/corda/1.6/cenm/config-identity-manager-parameters.md" >}}) and [Network Map configuration parameters]({{< relref "../../../../../en/platform/corda/1.6/cenm/config-network-map-parameters.md" >}}) for more information.
