...
menu:
  cenm-1-6:
    identifier: cenm-1-6-quick-start
...
* A [Signing Service]({{< relref "../../../../../en/platform/corda/1.6/cenm/signing-service.md" >}}) deployment to replace the built-in (local) signing component of the Identity Manager and Network Map Services.
* A [Zone Service]({{< relref "../../../../../en/platform/corda/1.6/cenm/zone-service.md" >}}) deployment to manage configuration deployment.
* [Angel Services]({{< relref "../../../../../en/platform/corda/1.6/cenm/angel-service.md" >}}) around the [Identity Manager]({{< relref "../../../../../en/platform/corda/1.6/cenm/identity-manager.md" >}}), [Network Map]({{< relref "../../../../../en/platform/corda/1.6/cenm/network-map.md" >}}),
...
{{< note >}}
For more information on the certificate hierarchy, see [Certificate hierarchy guide]({{< relref "../../../../../en/platform/corda/1.6/cenm/pki-guide.md" >}}).
{{< /note >}}
...
{{< note >}}
The passwords for the key stores are defaulted to “password” and the passwords for the trust stores are defaulted to “trustpass”. To change them in the configuration setting, see [Public key infrastructure (PKI) tool]({{< relref "../../../../../en/platform/corda/1.6/cenm/pki-tool.md" >}})).
{{< /note >}}

#### Run the PKI Tool

This step generates the required certificate stores and key pairs using the
[Public key infrastructure (PKI) tool]({{< relref "../../../../../en/platform/corda/1.6/cenm/pki-tool.md" >}}). You will need to
...
See the “Database properties” section of [Identity Manager service]({{< relref "../../../../../en/platform/corda/1.6/cenm/identity-manager.md" >}}) for more information.
{{< /note >}}
...
{{< note >}}
This example uses a local H2 database. You can modify this to point to a separate database instance by modifying the `database` section. See the “Database properties” section of [Network Map service]({{< relref "../../../../../en/platform/corda/1.6/cenm/network-map.md" >}}) for more information.
...
See [Updating the network parameters]({{< relref "../../../../../en/platform/corda/1.6/cenm/updating-network-parameters.md" >}}) for more information on the process for setting and updating the parameters.
...
* Certificate revocation support (“Revocation workflow ” section within [Identity Manager service]({{< relref "../../../../../en/platform/corda/1.6/cenm/identity-manager.md" >}}))
* More advanced CSR approval workflows (“Certificate approval mechanism” section within [Identity Manager service]({{< relref "../../../../../en/platform/corda/1.6/cenm/identity-manager.md" >}}))
* External signing of CSRs/Network Map updates including HSM integration ([Signing Service]({{< relref "../../../../../en/platform/corda/1.6/cenm/signing-service.md" >}}))

{{< note >}}For more information, see the configuration sections within [Identity Manager service]({{< relref "../../../../../en/platform/corda/1.6/cenm/identity-manager.md" >}}) and [Network Map service]({{< relref "../../../../../en/platform/corda/1.6/cenm/network-map.md" >}}). {{< /note >}}
