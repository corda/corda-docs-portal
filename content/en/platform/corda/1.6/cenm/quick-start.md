...
* Network Map Service
* [Notary Service]({{< relref "../../4.10/enterprise/notary/notary-operate.md" >}})
...
* An [Auth Service]({{< relref "../../4.10/enterprise/node/auth-service.md" >}}) deployment to handle user authentication and authorisation.
* A [Gateway Service]({{< relref "../../4.10/enterprise/node/gateway-service.md" >}}) deployment to act as a gateway from the user interface (CLI) to the back-end services.
