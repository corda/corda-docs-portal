...
For more information about X.500 Name constraints, see the `Node naming` section in the [Corda documentation]({{< relref "../../4.10/enterprise/node/deploy/generating-a-node.md" >}}).
