...
Corda Enterprise Network Manager 1.6+ has been tested and verified to work with **Oracle JDK 8 JVM 8u461** and **Azul Zulu Enterprise 8u462**. For the Azure deployment downloadable, go to [Azul Systems](https://www.azul.com/downloads/azure-only/zulu/).
