...
Corda Enterprise Edition 4.11 has been tested and verified to work with **Oracle JDK 8 JVM 8u381** and **Azul Zulu Enterprise 8u382**. Corda Enterprise Network Manager 1.6 has been tested and verified to work with **Oracle JDK 8 JVM 8u392** and **Azul Zulu Enterprise 8u392**. For Azure deployment downloadable from [Azul Systems](https://www.azul.com/downloads/azure-only/zulu/).
