...
* Resolved an issue where the CENM logger ignored custom `log4j2.xml` files. You can now provide custom `log4j2.xml` files and CENM will use the custom configuration.
