...
2. Renew the TLS certificate and keys, as described in  the [Renewing TLS certificates](../../../../../../../en/platform/corda/4.9/enterprise/ha-utilities.html#renewing-tls-certificates) section in [HA Utilities]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/ha-utilities.md" >}}).
