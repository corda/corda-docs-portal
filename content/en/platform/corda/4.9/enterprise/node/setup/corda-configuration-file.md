...
environment variable isn’t present (see [Hiding sensitive data]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/node/operating/node-administration.md#hiding-sensitive-data" >}}) for more information).
