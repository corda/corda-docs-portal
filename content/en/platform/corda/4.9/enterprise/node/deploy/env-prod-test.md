...
You can find examples of configuration files [available here](../../../../../../../en/platform/corda/4.8/enterprise/node/corda-firewall-configuration-file.md).
...
A full list of the parameters that can be utilized in these configuration files can be found in [Configuring the Corda Enterprise Firewall](../../../../../../../en/platform/corda/4.8/enterprise/node/corda-firewall-configuration-file.md).


### Corda 3.x vs Corda 4.x Firewall Upgrade

In Corda 4.x it is possible to for multiple Nodes representing multiple identities to reside behind the same Corda Firewall. Details on setup can be found in [Firewall upgrade](../../../../../../../en/platform/corda/4.8/enterprise/node/corda-firewall-upgrade.md).
