...
The Corda Network Bootstrapper can be downloaded [here](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-network-bootstrapper/4.9.8/corda-tools-network-bootstrapper-4.9.8.jar).
...
variable `KEY_STORE_PASSWORD`. See [Hiding sensitive data]({{< relref "../operating/node-administration.md#hiding-sensitive-data" >}}) for more information.

{{< /note >}}
The available configuration fields are listed below:w
