...
The Node management console allows you to see information about a node and perform some operations on it. It runs as a plug-in for the [Gateway Service]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/node/gateway-service.md" >}}).
