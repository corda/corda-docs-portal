...
For details of how to build a Multi RPC Client, see [Building a Multi RPC Client]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/node/operating/clientrpc.md#building-the-multi-rpc-client" >}}). See also [MultiRPCClient](../../../../../../../en/api-ref/corda/4.9/community/javadoc/net/corda/client/rpc/ext/MultiRPCClient.html) in the API documentation.
