...
For more information on how to monitor a node, see [Node administration]({{< relref "../../../../../../../../en/platform/corda/4.9/enterprise/node/operating/node-administration.md" >}}), [Node monitoring and logging]({{< relref "../../../../../../../../en/platform/corda/4.9/enterprise/node/operating/monitoring-and-logging/overview.md" >}}), and [Node monitoring scenarios]({{< relref "../../../../../../../../en/platform/corda/4.9/enterprise/node/operating/monitoring-and-logging/monitoring-scenarios.md" >}}).
