...
All Corda Enterprise nodes record metering data, the metering collection tool is used to collect data from the node. Node metering data can also be collected using the [metering client]({{< relref "../../../../../../../../en/platform/corda/4.9/enterprise/node/operating/monitoring-and-logging/metering-rpc.md" >}}).
...
You invoke this flow from the [shell]({{< relref "../../../../../../../../en/platform/corda/4.9/enterprise/node/operating/shell.md" >}}). The flow takes the following arguments:
...
* the [Corda RPC API]({{< relref "../../../../../../../../en/platform/corda/4.9/enterprise/api-rpc.md" >}})
* the [node shell]({{< relref "../../../../../../../../en/platform/corda/4.9/enterprise/node/operating/shell.md" >}})
