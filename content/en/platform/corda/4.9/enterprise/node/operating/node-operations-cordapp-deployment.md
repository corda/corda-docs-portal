...
Because of that, most of the steps are similar to those described in [Database schema setup](../../../../../../../en/platform/corda/4.9/enterprise/node/operating/node-database-admin.md).
