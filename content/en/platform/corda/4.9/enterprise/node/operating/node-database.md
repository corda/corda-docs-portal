...
menu:
  corda-enterprise-4-9:
    identifier: corda-enterprise-4-9-corda-nodes-operating-db
...
The Corda platform, and the installed CorDapps store their data in a relational database (see [State Persistence](../../../../../../../en/platform/corda/4.8/enterprise/cordapps/state-persistence.md)).
...
Database setup for production systems (with **restricted permissions**) is described in [Database schema setup](../../../../../../../en/platform/corda/4.8/enterprise/node/operating/node-database-admin.md),
and the recommended setup for development/testing environments are described in [Simplified database schema setup for development](../../../../../../../en/platform/corda/4.8/enterprise/node/operating/node-database-developer.md).
...
You can review all available commands and options in the [Database Management Tool documentation](../../../../../../../en/platform/corda/4.8/enterprise/database-management-tool.md).
...
For more details, see [Database tables](../../../../../../../en/platform/corda/4.8/enterprise/node/operating/node-database-tables.md).
...
The structure of the tables of JPA notaries are described at [Configuring a JPA notary backend](../../../../../../../en/platform/corda/4.8/enterprise/notary/installing-jpa.html#configuring-jpa-notary-backend).
...
described in [Database Schema Migration Logging](../../../../../../../en/platform/corda/4.8/enterprise/node-database-migration-logging.html#database-schema-migration-logging).
