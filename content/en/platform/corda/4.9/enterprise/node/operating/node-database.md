...
The Corda platform, and the installed CorDapps store their data in a relational database (see [State Persistence]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/cordapps/state-persistence.md" >}})).
...
Database setup for production systems (with **restricted permissions**) is described in [Database schema setup]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/node/operating/node-database-admin.md" >}}),
and the recommended setup for development/testing environments are described in [Simplified database schema setup for development]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/node/operating/node-database-developer.md" >}}).
...
You can review all available commands and options in the [Database Management Tool documentation]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/database-management-tool.md" >}}).
