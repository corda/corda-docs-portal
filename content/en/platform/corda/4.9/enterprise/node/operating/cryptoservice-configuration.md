...
See the [Hardware Security Modules (HSM)]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/platform-support-matrix.md#hardware-security-modules-hsm" >}}) for supported HSMs and their features.
...
As mentioned in the description of the configuration file ([Node configuration]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/node/setup/corda-configuration-file.md" >}})), the `node.conf` has three relevant fields:
* `cryptoServiceName`
* `cryptoServiceConf`
