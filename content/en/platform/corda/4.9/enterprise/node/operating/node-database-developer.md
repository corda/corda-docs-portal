...
(see the documentation on [Database access when running H2]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/node-database-access-h2.md" >}}), hence when using H2 database it’s sufficient to [start the node]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/node/operating/node-database-admin.md#3-corda-node-configuration" >}}) and the database will be created.
...
See [Node configuration]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/node/setup/corda-configuration-file.md#database" >}}) for a complete list of database specific properties, it contains more options useful in case of testing Corda with unsupported databases.
