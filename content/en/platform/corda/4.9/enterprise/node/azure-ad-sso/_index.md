...
2. Configure your [Auth Service]({{< relref "../../../../../../../en/platform/corda/4.9/enterprise/node/auth-service" >}}).
3. If you use the [CENM Command-line Interface Tool]({{< relref "../../../../../../../en/platform/corda/1.5/cenm/cenm-cli-tool" >}}), you also need to configure Azure AD to enable commands.
...
You can now access Azure login using the [CENM Command-line Interface Tool]({{< relref "../../../../../../../en/platform/corda/1.5/cenm/cenm-cli-tool" >}}).
