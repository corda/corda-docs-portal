...
receiver flows to use the new APIs and thus opting in to platform version 4. See [Step 5. Security: Upgrade your use of FinalityFlow](../../../../../../en/platform/corda/4.9/enterprise/app-upgrade-notes.html#5-improve-the-security-of-your-cordapp-by-upgrading-how-you-use-finalityflow) for more information.
...
process described in the paragraph below to migrate these to signature constraints. See [CorDapp constraints migration](../../../../../../en/platform/corda/4.9/enterprise/cordapps/cordapp-constraint-migration.md) for more information.
...
that requires programmatic code changes. See [CZ whitelisted constraints migration](../../../../../../en/platform/corda/4.9/enterprise/cordapps/cordapp-constraint-migration.html#migrating-cz-whitelisted-constraints) for more information.
* Explicit Contract Upgrades are only supported for hash and CZ whitelisted constraint types. See [Performing explicit contract and state upgrades](../../../../../../en/platform/corda/4.9/enterprise/cordapps/upgrading-cordapps.html#performing-explicit-contract-and-state-upgrades) for more information.
...
See [Installing the CorDapp JAR](../../../../../../en/platform/corda/4.9/enterprise/cordapps/cordapp-build-systems.html#create-the-cordapp-jar) and [CorDapp Contract Attachments](../../../../../../en/platform/corda/4.9/enterprise/cordapps/cordapp-build-systems.html#cordapp-contract-attachments) for more information.
...
where the latest installed contract Jar is signed as per [CorDapp Jar signing](../../../../../../en/platform/corda/4.9/enterprise/cordapps/cordapp-build-systems.html#sign-the-cordapp).
