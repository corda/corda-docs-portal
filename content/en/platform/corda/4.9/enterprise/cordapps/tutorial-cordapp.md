...
Get started with Corda by running a sample CorDapp. Learn how to download, deploy, launch, interact with, and test a CorDapp before you try [building your own](../get-started/tutorials/build-basic-cordapp/basic-cordapp-intro.html), modifying a [Java](https://github.com/corda/cordapp-template-java) or [Kotlin](https://github.com/corda/cordapp-template-kotlin) template or using a [community CorDapp](https://www.corda.net/samples/).
