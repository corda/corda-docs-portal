...
Get started with Corda by running a sample CorDapp. Learn how to download, deploy, launch, interact with, and test a CorDapp before you try [building your own](../../../4.10/community/get-started/tutorials/build-basic-cordapp/basic-cordapp-intro.md), modifying a [Java](https://github.com/corda/cordapp-template-java) or [Kotlin](https://github.com/corda/cordapp-template-kotlin) template or using a [community CorDapp](https://www.corda.net/samples/).
...
in [Building and installing a CorDapp](../../../../../../en/platform/corda/4.9/enterprise/cordapps/cordapp-build-systems.md).
{{< /note >}}
