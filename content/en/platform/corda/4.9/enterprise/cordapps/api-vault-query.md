...
* The vault query API.
* A JDBC session (see [State Persistence](../../../../../../en/platform/corda/4.9/enterprise/cordapps/state-persistence.md)).
...
`CONSUMED`), state reference, contract state type, notary name, soft locked states, timestamps (`RECORDED`, `CONSUMED`), state constraints (see [Constraint Types](../../../../../../en/platform/corda/4.9/enterprise/cordapps/api-contract-constraints.html#implicit-constraint-types), relevancy (`ALL`, `RELEVANT`, `NON_RELEVANT`), and participants (exact or any match).
{{< note >}}
...
by a custom contract state that implements its own schema as described in the [State Persistence](../../../../../../en/platform/corda/4.9/enterprise/cordapps/state-persistence.md)
...
[VaultQueryTests.kt](https://github.com/corda/corda/blob/release/os/4.9/node/src/test/kotlin/net/corda/node/services/vault/VaultQueryTests.kt)
...
[VaultQueryJavaTests.java](https://github.com/corda/corda/blob/release/os/4.9/node/src/test/java/net/corda/node/services/vault/VaultQueryJavaTests.java)
