...
defined in the `build.gradle` files. See [Building and installing a CorDapp]({{< relref "../../../../../../en/platform/corda/4.9/enterprise/cordapps/cordapp-build-systems.md" >}}) for more information.
