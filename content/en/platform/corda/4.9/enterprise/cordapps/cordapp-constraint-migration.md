...
Contract CorDapp please read [Contract and state versioning](upgrading-cordapp.html#contract-and-state-versioning) and [CorDapp Upgradeability Guarantees](cordapp-upgradeability.md) to understand your options.
{{< /warning >}}
...
relaxed hash constraint checking mode as described in [Hash constrained states in private networks](api-contract-constraints.html#types-of-contract-constraints).
