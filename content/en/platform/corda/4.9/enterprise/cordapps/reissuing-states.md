...
{{< note >}}
This functionality is part of Corda open source 4.9 and can be fully leveraged by Corda: Enterprise Edition  4.9 users as well.
{{< /note >}}
...
* Corda Open Source or Corda: Enterprise Edition , version 4.7 or higher
