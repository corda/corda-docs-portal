...
* Corda Enterprise Edition 4.0 nodes can run CorDapps developed on and packaged for Corda 4.x, without recompilation.
  ...
  that are optimized for each distribution. See [separation of CorDapp contracts, flows and services]({{< relref "../../../../../en/platform/corda/4.9/enterprise/cordapps/cordapp-build-systems.md#separate-cordapp-contracts-flows-and-services" >}}) for further information.
