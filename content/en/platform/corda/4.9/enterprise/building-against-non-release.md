...
10. In your CorDapp’s root `build.gradle` file:
  ...
  2. Update `corda_gradle_plugins_version` to the `gradlePluginsVersion` you noted earlier - for Corda Enterprise 4.9, this must be `ext.corda_gradle_plugins_version = '5.0.12'`.
