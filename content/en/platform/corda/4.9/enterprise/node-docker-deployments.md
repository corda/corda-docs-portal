...
{{< /note >}}
It is possible to use the image to automate the process of joining an existing Zone as detailed [here](../../../../../en/platform/corda/4.9/enterprise/network/compatibility-zones.md)
