...
The Spent State Audit Tool is distributed with Corda: Enterprise Edition  as a `.jar` file that must be run from the command line using the following command:
