...
menu:
  corda-enterprise-4-9:
    identifier: corda-enterprise-4-9-key-concepts-transactions
...
the proposed transaction. [Uniqueness](key-concepts-consensus.html#uniqueness-consensus) is determined by a [notary]{{< relref "key-concepts-notaries.md" >}}).
