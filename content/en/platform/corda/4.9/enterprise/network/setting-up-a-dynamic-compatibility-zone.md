...
Each individual parameter is documented in [the JavaDocs/KDocs for the NetworkParameters class](../../../../../../en/api-ref/corda/4.9/open-source/kotlin/corda/net.corda.core.node/-network-parameters/index.html). The network map
