...
* A node configuration file with a name `node.conf`, configured as described in the [Node configuration](../../node/setup/corda-configuration-file.md) section.
...
The remaining node files and directories will be generated at runtime. These are described in the [Node configuration](../../node/setup/corda-configuration-file.md) section.
...
See [Upgrading a node to Corda 4.9](../../node-upgrade-notes.md) for more information.
