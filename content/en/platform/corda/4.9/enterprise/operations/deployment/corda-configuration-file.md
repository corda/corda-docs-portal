...
menu:
  corda-enterprise-4-9:
    identifier: corda-enterprise-4-9-operations-guide-deployment-configuration-file
...
environment variable isn’t present (see: [Hiding sensitive data](../../node/operating/node-administration.html#hiding-sensitive-data) for more information).
