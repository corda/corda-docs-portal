...
menu:
  corda-enterprise-4-9:
    identifier: corda-enterprise-4-9-operations-guide-deployment-node-generating-cordform
...
To configure [package namespace ownership](../../../../../../../en/platform/corda/4.9/enterprise/node/deploy/env-dev.html#package-namespace-ownership), use the optional `networkParameterOverrides` and `packageOwnership` blocks, in a similar way to how the configuration file is used by the [Network Bootstrapper](../../../../../../../en/platform/corda/4.9/enterprise/network-bootstrapper.md) tool. For example:
