...
Download the Corda Network Builder from [Maven](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-network-builder/4.9.7/corda-tools-network-builder-4.9.7-all.jar).
