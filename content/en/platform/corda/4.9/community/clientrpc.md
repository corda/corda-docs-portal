...
For further information on using the RPC API, see [Working with the CordaRPCClient API](../../../../tutorials/corda/4.8/os/supplementary-tutorials/tutorial-clientrpc-api.md).
...
`@CordaSerializable` annotation (see [Object serialization](serialization.md)). An example is shown in [Working with the CordaRPCClient API](../../../../tutorials/corda/4.8/os/supplementary-tutorials/tutorial-clientrpc-api.md).
