...
* For more information about the tasks, visit the [Dockerform](../../../../../en/platform/corda/4.9/community/generating-a-node-dockerform.md) and [Cordform](generating-a-node-cordform.md) pages.
