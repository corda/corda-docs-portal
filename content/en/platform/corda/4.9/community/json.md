...
menu:
  corda-community-4-9:
    identifier: corda-community-4-9-json
...
* [Kotlin API docs](https://api.corda.net/api/corda-os/4.9/html/api/kotlin/corda/net.corda.client.jackson/-jackson-support/index.html)
* [JavaDoc](https://api.corda.net/api/corda-os/4.9/html/api/javadoc/net/corda/client/jackson/package-summary.html)
