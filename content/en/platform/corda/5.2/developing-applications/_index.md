...
For information about deploying locally to a static network with the combined worker, see [Corda Runtime Gradle Plugin Template]({{< relref "./runtime-plugin/_index.md" >}}).
