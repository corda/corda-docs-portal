...
1. Follow the [CSDE environment instructions]({{< relref "../runtime-plugin/installing/_index.md"  >}}) to start the Corda combined worker and to deploy the static network.
...
1. Following the [CSDE documentation]({{< relref "../runtime-plugin/installing/_index.md" >}}) steps, open the Swagger UI and log in.
