...
menu:
  cenm-1-7:
    identifier: cenm-1-7-network-map-overview
...
more about *contract constraints* in the [contract constraints documentation]({{< relref "../../../../../en/platform/corda/4.12/enterprise/cordapps/api-contract-constraints.md" >}}). See
