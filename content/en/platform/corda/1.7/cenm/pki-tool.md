...
For more information about X.500 Name constraints, see {{< cordalatestrelref "enterprise/node/deploy/generating-a-node.md" "Node naming" >}} in the Corda documentation.
...
###### Using `msal4j` (_available from CENM 1.7.1_)
