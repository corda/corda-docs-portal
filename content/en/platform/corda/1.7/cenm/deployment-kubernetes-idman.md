...
menu:
  cenm-1-7:
    parent: cenm-1-7-deployment-kubernetes
tags:
- config
- kubernetes
...
This Helm chart is to configure, deploy, and run the CENM [Identity Manager service]({{< relref "identity-manager.md" >}}) on Kubernetes.

## Example usage

The example below shows a command that triggers the Helm chart for the [Zone Service]({{< relref "zone-service.md" >}}):
