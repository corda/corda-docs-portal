...
8. Log in using the initial user credentials.
...
To view the status and any pending changes to the Network Parameters, or to make new updates:
...
To access the Identity Manager Service:
