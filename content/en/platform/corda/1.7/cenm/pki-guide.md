...
* They need to have a custom extension defining the role of the certificate in the context of Corda. See
  [here]({{< relref "../../4.12/enterprise/network/permissioning.md#certificate-role-extension" >}}) for more details.
...
At the time of writing this document, the Corda Network assumes the certificate hierarchy that can be found [here]({{< relref "../../4.12/enterprise/network/permissioning.md" >}}).
