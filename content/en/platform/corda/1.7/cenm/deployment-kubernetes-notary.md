...
For additional information on database connection details refer to the [Corda database documentation]({{< relref "../../4.12/enterprise/node/setup/corda-configuration-file.md" >}}).
