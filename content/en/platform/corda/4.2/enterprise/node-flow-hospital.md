...
Flow hospital functionality is enabled by default in Corda Enterprise Edition 4.2. No explicit configuration settings are required.
...
As of Corda Enterprise Edition 4.2, this UI is informational only (read-only). Future versions of Corda will extend the basic functionality to enable
