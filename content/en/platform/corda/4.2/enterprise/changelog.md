...
input state owner.
    * Please see the documentation on [Identities](../../../../../en/platform/corda/4.1/open-source/key-concepts-ecosystem.html#identity) and [API: Identity](api-identity.md) for more details.
