...
- notes
- enterprise
title: Upgrading CorDapps to Corda Enterprise 4.2
---




# Upgrading CorDapps to Corda Enterprise 4.2


## Upgrading from Open Source


### Running on Corda Enterprise 4.2

A prerequisite to upgrade to Corda Enterprise 4.2 is to ensure your CorDapp is upgraded to Open Source Corda 4.x.
...
### Re-compiling for Corda Enterprise 4.2
...
{{< note >}}
Corda Enterprise 4.2 binaries are not available in a public repository. In order to make the dependencies available for development, either
