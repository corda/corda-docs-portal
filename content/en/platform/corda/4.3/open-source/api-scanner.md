...
new Corda release. The stable Corda modules are listed [here](api-stability-guarantees.html#internal-apis-and-stability-guarantees). Our CI process runs an “API Stability”
...
or anything in a module that isn’t in the stable modules list [here](api-stability-guarantees.html#internal-apis-and-stability-guarantees).
