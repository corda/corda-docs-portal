---
aliases:
- /releases/release-V4.3/checkpoint-tooling.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-4-3:
    identifier: corda-os-4-3-checkpoint-tooling
    parent: corda-os-4-3-tools-index
    weight: 1050
tags:
- checkpoint
- tooling
...
An advanced explanation of [checkpoints](contributing-flow-internals.html#flow-internals-checkpoints-ref) within the flow state machine can be found here: [Flow framework internals](contributing-flow-internals.md).
...
See [Generating a node](generating-a-node.html#the-cordform-task)
