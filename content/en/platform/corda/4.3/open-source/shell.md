---
aliases:
- /releases/release-V4.3/shell.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-4-3:
    identifier: corda-os-4-3-shell
...
The shell can be used to query flow data. For more information on the types of data that can be queried and instructions for doing so, search Querying flow data.
