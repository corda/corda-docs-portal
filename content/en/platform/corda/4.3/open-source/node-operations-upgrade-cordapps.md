---
aliases:
- /releases/release-V4.3/node-operations-upgrade-cordapps.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-4-3:
    identifier: corda-os-4-3-node-operations-upgrade-cordapps
...
Management Tool as detailed [here](../../corda-enterprise/4.3/node/operations/node-operations-cordapp-deployment.md/).
* Restart the node
