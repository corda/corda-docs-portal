...
menu:
  corda-os-4-3:
    identifier: corda-os-4-3-cordapp-build-systems
...
[Configuring a node](corda-configuration-file.html#corda-configuration-file-signer-blacklist)).
...
API documentation can be found at [api/kotlin/corda/net.corda.core.cordapp/index.html](https://api.corda.net/api/corda-os/4.3/html/api/kotlin/corda/net.corda.core.cordapp/index.html).
