...
menu:
  corda-enterprise-4-3:
    identifier: corda-enterprise-4-3-api-contract-constraints
...
[node configuration documentation](corda-configuration-file.html#blacklistedattachmentsigningkeys).
...
This is expanded upon in [Using Contract Constraints in Transactions](#using-signature-constraints-in-transactions).
