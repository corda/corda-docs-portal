---
aliases:
- /releases/4.3/performance-testing/performance-tuning.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-3:
    identifier: corda-enterprise-4-3-performance-tuning
...
[Setting JVM arguments](../running-a-node.html#setting-jvm-arguments). The recommended approach for performance optimisation work is to use the JVM argument section in the node
...
Flow and RPC threads can be set explicitly using the [tuning section](../corda-configuration-file.html#tuning) of the enterprise configuration. Add the following section to your
