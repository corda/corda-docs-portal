...
Float.  See [Use of HSM in Corda Firewall](corda-firewall.html#use-of-hsm-in-corda-firewall) for an overview.
...
### name
The name of HSM provider to be used. E.g.: `UTIMACO`, `GEMALTO_LUNA`, etc. See [HSM support for legal identity keys](cryptoservice-configuration.md).
