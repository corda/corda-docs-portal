...
more information on supported operating modes please see [Operating modes of the Bridge and Float](corda-firewall.md).
...
#### Node configuration file - Hot instance
...
#### Node configuration file - Cold instance
