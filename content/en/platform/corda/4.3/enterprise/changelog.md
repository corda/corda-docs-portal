...
input state owner.
    * Please see the documentation [Identities](../../../../../en/platform/corda/4.3/open-source/key-concepts-ecosystem.html#identities-and-discovery) and [API: Identity](api-identity.md) for more details.
