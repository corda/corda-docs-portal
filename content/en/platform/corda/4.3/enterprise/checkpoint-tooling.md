---
aliases:
- /releases/4.3/checkpoint-tooling.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-3:
    identifier: corda-enterprise-4-3-checkpoint-tooling
...
An advanced explanation of *checkpoints* within the flow state machine can be found here: [Flow framework internals](../open-source/contributing-flow-internals.md).
...
See [the Cordform task](generating-a-node.html#the-cordform-task).
