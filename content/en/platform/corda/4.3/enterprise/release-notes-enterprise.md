...
## Corda Enterprise 4.3.10

{{< note >}}
This is a direct upgrade from 4.3.8. No version 4.3.9 was released.
{{< /note >}}

Corda Enterprise 4.3.10 is a patch release of Corda Enterprise that fixes an urgent security issue - CVE-2021-44228 - caused by the Apache Log4j 2 dependency. In this fix, the Log4j dependency is updated to version 2.16.0.
