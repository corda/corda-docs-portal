...
* Ensure your CorDapp is designed per [Structuring a CorDapp](writing-a-cordapp.md) and annotated according to [Separation of CorDapp contracts, flows and services](#separation-of-cordapp-contracts-flows-and-services).
