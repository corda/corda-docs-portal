...
The `corda-crypto-extensions` package of the `Corda Crypto API` defines low-level crypto capabilities that can be used to extend functionality of the Corda Crypto Library by implementing them in a {{< tooltip >}}CPK{{< /tooltip >}}. For more information about this package, see the documentation for the package in the <a href="../../../../../../api-ref/corda/{{<version-num>}}/net/corda/v5/crypto/extensions/package-summary" target=" blank">Java API documentation</a>.
