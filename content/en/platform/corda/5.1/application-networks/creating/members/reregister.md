...
4. Send a re-registration request using the common [registration/re-registration endpoint](https://docs.r3.com/en/platform/corda/5.0/reference/rest-api/openapi.html#tag/Member-Registration-API/operation/post_membership__holdingidentityshorthash_).
