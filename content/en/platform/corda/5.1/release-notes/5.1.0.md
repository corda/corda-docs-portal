...
The performance of the retrieval of unconsumed states in the `findUnconsumedStatesByType` query has been improved. As a result, it is now more efficient to scan the table with an index on `utxo_visible_transaction_state.consumed`.
