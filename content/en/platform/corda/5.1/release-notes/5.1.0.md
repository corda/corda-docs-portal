...
For more information about sharding, see [Token Selection Worker Sharding]({{< relref "../deploying-operating/deployment/_index.md#token-selection-worker-sharding" >}}).
