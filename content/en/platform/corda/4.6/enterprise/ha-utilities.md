...
|Certificate|Max validity |Alias|File store|Steps to generate|
|---------------|-------------------|-----------------------|------------------|----------------------------------------|
...
|Node TLS|10 years |cordaclienttls-<hash>|sslkeystore.jks|<ul><li>Generate key pair (HSM or file)</li><li>Create Certificate signed by Node CA</li></ul>|
...
contain the notary service certificate chain. See [HSM Support](notary/hsm-support.html#hsm-support-for-notaries) for more information.
