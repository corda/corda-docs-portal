...
menu:
  corda-enterprise-4-6:
    identifier: corda-enterprise-4-6-cordapps-debugging
...
* Define a network using the node driver as described in [Conducting integration Testing](../../../../../../en/platform/corda/4.6/open-source/tutorial-integration-testing.md).
