...
The tool is distributed as part of Corda Enterprise Edition 4.6 in the form of runnable `.jar.` file - `corda-tools-blob-inspector-4.6.jar`.

To run simply pass in the file or URL as the first parameter:

```kotlin
java -jar corda-tools-blob-inspector-4.6.jar <file or URL>
```
