...
menu:
  corda-enterprise-4-6:
    ...
    identifier: corda-enterprise-4-6-operations-guide-deployment-cenm-kubernetes-signer
tags:
- config
- kubernetes
...
This Helm chart is to configure, deploy and run the  [CENM Signing Service](../../../../1.4/cenm/signing-service.md) on Kubernetes.
...
* [Certificate Hierarchy Guide](../../../../1.4/cenm/pki-guide.md)
* [PKI Tool](../../../../1.4/cenm/pki-tool.md)
...
| `signerImage.tag`                            | Docker image Tag | `1.4.4-zulu-openjdk8u242` |
