...
menu:
  corda-enterprise-4-6:
    ...
    identifier: corda-enterprise-4-6-operations-guide-deployment-cenm-kubernetes-notary
tags:
- config
- kubernetes
...
| `dockerImage.tag`             | Docker image Tag | `4.5.2-zulu-openjdk8u242` |
...
For additional information on database connection details refer to the [Corda database documentation](../../../../../../../en/platform/corda/4.6/open-source/corda-configuration-file.md).
