...
use admin RPC. For information about the legacy process, see the [CENM 1.2 documentation](../../../../1.4/cenm/updating-network-parameters.md).
{{< /note >}}
...
update. See [the Corda node RPC API](../../../../../../../en/platform/corda/4.6/open-source/tutorial-clientrpc-api.md) for further details.
