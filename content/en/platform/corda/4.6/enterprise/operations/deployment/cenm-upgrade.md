...
menu:
  corda-enterprise-4-6:
    identifier: corda-enterprise-4-6-operations-guide-deployment-cenm-upgrade
...
{{< warning >}}
Before you start the upgrade, you must consult the [CENM Release Notes](../../../../1.4/cenm/release-notes.md) to confirm all changes between releases.
{{< /warning >}}
...
1. Generate new certificates for [Gateway](../../../../1.3/cenm/gateway-service.md), [Auth](../../../../1.3/cenm/auth-service.md), and [Zone](../../../../1.3/cenm/zone-service.md) Services.
...
* [Gateway Service](../../../../1.3/cenm/gateway-service.md)
