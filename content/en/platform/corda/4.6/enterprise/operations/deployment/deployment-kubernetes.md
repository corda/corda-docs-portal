...
Each service runs in its own dedicated Kubernetes pod, with the exception of the [Angel Service](../../../../1.4/cenm/angel-service.md), which runs in the same pod as its managed service.
...
Use the CENM [Command Line Interface (CLI) Tool](../../../../1.4/cenm/cenm-cli-tool.md) to access the [Gateway Service](../../../../1.4/cenm/gateway-service.md) from your local machine.
...
The [Gateway Service](../../../../1.4/cenm/gateway-service.md) is a gateway between the [Auth Service](../../../../1.4/cenm/auth-service.md) and front end services in CENM. It allows you to perform all network operations on the [Identity Manager Service](../../../../1.4/cenm/identity-manager.md), the [Network Map Service](../../../../1.4/cenm/network-map.md), and the [Signing Service](../../../../1.4/cenm/signing-service.md).
...
[Joining an existing compatibility zone](../../../../../../../en/platform/corda/4.6/open-source/joining-a-compatibility-zone.md).
{{< /note >}}
...
The Signing Service is not managed by the [Angel Service](../../../../1.4/cenm/angel-service.md) in this deployment, therefore any CENM Command-Line Interface (CLI) tool commands trying to change the Signing Service configuration will take no effect.
...
and then setting up the database user/schema, following the instructions in the [CENM database setup](../../../../1.4/cenm/database-set-up.md) section.
...
| Notary            | acrcenm.azurecr.io/notary/notary     | 4.5 |
