...
1. Download the shell `.jar` file for your version of Corda from [Artifactory](https://software.r3.com/ui/repos/tree/General/corda-enterprise-for-customers)—for example, `corda-tools-shell-cli-4.6.jar`.
...
The shell can be used to upload and download attachments from the node. To learn how, see the [Working with attachments](../../../../4.7/open-source/tutorial-attachments.html#uploading-an-attachment) tutorial.
