...
1. Download the shell `.jar` file for your version of Corda from [Artifactory](https://software.r3.com/artifactory/corda-releases/net/corda/corda-tools-shell-cli/)—for example, `corda-tools-shell-cli-4.6.jar`.
...
[here](https://docs.r3.com/en/api-ref/corda/4.6/open-source/kotlin/corda/net.corda.core.messaging/-corda-r-p-c-ops/index.html).
...
The shell can be used to query flow data. For more information on the types of data that can be queried and instructions for doing so, see the documentation on [querying flow data](../../4.6/enterprise/node/operating/querying-flow-data.html#querying-flow-data-via-the-node-shell).
