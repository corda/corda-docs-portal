...
parent: corda-enterprise-4-13-cordapps-debugging
tags:
- network
- bootstrapper
...
1. Download the [Corda Network Bootstrapper ](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-network-bootstrapper/4.13/corda-tools-network-bootstrapper-4.13.jar) for the version of Corda you want the nodes to run.
...
4. Run the command `java -jar network-bootstrapper-4.13.jar --dir <nodes-root-dir>`.
...
`java -jar network-bootstrapper-4.13.jar --dir <nodes-root-dir>`
...
`java -jar network-bootstrapper-4.13.jar --network-parameter-overrides=<path_to_file>`

Or the short form version:

`java -jar network-bootstrapper-4.13.jar -n=<path_to_file>`
