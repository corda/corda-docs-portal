...
menu:
  corda-enterprise-4-13:
    identifier: corda-enterprise-4-13-reissuing-states
...
{{< note >}}
This functionality is part of Corda Open Source Edition 4.12 and can be fully leveraged by Corda Enterprise Edition 4.12 users as well.
{{< /note >}}
