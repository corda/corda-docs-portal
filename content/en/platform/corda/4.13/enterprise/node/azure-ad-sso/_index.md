...
3. If you use the [CENM Command-line Interface Tool]({{< relref "../../../../1.6/cenm/cenm-cli-tool.md" >}}), you also need to configure Azure AD to enable commands.
...
You can now access Azure login using the [CENM Command-line Interface Tool]({{< relref "../../../../1.6/cenm/cenm-cli-tool.md" >}}).
