...
The Corda Network Bootstrapper can be downloaded [here](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-network-bootstrapper/4.13/corda-tools-network-bootstrapper-4.13.jar).
...
```bash
java -jar corda-tools-network-bootstrapper-4.13.jar --dir <nodes-root-dir>
```
...
```bash
java -jar corda-tools-network-bootstrapper-4.13.jar --network-parameter-overrides=<path_to_file>
```

Or alternatively, by using the short form version:

```bash
java -jar corda-tools-network-bootstrapper-4.13.jar -n=<path_to_file>
```
