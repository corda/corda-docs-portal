...
menu:
  corda-enterprise-4-13:
    identifier: corda-enterprise-4-13-error-codes
...
For a list of error codes specific to Corda Enterprise Network Manager (CENM), see [CENM error codes]({{< relref "../../../../../../../en/platform/corda/1.6/cenm/cenm-error-codes.md" >}}).
