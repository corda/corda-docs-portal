...
The metering collection tool is distributed as part of Corda Enterprise Edition 4.13 under the name `corda-tools-metering-collector-4.13.jar`. You must place this JAR file in the `cordapps` directory of the node.
