...
menu:
  corda-community-4-13:
    identifier: corda-community-4-13-blob-inspector
...
The tool is distributed as a `.jar.` file - `corda-tools-blob-inspector-4.13.jar`. To run it, pass in the file or URL as the first parameter:

```kotlin
java -jar corda-tools-blob-inspector-4.13.jar <file or URL>
```
