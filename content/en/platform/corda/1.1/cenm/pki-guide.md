...
* They need to have a custom extension defining the role of the certificate in the context of Corda. See .. _here: [https://docs.corda.net/head/permissioning.html#certificate-role-extension](../../../../../en/platform/corda/4.3/open-source/permissioning.html#certificate-role-extension) for more details.
