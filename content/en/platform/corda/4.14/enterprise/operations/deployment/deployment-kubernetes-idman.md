...
menu:
  corda-enterprise-4-14:
    parent: corda-enterprise-4-14-operations-guide-deployment-cenm-kubernetes
    identifier: corda-enterprise-4-14-operations-guide-deployment-cenm-kubernetes-idman
tags:
- config
- kubernetes
...
This Helm chart is to configure, deploy, and run the CENM {{< cenmlatestrelref "cenm/identity-manager.md" "Identity Manager Service" >}} on Kubernetes.

## Example usage

The example below shows a command that triggers the Helm chart for the {{< cenmlatestrelref "cenm/zone-service.md" "Zone Service" >}}:
