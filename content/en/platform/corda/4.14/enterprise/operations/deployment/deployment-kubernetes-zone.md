...
menu:
  corda-enterprise-4-14:
    ...
    identifier: corda-enterprise-4-14-operations-guide-deployment-cenm-kubernetes-zone
tags:
- config
- kubernetes
...
This Helm chart is to configure, deploy, and run the {{< cenmlatestrelref "cenm/zone-service.md" "Zone Service" >}} on Kubernetes.
