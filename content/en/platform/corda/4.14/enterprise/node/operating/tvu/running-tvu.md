...
{{< important >}}
The TVU included in the 4.14 release is compatible only with 4.14 database schemas.
{{</ important >}}
...
To verify transactions on a 4.14 database:

- Place the TVU JAR in your Corda 4.14 node directory.
