...
3. If you use the {{< cenmlatestrelref "cenm/cenm-cli-tool.md" "CENM Command-line Interface Tool" >}}, you also need to configure Azure AD to enable commands.
...
You can now access Azure login using the {{< cenmlatestrelref "cenm/cenm-cli-tool.md" "CENM Command-line Interface Tool" >}}.
