...
* Download the `.tar` [file](https://download.corda.net/corda-open-source/4.14/corda-open-source-4.14.tar).
* Download the `.zip` [file](https://download.corda.net/corda-open-source/4.14/corda-open-source-4.14.zip)
