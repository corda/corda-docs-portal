...
menu:
  corda-community-4.14:
    identifier: corda-community-4.14-tutorial-basic-cordapp-state
    parent: corda-community-4.14-tutorial-basic-cordapp-intro
    weight: 70
tags:
- tutorial
- cordapp
...
If you do not know how to open a CorDapp in IntelliJ, see the documentation on [Running a sample CorDapp]({{< relref "../../../tutorial-cordapp.md#step-2-open-the-sample-cordapp-in-intellij-idea" >}}).
