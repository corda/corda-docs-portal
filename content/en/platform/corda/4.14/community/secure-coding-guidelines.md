...
menu:
  corda-community-4-13:
    identifier: corda-community-4-13-secure-coding-guidelines
...
* How to use security best practices.
...
Counterparties on a network have the ability to run their own code - it is possible that they may not be running the code you provided to take part in the flow. This means it's up to you to validate everything you receive over the network.
