...
menu:
  corda-community-4.14:
    identifier: corda-community-4.14-contract-irs
    parent: corda-community-4.14-component-library-index
    weight: 1030
tags:
- contract
- irs
...
The `Common` data class contains all data that is general to the entire swap; for example, data such as trade identifier,
valuation date, and so on.
