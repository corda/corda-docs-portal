...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-key-concepts-vault
    parent: corda-key-concepts-4-15-community
    weight: 1090
tags:
- concepts
- vault
...
spend the same fungible states. If there are not enough fungible states to satisfy both requests,  one of the requesters receives an `InsufficientBalanceException`.
...
[QueryCriteria.kt](https://github.com/corda/corda/blob/release/os/4.15/core/src/main/kotlin/net/corda/core/node/services/vault/QueryCriteria.kt)
