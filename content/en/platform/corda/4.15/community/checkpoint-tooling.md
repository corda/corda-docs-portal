...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-checkpoint-tooling
...
The checkpoint agent can be downloaded from [here](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-checkpoint-agent/4.15/corda-tools-checkpoint-agent-4.12.jar).
