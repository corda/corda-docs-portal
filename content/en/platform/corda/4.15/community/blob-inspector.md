...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-blob-inspector
    parent: corda-community-4-15-serialization-index
    weight: 1060
tags:
- blob
- inspector
...
The tool is distributed as a `.jar.` file - `corda-tools-blob-inspector-4.15.jar`. To run it, pass in the file or URL as the first parameter:

```kotlin
java -jar corda-tools-blob-inspector-4.15.jar <file or URL>
```
