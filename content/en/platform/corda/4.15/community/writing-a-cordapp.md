...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-writing-a-cordapp
...
* [Java CorDapp template](https://github.com/corda/cordapp-template-java/tree/release/4.15) (for CorDapps written in Java)
* [Kotlin CorDapp template](https://github.com/corda/cordapp-template-kotlin/tree/release/4.15) (for CorDapps written in Kotlin)
