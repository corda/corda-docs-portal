...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-app-upgrade-notes
...
## Upgrading CordDapps to platform version 160
...
Additionally, if a CorDapp has been updated to platform version 140, you must upgrade Corda nodes to Corda 4.12. For instructions on how to upgrade Corda nodes, see [Corda Open Source Edition 4.11 to 4.12 upgrade guide]({{< relref "comm-upgrade-guide.md" >}}).
