...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-event-scheduling
...
Let’s take the example of heartbeat sample in our `samples` repositories ([Kotlin](https://github.com/corda/samples-kotlin/tree/release/4.15/Features/schedulableState-heartbeat), [Java](https://github.com/corda/samples-java/tree/release/4.15/Features/schedulablestate-heartbeat)). The first task is to implement the
