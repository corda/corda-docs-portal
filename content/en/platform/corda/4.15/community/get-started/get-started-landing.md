...
menu:
  corda-community-4-15:
    identifier: get-started-landing-4-15-community
...
* Download the `.tar` [file](https://download.corda.net/corda-open-source/4.15/corda-open-source-4.15.tar).
* Download the `.zip` [file](https://download.corda.net/corda-open-source/4.15/corda-open-source-4.15.zip)
