...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-setting-up-a-dynamic-compatibility-zone
...
Each individual parameter is documented in [the JavaDocs/KDocs for the NetworkParameters class](https://docs.r3.com/api/kotlin/corda/net.corda.core.node/-network-parameters/index.html). The network map
