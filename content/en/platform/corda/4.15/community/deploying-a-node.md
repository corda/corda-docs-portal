...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-deploying-a-node
...
4. Download the [Corda jar](https://download.corda.net/maven/corda-releases/net/corda/corda/4.15/corda-4.15.jar)
(under `/4.15/corda-4.15.jar`) and place it in `/opt/corda`.
...
3. Download the following JAR file:
   https://download.corda.net/maven/corda-releases/net/corda/corda/4.15/corda-4.15.jar
