...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-network-bootstrapper
    parent: corda-community-4-15-tools-index
    weight: 1020
tags:
- network
- bootstrapper
...
1. Download the [Corda Network Bootstrapper ](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-network-bootstrapper/4.15/corda-tools-network-bootstrapper-4.15.jar) for the version of Corda you want the nodes to run.
...
4. Run the command `java -jar network-bootstrapper-4.15.jar --dir <nodes-root-dir>`.
...
`java -jar network-bootstrapper-4.15.jar --dir <nodes-root-dir>`
...
`java -jar network-bootstrapper-4.15.jar --network-parameter-overrides=<path_to_file>`

Or the short form version:

`java -jar network-bootstrapper-4.15.jar -n=<path_to_file>`
...
We've created a sample CorDapp (available in [Java](https://github.com/corda/samples-java/tree/release/4.15/Basic/cordapp-example) and [Kotlin](https://github.com/corda/samples-kotlin/tree/release/4.15/Basic/cordapp-example)) you can use to practice initializing a simple network and registering and unregistering a package namespace.
