...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-corda-configuration-file
...
This file can be found in the `:node` gradle module of the [Corda repository](https://github.com/corda/corda); see [reference.conf](https://github.com/corda/corda/blob/release/os/4.15/node/src/main/resources/corda-reference.conf).
