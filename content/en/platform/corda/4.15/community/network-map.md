...
menu:
  corda-community-4-15:
    identifier: corda-community-4-15-network-map
    parent: corda-community-4-15-corda-networks-index
    weight: 1030
tags:
- network
- map
...
additional endpoints for users. These additional endpoints can be found in {{< cenmlatestrelref "cenm/network-map-overview.md" "Network map overview" >}}.
...
[NetworkParameters.kt](https://github.com/corda/corda/blob/release/os/4.15/core/src/main/kotlin/net/corda/core/node/NetworkParameters.kt)
