...
* The Corda JAR artifact file, downloaded from [Maven](https://download.corda.net/maven/corda-releases/net/corda/corda/4.15/corda-4.15.jar).
...
* An up-to-date version of the `network-parameters` file (see [The network map]({{< relref "../../network/network-parameters.md" >}})), generated by the bootstrapper tool.
