...
* [Download](https://download.corda.net/maven/corda-releases/net/corda/corda-shell/4.15/corda-shell-4.15.jar) the `corda-shell` JAR from Maven and install it in a node's `/drivers` directory to run the shell in the same terminal that starts the node.
...
[here](../../../../../../api-ref/corda/4.15/community/kotlin/docs/net.corda.core.messaging/-corda-r-p-c-ops/index.html).
