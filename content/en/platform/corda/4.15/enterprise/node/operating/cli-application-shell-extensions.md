...
menu:
  corda-enterprise-4-15:
    parent: corda-enterprise-4-15-corda-nodes-operating-interacting
tags:
- cli
- application
- shell
...
|---------------------------------------------------------|------------------------------|----------------------------------------------------------|
|[Corda node]({{< relref "../deploy/running-a-node.md#starting-a-corda-node-from-the-command-prompt" >}})|`corda --<option>`|`corda-4.15.jar`|
|Network bootstrapper|`bootstrapper --<option>`|`corda-tools-network-bootstrapper-4.15.jar`|
|[Standalone shell]({{< relref "shell.md#the-standalone-shell" >}})|`corda-shell --<option>`|`corda-shell-4.15.jar`|
|Blob inspector|`blob-inspector --<option>`|`corda-tools-blob-inspector-4.15.jar`|
...
Database Manager                `database-manager --<option>`  `corda-tools-database-manager-4.15.jar`
Corda Firewall          `corda-firewall --<option>`    `corda-firewall-4.15.jar`                                 |
