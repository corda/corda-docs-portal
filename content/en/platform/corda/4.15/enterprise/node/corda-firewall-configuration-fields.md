---
aliases:
- /docs/4.15/enterprise/operations/deployment/corda-firewall-configuration-file.html
date: '2020-04-07T12:00:00Z'
menu:
  corda-enterprise-4-15:
    parent: corda-enterprise-4-15-corda-nodes-firewall-config
    identifier: corda-enterprise-4-15-corda-nodes-firewall-config-file
tags:
- corda
- firewall
- configuration
