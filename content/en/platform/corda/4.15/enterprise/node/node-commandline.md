...
`install-shell-extensions`: Install `corda` alias and auto completion for bash and zsh; see [Shell extensions for CLI applications]({{< relref "operating/cli-application-shell-extensions.md" >}}) for more info.
