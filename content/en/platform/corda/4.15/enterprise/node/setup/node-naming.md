...
menu:
  corda-enterprise-4-15:
    identifier: corda-enterprise-4-15-corda-nodes-configuring
...
* The `country` attribute is a valid *ISO 3166-1<https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2>* two letter code in upper-case. See the list of [defined country codes](https://github.com/corda/corda/blob/release/os/4.15/tools/worldmap/src/main/resources/net/corda/worldmap/cities.txt).
