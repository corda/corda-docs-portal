...
menu:
  corda-enterprise-4-15:
    identifier: get-started-landing-4-15
...
1. Decide whether you need to use:
   ...
   * **Corda Open Source Edition** - the open source version of Corda, which you can build on now. To use Corda Open Source Edition, you can access the latest version in one of three ways:
     ...
     * Download the latest Corda Open Source Edition `.tar` [file](https://download.corda.net/corda-open-source/4.15/corda-open-source-4.15.tar) that contains the required Corda `.jars`.
