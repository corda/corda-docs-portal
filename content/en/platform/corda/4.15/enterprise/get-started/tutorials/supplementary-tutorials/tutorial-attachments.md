...
menu:
  corda-enterprise-4-15:
    identifier: corda-enterprise-4-15-tutorial-attachments
...
Here is a simple example of how to attach a file to a transaction and send it to the counterparty. The full code for this demo can be found in the [Kotlin](https://github.com/corda/samples-kotlin/tree/release/4.15/Features/attachment-sendfile) and [Java](https://github.com/corda/samples-java/tree/release/4.15/Features/attachment-sendfile) sample repositories.
