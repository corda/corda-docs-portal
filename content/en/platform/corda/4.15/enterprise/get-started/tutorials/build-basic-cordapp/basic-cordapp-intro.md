...
menu:
  corda-enterprise-4-15:
    parent: tutorials-corda-4-15-enterprise
    name: Building your first basic CorDapp
    weight: 60
    identifier: corda-enterprise-4-15-tutorial-basic-cordapp-intro
...
The solution for this CorDapp is available in [Java](https://github.com/corda/samples-java/tree/release/4.15/Basic/tutorial-applestamp) and [Kotlin](https://github.com/corda/samples-kotlin/tree/release/4.15/Basic/tutorial-applestamp). This tutorial walks you through the Java version of the Apple Stamp CorDapp.
