...
menu:
  corda-enterprise-4-15:
    identifier: corda-enterprise-4-15-tutorial-observer-nodes
...
Adding support for observer nodes to your application is easy. The Trade reporting demo ([Kotlin](https://github.com/corda/samples-kotlin/tree/release/4.15/Features/observableStates-tradereporting), [Java](https://github.com/corda/samples-java/tree/release/4.15/Features/observablestates-tradereporting)) shows how to do so.
