...
menu:
  corda-enterprise-4-15:
    identifier: corda-enterprise-4-15-tutorial-basic-cordapp-running
...
Before you run your CorDapp, check your work against the [Apple Stamp CorDapp Java solution](https://github.com/corda/samples-java/tree/release/4.15/Basic/tutorial-applestamp).
