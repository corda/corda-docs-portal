...
menu:
  corda-enterprise-4-15:
    identifier: corda-enterprise-4-15-tutorial-basic-cordapp-int-test
    parent: corda-enterprise-4-15-tutorial-basic-cordapp-intro
    weight: 120
tags:
- tutorial
- cordapp
...
* Download `TemplateInitiator.java` and `TemplateContract.java` from the [CorDapp tutorial repository](https://github.com/corda/samples-java/tree/release/4.15/Basic/tutorial-applestamp).
...
Take a look at the [Apple Stamp CorDapp solution](https://github.com/corda/samples-java/tree/release/4.15/Basic/tutorial-applestamp) to see the implementation of integration tests for the `RedeemApples` flow and the `PackageApples` flow.
