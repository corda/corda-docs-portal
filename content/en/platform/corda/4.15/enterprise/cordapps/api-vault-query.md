...
menu:
  corda-enterprise-4-15:
    parent: corda-enterprise-4-15-cordapps-flows
tags:
- api
- vault
- query
...
[VaultService.kt](https://github.com/corda/corda/blob/release/os/4.15/core/src/main/kotlin/net/corda/core/node/services/VaultService.kt)
...
[CordaRPCOps.kt](https://github.com/corda/corda/blob/release/os/4.15/core/src/main/kotlin/net/corda/core/messaging/CordaRPCOps.kt)
...
`CONSUMED`), state reference, contract state type, notary name, soft locked states, timestamps (`RECORDED`, `CONSUMED`), state constraints (see [Constraint Types]({{< relref "api-contract-constraints.md#implicit-and-explicit-contract-upgrades" >}}), relevancy (`ALL`, `RELEVANT`, `NON_RELEVANT`), and participants (exact or any match).
{{< note >}}
...
[VaultQueryTests.kt](https://github.com/corda/corda/blob/release/os/4.15/node/src/test/kotlin/net/corda/node/services/vault/VaultQueryTests.kt)
...
[VaultQueryJavaTests.java](https://github.com/corda/corda/blob/release/os/4.15/node/src/test/java/net/corda/node/services/vault/VaultQueryJavaTests.java)
