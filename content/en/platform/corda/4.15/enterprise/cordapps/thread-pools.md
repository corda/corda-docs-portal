...
menu:
  corda-enterprise-4-15:
    identifier: corda-enterprise-4-15-cordapps-flows-segthreadpools
...
CorDapps can override the above default flow mapping logic by defining a class which implements [the FlowSchedulerMapper interface](https://github.com/corda/corda/blob/release/os/4.15/core/src/main/kotlin/net/corda/core/flows/scheduler/mapper/FlowSchedulerMapper.kt); for example:
...
The default mapping logic is available [here](https://github.com/corda/corda/blob/release/os/4.15/core/src/main/kotlin/net/corda/core/flows/scheduler/mapper/FlowSchedulerMapperImpl.kt).
...
The following [metric]({{< relref "../node/operating/monitoring-and-logging/node-metrics.md" >}}) was introduced in 4.15 specifically for thread pools:
