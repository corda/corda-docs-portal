...
the following folder and files from the [Kotlin CorDapp Template](https://github.com/corda/cordapp-template-kotlin/tree/release/4.12) or the [Java CorDapp Template](https://github.com/corda/cordapp-template-java/tree/release/4.12) to your project's root directory:
...
ext.corda_release_version = '4.15'
ext.corda_core_release_version = '4.15'
...
* Uploading the attachment JAR to the node via RPC, either programmatically (see [Connecting to a node with CordaRPCClient]({{< relref "../node/operating/clientrpc.md#connecting-to-a-node-with-cordarpcclient" >}}))
