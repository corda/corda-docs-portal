...
menu:
  corda-enterprise-4-15:
    parent: corda-enterprise-4-15-corda-nodes-notary-config
tags:
- installing
- notary
- service
...
{{< note >}}You can skip this section if you are setting up or joining a cluster with CENM.{{< /note >}}
...
you have configured; for example:
