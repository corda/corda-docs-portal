...
menu:
  corda-enterprise-4-15:
    identifier: corda-enterprise-4-15-network-builder
    parent: corda-enterprise-4-15-tools-index
    weight: 1010
tags:
- network
- builder
...
Download the Corda Network Builder from [Maven](https://download.corda.net/maven/corda-releases/net/corda/corda-tools-network-builder/4.15/corda-tools-network-builder-4.12-all.jar).
...
An easy way to build a valid set of nodes is by running `deployNodes`. In this document, we will be using the output of running `deployNodes` for the [Java samples repository](https://github.com/corda/samples-java/tree/release/4.12):
