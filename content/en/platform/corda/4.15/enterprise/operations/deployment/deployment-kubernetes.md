...
menu:
  corda-enterprise-4-15:
    identifier: corda-enterprise-4-15-operations-guide-deployment-cenm-kubernetes
    parent: corda-enterprise-4-15-operations-guide-deployment-cenm
tags:
- config
- kubernetes
...
Each service runs in its own dedicated Kubernetes pod, with the exception of the {{< cenmlatestrelref "cenm/angel-service.md" "Angel Service" >}}, which runs in the same pod as its managed service.
...
- Download the Docker image with the {{< cenmlatestrelref "cenm/cenm-cli-tool.md" "CENM Command-line Interface Tool" >}} so you can manage CENM services:

    ```bash
    docker pull corda/enterprise-cenm-cli:1.6-zulu-openjdk8u392
    ```
...
Use the {{< cenmlatestrelref "cenm/cenm-cli-tool.md" "CENM Command-line Interface Tool" >}} to access the [Gateway Service]({{< relref "../../node/gateway-service.md" >}}) from your local machine.
...
The [Gateway Service]({{< relref "../../node/gateway-service.md" >}}) is a gateway between the [Auth Service]({{< relref "../../node/auth-service.md" >}}) and front-end services in CENM. It allows you to perform all network operations on the {{< cenmlatestrelref "cenm/identity-manager.md" "Identity Manager Service" >}}, the {{< cenmlatestrelref "cenm/network-map.md#network-map-service" "Network Map Service" >}}, and the {{< cenmlatestrelref "cenm/signing-service.md" "Signing Service">}}.
...
Use the {{< cenmlatestrelref "cenm/cenm-cli-tool.md" "CENM Command-line Interface Tool" >}} to run commands to update the network parameters.
...
The Signing Service is not managed by the {{< cenmlatestrelref "cenm/angel-service.md" "Angel Service" >}} in this deployment, therefore any CENM Command-Line Interface (CLI) tool commands trying to change the Signing Service configuration will take no effect.
...
1. {{< cenmlatestrelref "cenm/signing-service.md#azure-key-vault" "Create the library JAR">}}.
