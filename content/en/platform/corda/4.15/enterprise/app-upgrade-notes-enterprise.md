...
menu:
  corda-enterprise-4-15:
    identifier: "corda-enterprise-4-15-enterprise-cordapp-upgrade"
...
- notes
- enterprise
title: Upgrading a CorDapp to Corda Enterprise Edition 4.15
weight: 20
---

# Upgrading a CorDapp to Corda Enterprise Edition 4.15

## Upgrading from Corda Open Source Edition

Before upgrading to Corda Enterprise Edition 4.15, upgrade your CorDapp to Corda Open Source Edition 4.15. See [Upgrading CorDapps to newer platform versions]({{< relref "app-upgrade-notes.md" >}}) for detailed instructions.
...
### Re-compiling for Corda Enterprise Edition 4.15

To re-compile your CorDapp for Corda Enterprise Edition 4.15, you need to:
...
1. Update your Gradle build file as follows.
    ...
    corda_release_version = '4.15'
    corda_core_release_version = '4.15'
...
{{< note >}}
Corda Enterprise Edition 4.15 binaries are not publicly available. To make the dependencies available for development, either
