...
go through via the JMeter GUI (see [View Results in Table](practical-considerations.md#interpreting-and-trouble-shooting-jmeter-output) for details how to verify that), we have sorted
