...
If you run the blob inspector without any JAR files on the classpath, then it will deserialize objects using the class carpenter, (see [Object serialization]({{< relref "../../../../../en/platform/corda/4.8/enterprise/serialization.md" >}})).
