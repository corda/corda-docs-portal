...
by default. Enabling the Hibernate logger will produce these logs (see [Node administration](../../../../../en/platform/corda/4.8/enterprise/node/operating/node-administration.html#logging)).
...
```none
DatabaseInitialisation(id="bMmdUxxZ";status="error";error_code="2";message="Could not find the database driver class. Please add it to the 'drivers' folder. See [Node configuration]({{< relref "../../../../../en/platform/corda/4.8/enterprise/node/setup/corda-configuration-file.md" >}})).
```
...
Enabling custom logging is also described in [Node administration](../../../../../en/platform/corda/4.8/enterprise/node/operating/node-administration.html#logging).
