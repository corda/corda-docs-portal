...
When upgrading to Corda 4.6 from a previous version, you need to upgrade your nodes because of the operational improvements for [database schema harmonization](../../../../../en/platform/corda/4.8/enterprise/release-notes-enterprise.html#database-schema-harmonization) that were introduced as part of this release.
