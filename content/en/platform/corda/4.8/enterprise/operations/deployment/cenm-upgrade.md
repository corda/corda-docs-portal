...
menu:
  corda-enterprise-4-8:
    identifier: corda-enterprise-4-8-operations-guide-deployment-cenm-upgrade
...
1. Generate new certificates for [FARM](../../../../1.3/cenm/gateway-service.md), [Auth](../../../../1.3/cenm/auth-service.md), and [Zone](../../../../1.3/cenm/zone-service.md) Services.
...
7. Edit [Identity Manager Service](../../../../1.3/cenm/identity-manager.md), [Network Map Service](../../../../1.3/cenm/network-map.md), and [Signing Service](../../../../1.3/cenm/signing-service.md) configurations to remove shell access and add an admin listener configuration.
8. Edit the [Signing Service](../../../../1.3/cenm/signing-service.md) configuration so that signing tasks refer to [service aliases](../../../../1.3/cenm/signing-service.md#direct-cenm-service-locations) generated by the Zone Service.
9. Set Identity Manager Service configuration in the [Zone Service](../../../../1.3/cenm/zone-service.md).
...
13. Add [Angel Services](../../../../1.3/cenm/angel-service.md) to Identity Manager, Network Map, and Signing Services, to fetch configurations from the Zone
   Service.
...
To generate the JWT, refer to the [Auth Service](../../../../1.3/cenm/auth-service.md) documentation.
...
* [FARM Service](../../../../1.3/cenm/gateway-service.md)
* [Auth Service](../../../../1.3/cenm/auth-service.md)
* [Zone Service](../../../../1.3/cenm/zone-service.md)
...
The [Auth Service](../../../../1.3/cenm/auth-service.md) has an initial user who can manage users, however
...
these names. The names are specified in [service aliases](../../../../1.3/cenm/signing-service.md#direct-cenm-service-locations).
...
[Angel Service documentation](../../../../1.3/cenm/angel-service.md).
 ...
 **Identity Manager**
  ...
  The release includes changes to database schemas (see [Changelog](../../../../1.2/cenm/changelog.md)) for Oracle databases;
...
The release includes changes to database schemas (see [Changelog](../../../../1.2/cenm/changelog.md)); new columns are created automatically
...
configuration of the relevant component (Signing Service or PKI Tool). For more information, see [Signing Services](../../../../1.3/cenm/signing-service.md).
and [Public Key Infrastructure (PKI) Tool](../../../../1.3/cenm/pki-tool.md) for more information.
...
Version 0.2.2 and 0.3 / 0.4 configuration files can be migrated to CENM 1.0 using the [configuration migration tool](../../../../1.3/cenm/tool-config-migration.md).
...
of the [Network Map Service](../../../../1.3/cenm/network-map.md) document for more information.
...
manually. See [Signing Services](../../../../1.3/cenm/signing-service.md) for more information on how to configure this.
...
configuration modification. See [Signing Services](../../../../1.3/cenm/signing-service.md) for more information on how to configure this.
...
See the “Setting the Network Parameters” section of the [Network Map Service](../../../../1.3/cenm/network-map.md) document for more information.
