...
The minimum options are listed below. Find additional options in [Apache's manual](https://ant.apache.org/manual/Tasks/signjar.html).
...
[Configuring a node](../../../../../en/platform/corda/4.7/enterprise/node/setup/corda-configuration-file.html#corda-configuration-file-signer-blacklist)).
...
The Cordformation plugin can also sign CorDapp `.jar`s when [deploying set of nodes](https://docs.corda.net/docs/corda-os/4.8/generating-a-node.html).
...
You can find an example project that demonstrates this in the `samples` folder of the Corda Git repository, `cordapp-configuration` . You can also refer to the [API documentation](https://api.corda.net/api/4.7/enterprise/html/api/kotlin/corda/net.corda.core.cordapp/index.html).
