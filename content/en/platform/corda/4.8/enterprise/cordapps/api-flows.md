...
You can retrieve a notary from the network map:
...
{{< note >}}
The size of the external operation thread pool can be configured; see [flowExternalOperationThreadPoolSize in the Configuration Fields topic]({{< relref "../node/setup/corda-configuration-fields.md#flowexternaloperationthreadpoolsize" >}}).
