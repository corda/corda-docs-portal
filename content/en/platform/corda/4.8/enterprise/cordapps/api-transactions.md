...
{{< figure alt="transaction flow" width=80% zoom="../resources/transaction-flow.png" >}}
...
{{< note >}}
See [Reissuing states](../../../../../../en/platform/corda/4.8/enterprise/cordapps/reissuing-states.md) for information about reissuing states with a guaranteed state replacement, which allows you to break transaction backchains.
{{< /note >}}
...
We discuss the selection of a notary in [Writing CorDapp Flows](../../../../../../en/platform/corda/4.8/enterprise/cordapps/api-flows.md).
...
See [Writing CorDapp Flows](../../../../../../en/platform/corda/4.8/enterprise/cordapps/api-flows.md) for more details.
...
Notarising and recording a transaction is handled by a built-in flow called `FinalityFlow`. See [Writing CorDapp Flows](../../../../../../en/platform/corda/4.8/enterprise/cordapps/api-flows.md) for
more details.
