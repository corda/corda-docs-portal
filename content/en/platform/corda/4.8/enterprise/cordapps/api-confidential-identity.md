...
menu:
  corda-enterprise-4-8:
    parent: corda-enterprise-4-8-cordapps-identity
tags:
- api
- confidential
- identity
...
See [API stability guarantees]({{< relref "../../../../../../en/platform/corda/4.8/enterprise/cordapps/api-stability-guarantees.md" >}}).
