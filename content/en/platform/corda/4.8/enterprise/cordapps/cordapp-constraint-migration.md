...
Contract CorDapp please read [Contract and state versioning](../../../../../../en/platform/corda/4.8/enterprise/upgrading-cordapp.html#contract-and-state-versioning) and [CorDapp Upgradeability Guarantees](../../../../../../en/platform/corda/4.8/enterprise/cordapps/cordapp-upgradeability.md) to understand your options.
{{< /warning >}}
...
* If using a hosted CZ network (such as [Corda Network Foundation](../../../../../../en/platform/corda/4.8/enterprise/corda-network/the-corda-network.md) or
[Corda Network Pre-Production/UAT environment](../../../../../../en/platform/corda/4.8/enterprise/corda-network/uat.md)) running an Identity Operator (formerly known as Doorman) and
