...
* Learn [what a CorDapp is]({{< relref "../../../../../../en/platform/corda/4.8/enterprise/cordapps/cordapp-overview.md" >}}).
...
3. When the build finishes, go to the `samples-java/Basic/cordapp-example/build/nodes` or `samples-kotlin/Basic/cordapp-example/build/nodes` folder. You will see the following output:
    ...
    See [Appendix B](#appendix-b-node-structure-1) for the node structure.
...
You can connect directly to your node’s database to see its stored states, transactions and attachments. Follow the instructions in [Node database]({{< relref "../../../../../../en/platform/corda/4.8/enterprise/node/operating/node-database.md" >}}).
...
* [Debugging a CorDapp]({{< relref "../../../../../../en/platform/corda/4.8/enterprise/cordapps/debugging-a-cordapp.md" >}})
* [Writing a CorDapp]({{< relref "../../../../../../en/platform/corda/4.8/enterprise/cordapps/writing-a-cordapp.md" >}})
* [Build a CorDapp]({{< relref "../../../../../../en/platform/corda/4.8/enterprise/cordapps/cordapp-build-systems.md" >}})
