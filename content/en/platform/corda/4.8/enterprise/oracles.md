...
You can find a further explanation of this in [Oracles](../../../../../en/platform/corda/4.8/open-source/key-concepts-oracles.md). Below you will see how to build such a
...
See [here](https://github.com/corda/corda/blob/release/os/4.8/samples/irs-demo/cordapp/workflows-irs/src/test/kotlin/net/corda/irs/api/OracleNodeTearOffTests.kt) for more examples.
