...
menu:
  corda-enterprise-4-8:
    ...
    name: "Back end guide"
    identifier: bank-in-a-box-back-end-guide-4-8
tags:
- Bank in a Box
- back end
weight: 200
...
As noted in the [Loans](#loans) section, [Corda scheduled states]({{< relref "../../event-scheduling.md#implementing-scheduled-events" >}}) are utilised in Bank in a Box to create recurring payments that start on a given date and are executed in a specific time period.
