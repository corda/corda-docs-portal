...
More information can be found in [Network Bootstrapper]({{< relref "../../../../../../en/platform/corda/4.8/enterprise/network-bootstrapper.md" >}}).
...
{{< note >}}
To determine which *minimumPlatformVersion* a zone must mandate in order to permit all the features of Corda 4.8, see [Corda versioning]({{< relref "../cordapps/versioning.md" >}}).
