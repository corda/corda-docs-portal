...
menu:
  corda-enterprise-4-8:
    identifier: corda-enterprise-4-8-corda-nodes-firewall
...
* A supported Java distribution (see [Getting set up for CorDapp development]({{< relref "../../../../../../en/platform/corda/4.8/enterprise/cordapps/getting-set-up.md" >}}))
