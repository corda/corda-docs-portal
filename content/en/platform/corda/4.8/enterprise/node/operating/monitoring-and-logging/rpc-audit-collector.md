...
The RPC data recorded by the node is explained in detail on the [RPC Audit Data Recording]({{< relref "../../../../../../../../en/platform/corda/4.8/enterprise/node/setup/rpc-audit-data-recording.md" >}}) page.
