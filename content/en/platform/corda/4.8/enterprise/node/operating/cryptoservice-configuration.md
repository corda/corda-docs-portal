...
As mentioned in the description of the configuration file ([Node configuration]({{< relref "../../../../../../../en/platform/corda/4.8/enterprise/node/setup/corda-configuration-file.md" >}})), the `node.conf` has three relevant fields:
* `cryptoServiceName`
* `cryptoServiceConf`
...
{{< warning >}}
The file containing the configuration for the HSM (referenced by the `cryptoServiceConf` field) contains sensitive information. For this reason, we strongly advise you to use the [Configuration Obfuscator]({{< relref "../../../../../../../en/platform/corda/4.8/enterprise/tools-config-obfuscator.md" >}}) tool.
