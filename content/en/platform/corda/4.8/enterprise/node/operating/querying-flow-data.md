...
For details of how to build a Multi RPC Client, see [Building a Multi RPC Client](clientrpc.html#building-the-multi-rpc-client). See also [MultiRPCClient***** in the API documentation.
