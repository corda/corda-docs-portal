...
Please refer to [Database schema setup](http://localhost:1313/en/platform/corda/4.8/enterprise/node/operating/node-database-admin.md) if you are setting up a Corda database in a production environment.
...
(see the documentation on [Database access when running H2](../../../../../../../en/platform/corda/4.8/enterprise/node-database-access-h2.md), hence when using H2 database it’s sufficient to [start the node](../../../../../../../en/platform/corda/4.8/enterprise/node/operating/node-database-admin.html#3-corda-node-configuration) and the database will be created.
...
See [Node configuration](../../../../../../../en/platform/corda/4.8/enterprise/node/setup/corda-configuration-file.html#database) for a complete list of database specific properties, it contains more options useful in case of testing Corda with unsupported databases.
...
No database setup is needed. Optionally remote H2 access/port can be configured. See the documentation on [Database access when running H2](../../../../../../../en/platform/corda/4.8/enterprise/node/operating/node-database-access-h2.md).
...
See the [Corda node upgrade notes](../../../../../../../en/platform/corda/4.8/enterprise/node/operating/node-upgrade-notes.md) for more information.
