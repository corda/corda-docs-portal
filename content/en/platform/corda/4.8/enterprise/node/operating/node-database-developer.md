...
Please refer to [Database schema setup](../../../../../../../en/platform/corda/4.8/enterprise/node/operating/node-database-admin.md) if you are setting up a Corda database in a production environment.
...
No database setup is needed. Optionally remote H2 access/port can be configured. See the documentation on [Database access when running H2](../../../../../../../en/platform/corda/4.8/enterprise/node-database-access-h2.md).
...
See the [Corda node upgrade notes](../../../../../../../en/platform/corda/4.8/enterprise/node-upgrade-notes.md) for more information.
