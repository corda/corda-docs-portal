...
environment variable isn’t present (see [Hiding sensitive data](../../../../../../../en/platform/corda/4.8/enterprise/node/operating/node-administration.html#hiding-sensitive-data) for more information).
...
See [Configuration file fields]({{< relref "../../../../../../../en/platform/corda/4.8/enterprise/node/setup/corda-configuration-fields.md" >}}).
