...
In this section, you will learn how the node records [Remote Procedure Call (RPC)]({{< relref "../../../../../../../en/platform/corda/4.8/enterprise/api-rpc.md" >}}) audit data.
...
In addition to recording RPC Audit Data it will also be useful to collect information on any data recorded.  See the [RPC Audit Data Collector]({{< relref "../../../../../../../en/platform/corda/4.8/enterprise/node/operating/monitoring-and-logging/rpc-audit-collector.md" >}}) page for details on this.
