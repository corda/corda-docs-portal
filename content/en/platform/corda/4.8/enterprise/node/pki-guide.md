...
* They need to have a custom extension defining the role of the certificate in the context of Corda. See the [Certificate Hierarchy Guide](../../../../../../en/platform/corda/4.8/enterprise/network/permissioning.html#certificate-role-extension) for more details.
...
At the time of writing this document, the Corda Network assumes the certificate hierarchy that can be found in the [Certificate Hierarchy Guide](../../../../../../en/platform/corda/4.8/enterprise/network/permissioning.html#certificate-role-extension) .
...
{{< note >}}
To learn more about running the tool, see the documentation on the [Public Key Infrastructure (PKI) Tool](../../../../../../en/platform/corda/4.8/enterprise/pki-tool.md).
