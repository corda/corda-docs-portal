---
aliases:
- /docs/4.8/enterprise/operations/deployment/corda-firewall-configuration-file.html
date: '2020-04-07T12:00:00Z'
menu:
  corda-enterprise-4-8:
    parent: corda-enterprise-4-8-corda-nodes-firewall-config
    identifier: corda-enterprise-4-8-corda-nodes-firewall-config-file
tags:
- corda
- firewall
- configuration
...
## firewallMode
Determines operating mode of the firewall. See [Firewall operating modes](../../../../../../en/platform/corda/4.8/enterprise/node/corda-firewall-configuration-file.html#firewall-operating-modes).
...
See [Setting JVM arguments](../../../../../../en/platform/corda/4.8/enterprise/node/deploy/running-a-node.html#setting-jvm-arguments) for examples and details on the precedence of the different approaches to settings arguments.
...
Float.  See [Use of HSM in Corda Firewall](../../../../../../en/platform/corda/4.8/enterprise/node/corda-firewall-component.html#use-of-hsm-in-corda-firewall) for an overview.
