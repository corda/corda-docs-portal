...
You should interact with each node via its shell over SSH - see the [node configuration options]({{< relref "../../../../../../../en/platform/corda/4.8/enterprise/node/setup/corda-configuration-file.md" >}}) for more information.
