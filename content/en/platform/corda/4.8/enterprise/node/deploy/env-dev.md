...
menu:
  corda-enterprise-4-8:
    identifier: corda-enterprise-4-8-corda-nodes-deploying
...
You can find out more about network maps and network parameters from [network map](../../../../../../../en/platform/corda/4.8/enterprise/network/network-map.md).
...
`install-shell-extensions`: Install `bootstrapper` alias and auto completion for bash and zsh. See [shell extensions for CLI applications](../../../../../../../en/platform/corda/4.8/enterprise/node/operating/cli-application-shell-extensions.md) for more info.
