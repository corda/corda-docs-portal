...
* A node configuration file with a name `node.conf`, configured as described in the [Node configuration](../../../../../../../en/platform/corda/4.8/enterprise/node/corda-firewall-configuration-file.md) section.
...
The remaining node files and directories will be generated at runtime. These are described in the [Node folder structure](../../../../../../../en/platform/corda/4.8/enterprise/node/corda-firewall-configuration-file.md) section.
...
* For more information about the plugins, visit the [Dockerform](../../../../../../../en/platform/corda/4.8/enterprise/node/deploy/generating-a-node-dockerform.md) and [Cordform](../../../../../../../en/platform/corda/4.8/enterprise/node/deploy/generating-a-node-cordform.md) pages.
