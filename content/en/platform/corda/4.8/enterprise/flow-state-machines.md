...
plugin framework.  See [Object serialization]({{< relref "../../../../../en/platform/corda/4.8/enterprise/serialization.md" >}}).  You can see above that the `SellerTradeInfo` has been annotated.


## Starting your flow

The `StateMachineManager` is the class responsible for taking care of all running flows in a node. It knows
how to register handlers with the messaging system (see [Networking and messaging]({{< relref "../../../../../en/platform/corda/4.8/enterprise/messaging.md" >}})) and iterate the right state machine
