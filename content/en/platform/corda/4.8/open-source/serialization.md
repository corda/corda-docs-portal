...
You can see both methods in action in the [client RPC tutorial](../../../../../en/tutorials/corda/4.8/os/supplementary-tutorials/tutorial-clientrpc-api.md). Here's a sample:
