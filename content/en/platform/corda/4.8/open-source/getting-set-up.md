...
{{< note >}} Visit the [platform support matrix](../../../../../en/platform/corda/4.8/enterprise/platform-support-matrix.md) to check your software versions against the latest version supported by Corda. {{< /note >}}
