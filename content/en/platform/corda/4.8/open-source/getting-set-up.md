...
{{< note >}} Visit the [platform support matrix](../../../../../en/platform/corda/4.8/enterprise/platform-support-matrix.md) to check your dependency versions against those supported by Corda. {{< /note >}}
