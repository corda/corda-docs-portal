...
{{< note >}}
The Latest version of Corda 4.8 has been updated to Log4j 2.15.0. A further update is underway to address security issues with Log4j 2.15.0. Check the releases and alerts banner for more information and expected release of the new update.
{{< /note >}}
