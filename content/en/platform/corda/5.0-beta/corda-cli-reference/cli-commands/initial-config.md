...
This section lists the Corda CLI `initial-config` arguments. You can use these commands to manually perform various setup actions, as described in the [Manual Bootstrapping Tutorial]({{< relref "../../deploying/deployment-tutorials/manual.md" >}}).
