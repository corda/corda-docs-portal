...
1. Compiles the [CPB](../../../introduction/key-concepts.html#corda-package-bundles-cpbs) and [CPI](../../../introductionkey-concepts.html#corda-package-installer-cpi) using the [buildCPI](#buildCPI-task) task
2. Uploads the CPI to the combined worker
3. Generates the [virtual nodes](../../../introductionkey-concepts.html#virtual-nodes) with the CPI
