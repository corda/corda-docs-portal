...
menu:
  corda-community-4-11:
    identifier: corda-community-4-11-corda-configuration-file
...
[reference.conf](https://github.com/corda/corda/blob/release/os/4.11/node/src/main/resources/corda-reference.conf)
