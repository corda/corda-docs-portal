...
menu:
  corda-enterprise-4-11:
    ...
    identifier: corda-enterprise-4-11-operations-guide-deployment-cenm-kubernetes-nmap
tags:
- config
- kubernetes
...
This Helm chart is to configure, deploy, and run the {{< cenmlatestrelref "cenm/network-map.md" "Network Map service" >}} on Kubernetes.
