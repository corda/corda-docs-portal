...
Each service runs in its own dedicated Kubernetes pod, with the exception of the [Angel Service]({{< relref "../../../../1.6/cenm/angel-service.md" >}}), which runs in the same pod as its managed service.
...
- Download the Docker image with CENM [Command-Line Interface (CLI) tool]({{< relref "../../../../1.6/cenm/cenm-cli-tool.md" >}}) so you can manage CENM services:
...
Use the CENM [Command Line Interface (CLI) Tool]({{< relref "../../../../1.6/cenm/cenm-cli-tool.md" >}}) to access the [Gateway Service]({{< relref "../../node/gateway-service.md" >}}) from your local machine.
...
Use the CENM [Command-Line (CLI) tool]({{< relref "../../../../1.6/cenm/cenm-cli-tool.md" >}}) to run commands to update the network parameters.
...
1. [Create the library JAR]({{< relref "../../../../../../../en/platform/corda/1.6/cenm/signing-service.md#azure-key-vault" >}}). 
...
and then setting up the database user/schema, following the instructions in the [CENM database setup]({{< relref "../../../../1.6/cenm/database-set-up.md" >}}) section.
