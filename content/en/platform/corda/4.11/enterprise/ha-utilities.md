...
The tool is distributed as part of Corda Enterprise in the form of runnable `.jar.` file - `corda-tools-ha-utilities-4.11.jar`.

To run simply pass in the file or URL as the first parameter:

```kotlin
java -jar corda-tools-ha-utilities-4.11.jar <sub-command> <command line options>
```
...
```kotlin
.
├── corda-tools-ha-utilities-4.11.jar
├── drivers
    ├── <HSM driver>
├── entity_A
    ├── node.conf
