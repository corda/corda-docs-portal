...
* [The network map]({{< relref "network-map.md" >}})
    ...
    * [Network parameters]({{< relref "network-parameters.md" >}})
    * [Network parameters update process]({{< relref "network-parameters.md#network-parameters-update-process" >}})
        * [Automatic acceptance]({{< relref "network-parameters.md#automatic-acceptance" >}})
        * [Manual acceptance]({{< relref "network-parameters.md#manual-acceptance" >}})
    * [Private network maps]({{< relref "network-map.md#private-network-maps" >}})
