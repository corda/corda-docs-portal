...
menu:
  corda-enterprise-4-11:
    parent: corda-enterprise-4-11-cordapps-identity
tags:
- api
- confidential
- identity
...
You can see an example of using `SwapIdentitiesFlow` in <a href="../../../../../../en/api-ref/corda/4.11/community/kotlin/corda/net.corda.finance.flows/-two-party-deal-flow/index.md">`TwoPartyDealFlow.kt`</a> .
