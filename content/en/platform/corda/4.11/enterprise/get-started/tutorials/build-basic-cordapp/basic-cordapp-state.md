...
menu:
  corda-enterprise-4-11:
    identifier: corda-enterprise-4-11-tutorial-basic-cordapp-state
    parent: corda-enterprise-4-11-tutorial-basic-cordapp-intro
    weight: 70
tags:
- tutorial
- cordapp
...
The next line of code you add defines the type of [contract state sub-interfaces]({{< relref "../../../cordapps/api-states.md#contractstate-sub-interfaces" >}}) you implement with the `AppleStamp` class. Add this line to ensure that Corda recognizes the `AppleStamp` as a state.
