...
* When executing the database migration, it was possible for upgrading from a pre-4.11 node to fail. This occurred when the database contained new-style confidential identities, that is, those without a certificate. This issue has been now resolved.
