...
`install-shell-extensions`: Install `corda` alias and auto completion for bash and zsh. See ({{< relref "operating/cli-application-shell-extensions.md" >}}) for more info.
