...
* If the [network parameter]({{< relref "../../network/available-network-parameters.md" >}}) 'recoveryMaximumBackupInterval' is defined, then it is used and given first precedence.
