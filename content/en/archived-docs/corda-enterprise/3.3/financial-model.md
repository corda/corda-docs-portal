...
menu:
  corda-enterprise-3-3:
    identifier: corda-enterprise-3-3-financial-model
    parent: corda-enterprise-3-3-component-library-index
    weight: 1020
tags:
- financial
- model
...
The [Amount](https://api.corda.net/api/corda-enterprise/3.3/html/api/kotlin/corda/net.corda.core.contracts/-amount/index.html) class is used to represent an amount of
