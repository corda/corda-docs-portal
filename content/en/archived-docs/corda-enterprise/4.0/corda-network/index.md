---
aliases:
- /releases/4.0/corda-network/index.html
...
The Corda Network website has a [high level overview](https://corda.network/joining-corda-network/onboarding-workflow) of the joining process.
