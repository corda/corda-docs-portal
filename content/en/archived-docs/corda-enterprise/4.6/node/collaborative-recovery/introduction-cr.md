...
Collaborative Recovery applications have a minimum platform version of 6 and are compatible only with [Corda Enterprise](../../../enterprise.html#corda-enterprise-vs-corda-open-source-feature-comparison) nodes.
