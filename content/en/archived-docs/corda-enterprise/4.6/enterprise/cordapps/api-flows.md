...
menu:
  corda-enterprise-4-6:
    identifier: corda-enterprise-4-6-cordapps-flows
...
{{< note >}}
The size of the external operation thread pool can be configured, see [the node configuration documentation](../node/setup/corda-configuration-file.md).
...
using Guava’s ListenableFuture is given in a following section.
