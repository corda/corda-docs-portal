...
Those requirements should already be set during [the initial Corda node configuration](#3-run-the-run-migration-scripts-sub-command-to-create-all-database-schema-objects).
