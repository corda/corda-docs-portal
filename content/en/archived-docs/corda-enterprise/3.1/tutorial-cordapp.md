---
aliases:
- /releases/3.1/tutorial-cordapp.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-3-1:
    identifier: corda-enterprise-3-1-tutorial-cordapp
...
* Checkout the branch for Corda Enterprise 3.1 by running `git checkout release-enterprise-V3`
...
* Make sure you are on the Corda Enterprise 3.1 branch `git checkout release-enterprise-V3`
...
Loaded 3 CorDapp(s)                     : com.r3.corda.corda-finance version 3.1 by R3, com.example.cordapp-example version 0.1 by Unknown, corda-core version 3.1 by Corda Enterprise Edition
