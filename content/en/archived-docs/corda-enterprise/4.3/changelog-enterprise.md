---
aliases:
- /releases/4.3/changelog-enterprise.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-4-3:
    identifier: corda-enterprise-4-3-changelog-enterprise
...
See [notary installation page](running-a-notary-cluster/installing-the-notary-service.html#mysql-notary-deprecated) for more information.
...
later than 2.12.3 (including 2.12.4) exhibit a different issue.{{< /note >}}
