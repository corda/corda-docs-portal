...
menu:
  corda-enterprise-4-3:
    identifier: corda-enterprise-4-3-cordapp-constraint-migration
    parent: corda-enterprise-4-3-versioning-and-upgrades
    weight: 1040
tags:
- cordapp
- constraint
...
Signature Constraint if they were originally using the CZ Whitelisted Constraint. Here, we explain how to modify existing CorDapp flows to
...
relaxed hash constraint checking mode as described in [Hash constrained states in private networks](https://docs.corda.net/docs/corda-enterprise/4.3/api-contract-constraints.html#hash-constrained-states-in-private-networks).
...
* If using a hosted CZ network (such as [The Corda Network](corda-network/the-corda-network.md) or
...
[Updating the contract whitelist for bootstrapped networks](network-bootstrapper.html#updating-the-contract-whitelist-for-bootstrapped-networks) to can add both CorDapp Contract JAR hashes.
