...
of the whitelisted contracts in the network parameters (see `NetworkParameters.whitelistedContractImplementations` in [Network parameters](../../../../../../en/platform/corda/4.5/enterprise/network/network-map.html#network-parameters)).
...
`java -jar network-bootstrapper-4.5.jar --network-parameter-overrides=<path_to_file>`

Or alternatively, by using the short form version:

`java -jar network-bootstrapper-4.5.jar -n=<path_to_file>`
...
variable `KEY_STORE_PASSWORD`. See: [Hiding sensitive data](../../../../../../en/platform/corda/4.5/enterprise/node/operating/node-administration.html#hiding-sensitive-data).
...
Check out the Example CorDapp and follow the instructions to build it [here](../../../../../en/platform/corda/4.5/open-source/tutorial-cordapp.html#building-the-example-cordapp).
