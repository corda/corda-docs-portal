...
menu:
  corda-enterprise-4-5:
    identifier: corda-enterprise-4-5-operations-guide-deployment-node-deploying
...
below. See the [Capsule documentation](https://github.com/puniverse/capsule) for more details.
