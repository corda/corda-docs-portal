...
The shell can be used to upload and download attachments from the node. To learn how, see the [Working with attachments](../../tutorial-attachments.html#uploading-and-downloading) tutorial.
