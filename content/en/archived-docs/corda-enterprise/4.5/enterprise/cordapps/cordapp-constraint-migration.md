...
by different parties and it will be expressed as a `CompositeKey` in the `SignatureAttachmentConstraint` (see [Core types in the Corda API](../api-core-types.md)).
