...
## Comparing Corda Enterprise Edition 4.3 vs Corda Enterprise Edition 4.5

This section contains a comparative analysis between Corda Enterprise Edition 4.3 and Corda Enterprise Edition 4.5, with a main focus on the parallelisation improvements introduced in version 4.5. The analysis also covers some of the improvements introduced in version 4.4. The features discussed are listed below:
