...
This Helm chart is to configure, deploy and run the  [CENM Signing Service](../../../../../../../en/platform/corda/1.3/cenm/signing-service.md) on Kunernetes.
...
* [PKI Tool](../../../../../../../en/platform/corda/1.3/cenm/pki-tool.md)
...
| `signerImage.tag`                            | Docker image Tag | `1.3.5-zulu-openjdk8u242` |
