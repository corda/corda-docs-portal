...
{{< warning >}}
Before you start the upgrade, you must consult the [CENM Release Notes](../../../../../../../en/platform/corda/1.3/cenm/release-notes.md) to confirm all changes between releases.
{{< /warning >}}
...
1. Generate new certificates for [FARM](../../../../../../../en/platform/corda/1.3/cenm/gateway-service.md), [Auth](../../../../../../../en/platform/corda/1.3/cenm/auth-service.md), and [Zone](../../../../../../../en/platform/corda/1.3/cenm/zone-service.md) Services.
...
8. Edit the [Signing Service](../../../../../../../en/platform/corda/1.3/cenm/signing-service.md) configuration so that signing tasks refer to [service aliases](../../../../../../../en/platform/corda/1.3/cenm/signing-service.html#direct-cenm-service-locations) generated by the Zone Service.
...
for generating the full SSL hierarchy is provided under [config-samples/upgrade-pki-tool-1.3.conf](../../../../../../../en/platform/corda/1.3/cenm/config-samples/upgrade-pki-tool-1.3.conf).
...
To generate the JWT, refer to the [Auth Service](../../../../../../../en/platform/corda/1.3/cenm/auth-service.md) documentation.
...
The [Auth Service](../../../../../../../en/platform/corda/1.3/cenm/auth-service.md) has an initial user who can manage users, however
...
configuration of the relevant component (Signing Service or PKI Tool). For more information, see [Signing Services](../../../../../../../en/platform/corda/1.3/cenm/signing-service.md).
and [Public Key Infrastructure (PKI) Tool](../../../../../../../en/platform/corda/1.3/cenm/pki-tool.md) for more information.
...
Version 0.2.2 and 0.3 / 0.4 configuration files can be migrated to CENM 1.0 using the [configuration migration tool](../../../../../../../en/platform/corda/1.3/cenm/tool-config-migration.md).
...
of the [Network Map Service](../../../../../../../en/platform/corda/1.3/cenm/network-map.md) document for more information.
...
manually. See [Signing Services](../../../../../../../en/platform/corda/1.3/cenm/signing-service.md) for more information on how to configure this.
...
configuration modification. See [Signing Services](../../../../../../../en/platform/corda/1.3/cenm/signing-service.md) for more information on how to configure this.
...
See the “Setting the Network Parameters” section of the [Network Map Service](../../../../../../../en/platform/corda/1.3/cenm/network-map.md) document for more information.
