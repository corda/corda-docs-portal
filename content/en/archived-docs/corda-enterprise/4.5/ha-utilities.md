...
```kotlin
java -jar corda-tools-ha-utilities-4.5.jar <sub-command> <command line options>
```
...
```kotlin
.
├── corda-tools-ha-utilities-4.5.jar
├── drivers
    ├── <HSM driver>
├── entity_A
    ├── node.conf
