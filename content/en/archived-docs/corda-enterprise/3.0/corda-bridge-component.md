---
aliases:
- /releases/3.0/corda-bridge-component.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-enterprise-3-0:
    identifier: corda-enterprise-3-0-corda-bridge-component
...
- bridge
- component
title: Corda Bridge Component Overview
---
{{% important %}}
...
* Assuming this is a normal message, it is passed on to the Artemis inbox and on acknowledgment of delivery, is cascaded back. Thus, Artemis acknowledgement leads to acknowledgement of the tunnel AMQP packet,
