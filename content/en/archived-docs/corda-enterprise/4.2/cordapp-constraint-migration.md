...
menu:
  corda-enterprise-4-2:
    identifier: corda-enterprise-4-2-cordapp-constraint-migration
...
{{< warning >}}
The steps outlined on this page assume you are using the same CorDapp Contract (for example, same state definition, commands and verification code) and
...
[Corda Network: UAT environment](corda-network/uat.md) running an Identity Operator (formerly known as Doorman) and
