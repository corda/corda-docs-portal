...
```shell
java -jar tools-database-manager-4.2-RC03.jar execute-migration -b .
```
...
distribution. See [Upgrade a Corda 3.X Enterprise Node](https://docs.corda.net/docs/corda-enterprise/3.3/node-operations-upgrading.html)
