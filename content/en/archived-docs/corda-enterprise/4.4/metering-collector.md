...
The tool is distributed as part of Corda Enterprise Edition 4.4 with the name “corda-tools-metering-collector-4.4.jar”. This JAR must be placed in the node’s
`cordapps` folder.
