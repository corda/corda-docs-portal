...
1. Register the notary service identity using the [HA Utilities tool](../../../../../../en/platform/corda/4.4/enterprise/notary/ha-notary-service-setup.html#ha-notary-registration-process).
