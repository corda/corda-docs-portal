...
* Use the [Corda Database Management Tool](../../../../../../en/platform/corda/4.4/enterprise/node/operating/node-database.html#database-management-tool-ref) to prepare the schema in the target database.
