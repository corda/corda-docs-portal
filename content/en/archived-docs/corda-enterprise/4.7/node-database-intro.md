...
Corda Enterprise is released with the [Database Management Tool](../../../../../en/platform/corda/4.7/enterprise/node/operating/node-database.html#database-management-tool).
