...
You can see a complete list, and guidance on monitoring specific scenarios in the [Monitoring scenarios docs]({{< relref "../../node/operating/monitoring-scenarios.md" >}}).
...
Take a look at the [Node metrics documentation]({{< relref "../../node-metrics.md" >}}) for a complete range of the metrics data available from your node.
