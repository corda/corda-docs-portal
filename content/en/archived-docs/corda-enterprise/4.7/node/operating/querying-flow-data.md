...
For details of how to build a Multi RPC Client, see [Building a Multi RPC Client](clientrpc.md). See also [MultiRPCClient](https://api.corda.net/api/4.7/enterprise/html/api/javadoc/net/corda/client/rpc/ext/MultiRPCClient.html) in the API documentation.
