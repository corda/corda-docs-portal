...
Collaborative Recovery applications have a minimum platform version of 6 and are compatible only with [Corda Enterprise](../../../../../../../en/platform/corda/4.7/enterprise.html#corda-enterprise-vs-corda-open-source-feature-comparison) nodes.
...
In general, R3 recommends that you avoid the legacy Corda Finance module in favour of [Tokens]({{< relref "../../../../../../../en/platform/corda/4.7/enterprise/cordapps/token-sdk-introduction.md" >}}) and Accounts SDKs.
