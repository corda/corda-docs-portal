...
menu:
  corda-enterprise-4-7:
    identifier: corda-enterprise-4-7-corda-nodes-firewall
...
* A supported Java distribution (see [Getting set up for CorDapp development]({{< relref "../../../../../../en/platform/corda/4.7/enterprise/cordapps/getting-set-up.md" >}}))
...
{{< /note >}}
We have tested Corda against Apache Artemis v2.6.2 and RedHat amq broker v7.2.2. R3 recommends to use these Artemis versions with Corda.
