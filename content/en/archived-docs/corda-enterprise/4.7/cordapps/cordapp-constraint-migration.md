...
## Upgrade from a Corda 3.x CorDapp to Corda 4
...
## Migrate CZ whitelisted constraints
...
* As the original developer of the CorDapp, the first step is to sign the latest version of the JAR that was released (see [Building and installing a CorDapp]({{< relref "../cordapps/cordapp-build-systems.md" >}})).
...
by different parties and it will be expressed as a `CompositeKey` in the `SignatureAttachmentConstraint` (see [API: Core types]({{< relref "../../../../../../en/platform/corda/4.7/enterprise/api-core-types.md" >}})).
...
* If using a hosted CZ network (such as [Corda Network Foundation]({{< relref "../corda-network/the-corda-network.md" >}}) or
[Corda Network Pre-Production/UAT environment]({{< relref "../../../../../../en/platform/corda/4.7/enterprise/corda-network/uat.md" >}})) running an Identity Operator (formerly known as Doorman) and
...
[Updating the contract whitelist for bootstrapped networks](../../../../../../en/platform/corda/4.7/enterprise/network-bootstrapper.html#updating-the-contract-whitelist-for-bootstrapped-networks) to can add both CorDapp Contract JAR hashes.
