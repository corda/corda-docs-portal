...
menu:
  corda-os-4-8:
    identifier: corda-os-4-8-debugging-a-cordapp
...
1. Define a network using the node driver as per [Integration testing]({{< relref "../../../../tutorials/corda/4.8/os/supplementary-tutorials/tutorial-integration-testing.md" >}}).
