...
menu:
  corda-os-4-8:
    identifier: corda-os-4-8-api-stability-guarantees
    parent: corda-os-4-8-versioning-and-upgrades
    weight: 1010
tags:
- api
- stability
...
Corda makes certain commitments about which parts of the Corda 4 API will remain stable and which will not. Over time, more of the API will fall under the stability guarantees. Thus, APIs can be categorized in the following two broad categories:
