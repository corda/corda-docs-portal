...
* A network can have several notary clusters, all running different [consensus algorithms]({{< relref "../../../../../en/platform/corda/4.8/open-source/key-concepts-consensus.md" >}}).
