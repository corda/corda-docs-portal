...
You can see both methods in action in the [client RPC tutorial]({{< relref "../../../../../en/tutorials/corda/4.9/community/supplementary-tutorials/tutorial-clientrpc-api.md" >}}). Here's a sample:
