...
menu:
  corda-community-4-9:
    identifier: corda-community-4-9-node-database-tables
...
Read more in [Working with attachments]({{< relref "../../../../tutorials/corda/4.9/community/supplementary-tutorials/tutorial-attachments.md" >}}) and [Node services](node-services.md)
