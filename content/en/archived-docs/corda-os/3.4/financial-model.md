...
menu:
  corda-os-3-4:
    identifier: corda-os-3-4-financial-model
...
The [Amount](https://api.corda.net/api/corda-os/3.4/html/api/kotlin/corda/net.corda.core.contracts/-amount/index.html) class is used to represent an amount of
