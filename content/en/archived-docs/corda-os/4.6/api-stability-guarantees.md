...
* **public APIs**, for which API/[ABI](https://en.wikipedia.org/wiki/Application_binary_interface) stability guarantees are provided.
* **non-public APIs**, for which no stability guarantees are provided.
