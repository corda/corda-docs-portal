...
relaxed hash constraint checking mode as described in [Hash constrained states in private networks](../../../../../en/platform/corda/4.5/open-source/api-contract-constraints.html#hash-constrained-states-in-private-networks).
