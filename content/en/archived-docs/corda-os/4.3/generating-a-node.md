...
menu:
  corda-os-4-3:
    identifier: corda-os-4-3-generating-a-node
...
* An up-to-date version of the `network-parameters` file ([see docs:](https://docs.corda.net/network-map.md)) generated by the bootstrapper tool
...
in the [Kotlin CorDapp Template](https://github.com/corda/cordapp-template-kotlin/blob/release-V5/build.gradle#L120):
...
* `name` <string>
    * The legal identity name of the Corda node. (see [myLegalName](corda-configuration-file.html#corda-configuration-file-mylegalname))
    * e.g.
...
* `p2pAddress` <string> <**required if p2pPort not specified**>
    * The address/port the node uses for inbound communication from other nodes. (see [p2pAddress](corda-configuration-file.html#corda-configuration-file-p2paddress))
    * e.g.
...
* `p2pPort` <integer>
    * The port the node uses for inbound communication from other nodes.  Assumes the address is `localhost`. (see [p2pAddress](corda-configuration-file.html#corda-configuration-file-p2paddress))
    * e.g.
...
* `rpcSettings` <config>
    * Specifies RPC settings for the node. (see [rpcSettings](corda-configuration-file.html#corda-configuration-file-rpc-settings))
    * e.g.
...
* `notary` <config> (see [notary](corda-configuration-file.html#corda-configuration-file-notary))
...
* `devMode` <boolean>
    * When true enables development mode. (see [devMode](corda-configuration-file.html#corda-configuration-file-dev-mode))
    * e.g.
...
* `rpcUsers` <list>
    * Set the RPC users for this node. (see [rpcUsers](corda-configuration-file.html#corda-configuration-file-rpc-users))
    * e.g.
...
* `sshdPort` <integer>
    * Specifies the port for sshd communication. (see [sshd](corda-configuration-file.html#corda-configuration-file-sshd))
    * e.g.
