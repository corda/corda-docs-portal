...
menu:
  corda-os-4-7:
    identifier: corda-os-4-7-blob-inspector
...
The tool is distributed as part of Corda OS 4.7 in the form of runnable `.jar.` file - `corda-tools-blob-inspector-4.7.jar`.
