---
aliases:
- /releases/release-V3.0/release-notes.html
date: '2020-01-08T09:59:25Z'
menu:
  corda-os-3-0:
    identifier: corda-os-3-0-release-notes
...
Further information can be found in the [Changelog](changelog.md), [Network Map](network-map.md) and [Creating a Corda network](setting-up-a-corda-network.md) documentation.
