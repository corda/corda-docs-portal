...
2. To sign your CPB, add a `cordapp/signing` section to the project `settings.gradle` file.
   ...
   {{< note >}}
By default, the CPB plugin signs with a default key. This key should only be used for local testing. For more information about deploying locally on a static network, see [Getting Started Using the CSDE]({{< relref "../../../../../tools-corda5/csde/_index.md">}}).
