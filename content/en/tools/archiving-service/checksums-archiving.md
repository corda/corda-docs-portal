...
## Checksums of Archive Service 2.0 release files

The checksum information for Archive Service 2.0 can be found: @todo

The 1.x series checksum information can be found in the [Archive Service 1.x checksums]({{< relref "../archiving-service-1.x/checksums-archiving.md" >}}) page.
