...
The 2.x series release notes can be found in the [Archive Service 2.x release notes]({{< relref "../archiving-service/archiving-release-notes.html" >}}) page.
...
{{< note >}}
For Corda Enterprise 4.12 and newer, [Archive Service 2.x]({{< relref "../archiving-service/archiving-release-notes.md" >}}) is also available.
{{< /note >}}
...
Archive Service 1.2.4 is a patch release focussed on resolving vulnerabilities.
...
Archive Service 1.2 is a major release supporting Java 17 and Kotlin 1.9.20. If you want to use the Archive Service, this is the only 1.x release that works with Corda 4.12.
